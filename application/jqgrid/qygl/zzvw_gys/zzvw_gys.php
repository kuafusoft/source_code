...
//供应商管理
class qygl_zzvw_gys extends table_desc{
	protected function init($db, $table, $params = array()){
		parent::init($db, $table, $params);
		$this->options['caption'] = '供应商';
        ...
        $this->options['list'] = array(
			...
			'hb_wz_id'=>array('label'=>'可提供', 'editable'=>true, 'data_source_table'=>'wz'),
		...
		$this->options['edit'] = array('hb_fl_id'=>array('type'=>'hidden', 'defval'=>HB_FL_GYS), 'name', 'gender_id', 'zhengjian_fl_id', 'identity_no', 
	...
	protected function _setSubGrid(){
		...
		$this->options['subGrid'] = array('expandField'=>'hb_id', 'db'=>'qygl', 'table'=>'zzvw_yw_xd');
	}
