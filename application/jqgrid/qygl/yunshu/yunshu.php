...
class qygl_yunshu extends table_desc{
...
// print_r($params);		
        $this->options['list'] = array(
			...
			// 'kuguan_id'=>array('label'=>'库管', 'data_source_db'=>'qygl', 'data_source_table'=>'zzvw_hb_yg'),
			// 'pici_id'=>array('label'=>'批次'),
			// 'dizhi'=>array('label'=>'地址'),
        );
		// if($params['yw_fl_id'] == YW_FL_YUNRU){ //运入
			// $this->options['edit'] = array('dingdan_id', 'amount', 'kuguan_id');
		// }
		// else{ //运出
			// $this->options['edit'] = array('dingdan_id', 'amount', 'kuguan_id', 'pici_id', 'dizhi');
		// }
