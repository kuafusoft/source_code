...
//客户管理
class qygl_kh extends table_desc{
	protected function init($db, $table, $params = array()){
        ...
        $this->options['list'] = array(
			...
			'kh_contact_method'=>array('label'=>'联系方式', 'formatter'=>'multi_row_edit', 'legend'=>'联系方式', 'data_source_table'=>'kh_contact_method',
				'formatoptions'=>array('subformat'=>'temp', 'temp'=>'%(contact_method_id)s:%(content)s'), 'from'=>'qygl.kh_contact_method'
			),
			'kh_wz_id'=>array('label'=>'需求', 'editable'=>true, 'data_source_table'=>'wz'),
            'isactive',
        );
		$this->linkTables = array(
			'm2m'=>array(
				'kh_wz'=>array('link_table'=>'kh_wz', 'self_link_field'=>'kh_id', 'link_field'=>'wz_id', 'refer_table'=>'wz'),
				),
			'one2m'=>array(
				'kh_contact_method'=>array('link_table'=>'kh_contact_method', 'self_link_field'=>'kh_id'),
				),
			);
	...
	protected function _setSubGrid(){
		...
		$this->options['subGrid'] = array('expandField'=>'kh_id', 'db'=>'qygl', 'table'=>'yw_xs');
	}
