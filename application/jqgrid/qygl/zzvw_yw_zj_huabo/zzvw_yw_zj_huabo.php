...
class qygl_zzvw_yw_zj_huabo extends table_desc{
	protected function init($db, $table, $params = array()){
		...
		$this->options['list'] = array(
			'out_zjzh_id'=>array('label'=>'转出账户', 'data_source_table'=>'zzvw_zjzh_cash', 'from'=>'qygl.yw_zj_huabo', 'editable'=>true),
			'in_zjzh_id'=>array('label'=>'转入账户', 'data_source_table'=>'zzvw_zjzh_cash', 'from'=>'qygl.yw_zj_huabo', 'editable'=>true),
			'amount'=>array('label'=>'转出金额', 'post'=>array('value'=>'元'), 'from'=>'qygl.yw_zj_huabo', 'editable'=>true),
			'cost'=>array('label'=>'费用', 'post'=>array('value'=>'元'), 'defval'=>0, 'from'=>'qygl.yw_zj_huabo', 'editable'=>true),
		...
		$this->options['edit'] = array('yw_fl_id'=>array('type'=>'hidden', 'defval'=>YW_FL_ZJHB),
			...
			'out_zjzh_id', 'out_zjzh_remained'=>array('label'=>'账户余额', 'DATA_TYPE'=>'float', 'editable'=>true, 'disabled'=>false, 'post'=>'元'),
			'in_zjzh_id', 'in_zjzh_remained'=>array('label'=>'账户余额', 'DATA_TYPE'=>'float', 'editable'=>true, 'disabled'=>false, 'post'=>'元'),
			'amount', 'cost',
