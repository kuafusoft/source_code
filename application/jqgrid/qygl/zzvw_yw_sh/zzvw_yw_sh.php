...
//接收采购的货物
class qygl_zzvw_yw_sh extends table_desc{
...
// print_r($params);
        ...
        $this->options['list'] = array(
			...
			'note'=>array('label'=>'备注'),
			'jbr_id'=>array('label'=>'收货人', 'data_source_db'=>'qygl', 'data_source_table'=>'zzvw_yg'),
			'happen_date'=>array('label'=>'入库日期', 'edittype'=>'date',
				'stype'=>'select', 'searchoptions'=>array('value'=>$year_month2)), //只提供三年内的查询
			'*'=>array('hidden'=>true),
        );

		$this->options['add'] = array('yw_fl_id'=>array('type'=>'hidden', 'defval'=>YW_FL_SH),'hb_id', 'yunshu_price', 'zxr_id', 'zx_price', 'zzvw_pici_sh', 'weight', 
			'dj_id', 'note', 'jbr_id', 'happen_date');
		$this->options['edit'] = array('yw_fl_id'=>array('type'=>'hidden', 'defval'=>YW_FL_SH),'hb_id', 'yunshu_price', 'zxr_id', 'zx_price', 'zzvw_pici_sh', 'weight', 
			'dj_id', 'note', 'jbr_id', 'happen_date');
