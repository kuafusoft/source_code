...
//下采购单
class qygl_zzvw_yw_xd extends table_desc{
...
// print_r($params);
        ...
        $this->options['list'] = array(
			...
			'name'=>array('label'=>'概述'),
			'hb_id'=>array('label'=>'供应商', 'editrules'=>array('required'=>true), 'data_source_table'=>'zzvw_stgys'),
			...
			'note'=>array('label'=>'备注'),
			'jbr_id'=>array('label'=>'下单人', 'data_source_db'=>'qygl', 'data_source_table'=>'zzvw_yg'),
			'happen_date'=>array('label'=>'下单日期', 'edittype'=>'date',
				'stype'=>'select', 'searchoptions'=>array('value'=>$year_month2)), //只提供三年内的查询
			'*'=>array('hidden'=>true),
        );

		$this->options['add'] = array('yw_fl_id'=>array('type'=>'hidden', 'defval'=>YW_FL_XD), 'hb_id', 'dingdan', 
			'note', 'jbr_id', 'happen_date');
		$this->options['edit'] = array('hb_id'=>array('editable'=>false), 'dingdan', 
			'note', 'jbr_id', 'happen_date');
