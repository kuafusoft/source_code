    ...
    public function init($db, $table, $params = array()){
		...
		$this->options['list'] = array(
			...
			'module_ticket'=>array('label'=>'Module', 'editable'=>true, 'data_source_db'=>'workflow', 
				...
				'formatter'=>'multi_row_edit', 'formatoptions'=>array('subformat'=>'temp', 'temp'=>'Module[%(module_id)s] has %(question_type_id)s question')),
			'ticket_trace'=>array('label'=>'Trace', 'data_source_table'=>'ticket_trace', 'data_source_db'=>'workflow', 'from'=>'workflow.ticket_trace', 
				'formatter'=>'multi_row_edit', 'formatoptions'=>array('subformat'=>'temp', 'temp'=>'[%(creater_id)s] updated on [%(update_date)s]: <BR />%(content)s'))
		);
