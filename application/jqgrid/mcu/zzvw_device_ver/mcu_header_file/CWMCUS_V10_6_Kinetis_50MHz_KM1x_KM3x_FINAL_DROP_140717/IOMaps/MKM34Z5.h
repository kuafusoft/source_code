...
#if !defined(MCU_MKM34Z5)  /* Check if memory map has not been already included */
#define MCU_MKM34Z5
...
typedef enum {
  ...
  INT_SPI0                     = 20,               /**< SPI0 ORed interrupt */
  INT_SPI1                     = 21,               /**< SPI1 ORed interrupt */
  INT_PMC                      = 22,               /**< Low-voltage detect, low-voltage warning */
  INT_TMR0                     = 23,               /**< Quad Timer Channel 0 */
  INT_TMR1                     = 24,               /**< Quad Timer Channel 1 */
  INT_TMR2                     = 25,               /**< Quad Timer Channel 2 */
  INT_TMR3                     = 26,               /**< Quad Timer Channel 3 */
  INT_PIT0_PIT1                = 27,               /**< PIT0/PIT1 ORed interrupt */
  INT_LLWU                     = 28,               /**< Low Leakage Wakeup */
  INT_FTFA                     = 29,               /**< Command complete and read collision */
  INT_CMP0_CMP1                = 30,               /**< CMP0/CMP1 ORed interrupt */
  INT_LCD                      = 31,               /**< LCD interrupt */
  INT_ADC                      = 32,               /**< ADC interrupt */
  INT_PTx                      = 33,               /**< Single interrupt vector for GPIOA,GPIOB,GPIOC,GPIOD,GPIOE,GPIOF,GPIOG,GPIOH,GPIOI */
  INT_RNGA                     = 34,               /**< RNGA interrupt */
  INT_UART0_UART1              = 35,               /**< UART0/UART1 ORed interrupt */
  INT_UART2_UART3              = 36,               /**< UART2/UART3 ORed interrupt */
  INT_AFE_CH0                  = 37,               /**< AFE Channel 0 */
  INT_AFE_CH1                  = 38,               /**< AFE Channel 1 */
  INT_AFE_CH2                  = 39,               /**< AFE Channel 2 */
  INT_AFE_CH3                  = 40,               /**< AFE Channel 3 */
  INT_RTC                      = 41,               /**< IRTC interrupt */
  INT_I2C0_I2C1                = 42,               /**< I2C0/I2C1 ORed interrupt */
  INT_EWM                      = 43,               /**< EWM interrupt */
  INT_MCG                      = 44,               /**< MCG interrupt */
  INT_Watchdog                 = 45,               /**< WDOG interrupt */
  INT_LPTMR                    = 46,               /**< LPTMR interrupt */
  INT_XBAR                     = 47                /**< XBAR interrupt */
} IRQInterruptIndex;
...
#define UART1_WP7816T0                           UART_WP7816T0_REG(UART1_BASE_PTR)
#define UART1_WP7816T1                           UART_WP7816T1_REG(UART1_BASE_PTR)
...
#define UART3_WP7816T0                           UART_WP7816T0_REG(UART3_BASE_PTR)
#define UART3_WP7816T1                           UART_WP7816T1_REG(UART3_BASE_PTR)
...
#define INT_SCI0_SCI1                            INT_UART0_UART1
#define INT_SCI2_SCI3                            INT_UART2_UART3
#define INT_AFE0                                 INT_AFE_CH0
#define INT_AFE1                                 INT_AFE_CH1
#define INT_AFE2                                 INT_AFE_CH2
#define INT_AFE3                                 INT_AFE_CH3
#define INT_PXBAR                                INT_XBAR
#define CRC_CRCL_REG(base)                       CRC_DATAL_REG(base)
#define CRC_CRCH_REG(base)                       CRC_DATAH_REG(base)
#define CRC_CRC_REG(base)                        CRC_DATA_REG(base)
#define CRC_CRCLL_REG(base)                      CRC_DATALL_REG(base)
#define CRC_CRCLU_REG(base)                      CRC_DATALU_REG(base)
#define CRC_CRCHL_REG(base)                      CRC_DATAHL_REG(base)
#define CRC_CRCHU_REG(base)                      CRC_DATAHU_REG(base)
...
#define CRC_CRCL                                 CRC_DATAL
#define CRC_CRCLL                                CRC_DATALL
#define CRC_CRCLU                                CRC_DATALU
#define CRC_CRCH                                 CRC_DATAH
#define CRC_CRCHL                                CRC_DATAHL
#define CRC_CRCHU                                CRC_DATAHU
#define MCG_C11_REG(base)                        This_symbol_has_been_deprecated
#define MCG_C12_REG(base)                        This_symbol_has_been_deprecated
#define MCG_S2_REG(base)                         This_symbol_has_been_deprecated
#define MCG_T3_REG(base)                         This_symbol_has_been_deprecated
#define MCG_C11_PLLCS_MASK                       This_symbol_has_been_deprecated
#define MCG_C11_PLLCS_SHIFT                      This_symbol_has_been_deprecated
#define MCG_C11                                  This_symbol_has_been_deprecated
#define MCG_C12                                  This_symbol_has_been_deprecated
#define MCG_S2                                   This_symbol_has_been_deprecated
#define MCG_T3                                   This_symbol_has_been_deprecated
...
#define TMR1_ENBL                                This_symbol_has_been_deprecated
#define TMR2_ENBL                                This_symbol_has_been_deprecated
#define TMR3_ENBL                                This_symbol_has_been_deprecated
#define C10                                      This_symbol_has_been_deprecated
