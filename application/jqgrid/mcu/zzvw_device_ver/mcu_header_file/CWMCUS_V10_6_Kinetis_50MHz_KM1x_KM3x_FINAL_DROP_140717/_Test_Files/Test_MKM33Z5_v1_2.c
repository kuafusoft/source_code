...
void test_NVIC(void) {
  ...
  (void)NVIC_ISER_SETENA_MASK;
  (void)NVIC_ISER_SETENA_SHIFT;
  (void)NVIC_ISER_SETENA(1);
  NVIC_ISER |= NVIC_ISER_SETENA_MASK;
  NVIC_ISER &= ~(1U << NVIC_ISER_SETENA_SHIFT);
  NVIC_ICER_REG(NVIC_BASE_PTR) = NVIC_ICER_REG(NVIC_BASE_PTR) + 1;
  (void)NVIC_ICER_CLRENA_MASK;
  (void)NVIC_ICER_CLRENA_SHIFT;
  (void)NVIC_ICER_CLRENA(1);
  NVIC_ICER |= NVIC_ICER_CLRENA_MASK;
  NVIC_ICER &= ~(1U << NVIC_ICER_CLRENA_SHIFT);
  NVIC_ISPR_REG(NVIC_BASE_PTR) = NVIC_ISPR_REG(NVIC_BASE_PTR) + 1;
  (void)NVIC_ISPR_SETPEND_MASK;
  (void)NVIC_ISPR_SETPEND_SHIFT;
  (void)NVIC_ISPR_SETPEND(1);
  NVIC_ISPR |= NVIC_ISPR_SETPEND_MASK;
  NVIC_ISPR &= ~(1U << NVIC_ISPR_SETPEND_SHIFT);
  NVIC_ICPR_REG(NVIC_BASE_PTR) = NVIC_ICPR_REG(NVIC_BASE_PTR) + 1;
  (void)NVIC_ICPR_CLRPEND_MASK;
  (void)NVIC_ICPR_CLRPEND_SHIFT;
  (void)NVIC_ICPR_CLRPEND(1);
  NVIC_ICPR |= NVIC_ICPR_CLRPEND_MASK;
  NVIC_ICPR &= ~(1U << NVIC_ICPR_CLRPEND_SHIFT);
...
void test_PIT(void) {
  ...
  (void)PIT_CVAL_TVL(1);
  PIT1_CVAL0 |= PIT_CVAL_TVL_MASK;
  PIT1_CVAL0 &= ~(1U << PIT_CVAL_TVL_SHIFT);
