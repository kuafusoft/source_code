/*
  ...
  ------------------------------------------------------------------
   ...
   | SysTick         | SysTick           | 0xE000E010   |  PDF    |
   | SCB             | SystemControl     | 0xE000E000   |  PDF    |
...
void test_ADC(void) {
  ...
  ADC_CLP1 = ADC_CLP1 + 1;
  ADC_CLP0 = ADC_CLP0 + 1;
  ADC_SC1_REG(ADC_BASE_PTR,0) = ADC_SC1_REG(ADC_BASE_PTR,0) + 1;
  ...
  ADC_CFG1_REG(ADC_BASE_PTR) = ADC_CFG1_REG(ADC_BASE_PTR) + 1;
  ...
  ADC_CFG2_REG(ADC_BASE_PTR) = ADC_CFG2_REG(ADC_BASE_PTR) + 1;
  ...
  ADC_SC3_REG(ADC_BASE_PTR) = ADC_SC3_REG(ADC_BASE_PTR) + 1;
  ...
  ADC_CLPS_REG(ADC_BASE_PTR) = ADC_CLPS_REG(ADC_BASE_PTR) + 1;
  ...
  ADC_CLP4_REG(ADC_BASE_PTR) = ADC_CLP4_REG(ADC_BASE_PTR) + 1;
  ...
  ADC_CLP3_REG(ADC_BASE_PTR) = ADC_CLP3_REG(ADC_BASE_PTR) + 1;
  ...
  ADC_CLP2_REG(ADC_BASE_PTR) = ADC_CLP2_REG(ADC_BASE_PTR) + 1;
  ...
  ADC_CLP1_REG(ADC_BASE_PTR) = ADC_CLP1_REG(ADC_BASE_PTR) + 1;
  ...
  ADC_CLP0_REG(ADC_BASE_PTR) = ADC_CLP0_REG(ADC_BASE_PTR) + 1;
...
void test_AFE(void) {
  ...
  AFE_CFR_REG(AFE_BASE_PTR,0) = AFE_CFR_REG(AFE_BASE_PTR,0) + 1;
  ...
  AFE_CR_REG(AFE_BASE_PTR) = AFE_CR_REG(AFE_BASE_PTR) + 1;
  ...
  AFE_CKR_REG(AFE_BASE_PTR) = AFE_CKR_REG(AFE_BASE_PTR) + 1;
  ...
  AFE_DI_REG(AFE_BASE_PTR) = AFE_DI_REG(AFE_BASE_PTR) + 1;
  ...
  AFE_DR_REG(AFE_BASE_PTR,0) = AFE_DR_REG(AFE_BASE_PTR,0) + 1;
  AFE_DR(0) = AFE_DR(0) + 1;
  ...
  (void)AFE_RR_SDR(1);
  AFE_CH0_RR |= AFE_RR_SDR_MASK;
  AFE_CH0_RR &= ~(1U << AFE_RR_SDR_SHIFT);
  (void)AFE_RR_SIGN_BITS_MASK;
  (void)AFE_RR_SIGN_BITS_SHIFT;
  (void)AFE_RR_SIGN_BITS(1);
  AFE_CH0_RR |= AFE_RR_SIGN_BITS_MASK;
  AFE_CH0_RR &= ~(1U << AFE_RR_SIGN_BITS_SHIFT);
  (void)AFE_SR_RDY3_MASK;
  (void)AFE_SR_RDY3_SHIFT;
  AFE_SR |= AFE_SR_RDY3_MASK;
  AFE_SR &= ~(1U << AFE_SR_RDY3_SHIFT);
  (void)AFE_SR_RDY2_MASK;
  (void)AFE_SR_RDY2_SHIFT;
  AFE_SR |= AFE_SR_RDY2_MASK;
  AFE_SR &= ~(1U << AFE_SR_RDY2_SHIFT);
  (void)AFE_SR_RDY1_MASK;
  (void)AFE_SR_RDY1_SHIFT;
  AFE_SR |= AFE_SR_RDY1_MASK;
  AFE_SR &= ~(1U << AFE_SR_RDY1_SHIFT);
  (void)AFE_SR_RDY0_MASK;
  (void)AFE_SR_RDY0_SHIFT;
  AFE_SR |= AFE_SR_RDY0_MASK;
  AFE_SR &= ~(1U << AFE_SR_RDY0_SHIFT);
  (void)AFE_SR_OVR3_MASK;
  (void)AFE_SR_OVR3_SHIFT;
  AFE_SR |= AFE_SR_OVR3_MASK;
  AFE_SR &= ~(1U << AFE_SR_OVR3_SHIFT);
  (void)AFE_SR_OVR2_MASK;
  (void)AFE_SR_OVR2_SHIFT;
  AFE_SR |= AFE_SR_OVR2_MASK;
  AFE_SR &= ~(1U << AFE_SR_OVR2_SHIFT);
  (void)AFE_SR_OVR1_MASK;
  (void)AFE_SR_OVR1_SHIFT;
  AFE_SR |= AFE_SR_OVR1_MASK;
  AFE_SR &= ~(1U << AFE_SR_OVR1_SHIFT);
  (void)AFE_SR_OVR0_MASK;
  (void)AFE_SR_OVR0_SHIFT;
  AFE_SR |= AFE_SR_OVR0_MASK;
  AFE_SR &= ~(1U << AFE_SR_OVR0_SHIFT);
  (void)AFE_SR_COC3_MASK;
  (void)AFE_SR_COC3_SHIFT;
  AFE_SR |= AFE_SR_COC3_MASK;
  AFE_SR &= ~(1U << AFE_SR_COC3_SHIFT);
  (void)AFE_SR_COC2_MASK;
  (void)AFE_SR_COC2_SHIFT;
  AFE_SR |= AFE_SR_COC2_MASK;
  AFE_SR &= ~(1U << AFE_SR_COC2_SHIFT);
  (void)AFE_SR_COC1_MASK;
  (void)AFE_SR_COC1_SHIFT;
  AFE_SR |= AFE_SR_COC1_MASK;
  AFE_SR &= ~(1U << AFE_SR_COC1_SHIFT);
  (void)AFE_SR_COC0_MASK;
  (void)AFE_SR_COC0_SHIFT;
  AFE_SR |= AFE_SR_COC0_MASK;
  AFE_SR &= ~(1U << AFE_SR_COC0_SHIFT);
}
...
void test_AIPS(void) {
  ...
  AIPS_PACRA_REG(AIPS_BASE_PTR) = AIPS_PACRA_REG(AIPS_BASE_PTR) + 1;
  ...
  AIPS_PACRB_REG(AIPS_BASE_PTR) = AIPS_PACRB_REG(AIPS_BASE_PTR) + 1;
  ...
  AIPS_PACRE_REG(AIPS_BASE_PTR) = AIPS_PACRE_REG(AIPS_BASE_PTR) + 1;
  ...
  AIPS_PACRF_REG(AIPS_BASE_PTR) = AIPS_PACRF_REG(AIPS_BASE_PTR) + 1;
  ...
  AIPS_PACRG_REG(AIPS_BASE_PTR) = AIPS_PACRG_REG(AIPS_BASE_PTR) + 1;
  ...
  AIPS_PACRH_REG(AIPS_BASE_PTR) = AIPS_PACRH_REG(AIPS_BASE_PTR) + 1;
  ...
  AIPS_PACRI_REG(AIPS_BASE_PTR) = AIPS_PACRI_REG(AIPS_BASE_PTR) + 1;
  ...
  AIPS_PACRJ_REG(AIPS_BASE_PTR) = AIPS_PACRJ_REG(AIPS_BASE_PTR) + 1;
  ...
  AIPS_PACRK_REG(AIPS_BASE_PTR) = AIPS_PACRK_REG(AIPS_BASE_PTR) + 1;
  ...
  AIPS_PACRL_REG(AIPS_BASE_PTR) = AIPS_PACRL_REG(AIPS_BASE_PTR) + 1;
  ...
  AIPS_PACRM_REG(AIPS_BASE_PTR) = AIPS_PACRM_REG(AIPS_BASE_PTR) + 1;
  ...
  AIPS_PACRN_REG(AIPS_BASE_PTR) = AIPS_PACRN_REG(AIPS_BASE_PTR) + 1;
  ...
  AIPS_PACRO_REG(AIPS_BASE_PTR) = AIPS_PACRO_REG(AIPS_BASE_PTR) + 1;
  ...
  AIPS_PACRP_REG(AIPS_BASE_PTR) = AIPS_PACRP_REG(AIPS_BASE_PTR) + 1;
...
void test_BP(void) {
  ...
  BP_COMP0 = BP_COMP0 + 1;
  BP_COMP1 = BP_COMP1 + 1;
  BP_CTRL_REG(BP_BASE_PTR) = BP_CTRL_REG(BP_BASE_PTR) + 1;
  BP_COMP_REG(BP_BASE_PTR,0) = BP_COMP_REG(BP_BASE_PTR,0) + 1;
  BP_COMP(0) = BP_COMP(0) + 1;
}
...
void test_CMP(void) {
  ...
  CMP_CR0_REG(CMP0_BASE_PTR) = CMP_CR0_REG(CMP0_BASE_PTR) + 1;
  CMP_CR0_REG(CMP1_BASE_PTR) = CMP_CR0_REG(CMP1_BASE_PTR) + 1;
  ...
  CMP_CR1_REG(CMP0_BASE_PTR) = CMP_CR1_REG(CMP0_BASE_PTR) + 1;
  CMP_CR1_REG(CMP1_BASE_PTR) = CMP_CR1_REG(CMP1_BASE_PTR) + 1;
  ...
  CMP_FPR_REG(CMP0_BASE_PTR) = CMP_FPR_REG(CMP0_BASE_PTR) + 1;
  CMP_FPR_REG(CMP1_BASE_PTR) = CMP_FPR_REG(CMP1_BASE_PTR) + 1;
  ...
  CMP_SCR_REG(CMP0_BASE_PTR) = CMP_SCR_REG(CMP0_BASE_PTR) + 1;
  CMP_SCR_REG(CMP1_BASE_PTR) = CMP_SCR_REG(CMP1_BASE_PTR) + 1;
  ...
  CMP_DACCR_REG(CMP0_BASE_PTR) = CMP_DACCR_REG(CMP0_BASE_PTR) + 1;
  CMP_DACCR_REG(CMP1_BASE_PTR) = CMP_DACCR_REG(CMP1_BASE_PTR) + 1;
  ...
  CMP_MUXCR_REG(CMP0_BASE_PTR) = CMP_MUXCR_REG(CMP0_BASE_PTR) + 1;
  CMP_MUXCR_REG(CMP1_BASE_PTR) = CMP_MUXCR_REG(CMP1_BASE_PTR) + 1;
...
void test_CRC(void) {
  ...
  CRC_DATAL_REG(CRC_BASE_PTR) = CRC_DATAL_REG(CRC_BASE_PTR) + 1;
  ...
  CRC_DATAH_REG(CRC_BASE_PTR) = CRC_DATAH_REG(CRC_BASE_PTR) + 1;
  ...
  CRC_DATA_REG(CRC_BASE_PTR) = CRC_DATA_REG(CRC_BASE_PTR) + 1;
  ...
  CRC_DATALL_REG(CRC_BASE_PTR) = CRC_DATALL_REG(CRC_BASE_PTR) + 1;
  ...
  CRC_DATALU_REG(CRC_BASE_PTR) = CRC_DATALU_REG(CRC_BASE_PTR) + 1;
  ...
  CRC_DATAHL_REG(CRC_BASE_PTR) = CRC_DATAHL_REG(CRC_BASE_PTR) + 1;
  ...
  CRC_DATAHU_REG(CRC_BASE_PTR) = CRC_DATAHU_REG(CRC_BASE_PTR) + 1;
  ...
  CRC_GPOLYL_REG(CRC_BASE_PTR) = CRC_GPOLYL_REG(CRC_BASE_PTR) + 1;
  ...
  CRC_GPOLYH_REG(CRC_BASE_PTR) = CRC_GPOLYH_REG(CRC_BASE_PTR) + 1;
  ...
  CRC_GPOLY_REG(CRC_BASE_PTR) = CRC_GPOLY_REG(CRC_BASE_PTR) + 1;
  ...
  CRC_GPOLYLL_REG(CRC_BASE_PTR) = CRC_GPOLYLL_REG(CRC_BASE_PTR) + 1;
  ...
  CRC_GPOLYLU_REG(CRC_BASE_PTR) = CRC_GPOLYLU_REG(CRC_BASE_PTR) + 1;
  ...
  CRC_GPOLYHL_REG(CRC_BASE_PTR) = CRC_GPOLYHL_REG(CRC_BASE_PTR) + 1;
  ...
  CRC_GPOLYHU_REG(CRC_BASE_PTR) = CRC_GPOLYHU_REG(CRC_BASE_PTR) + 1;
  ...
  CRC_CTRL_REG(CRC_BASE_PTR) = CRC_CTRL_REG(CRC_BASE_PTR) + 1;
  ...
  CRC_CTRLHU_REG(CRC_BASE_PTR) = CRC_CTRLHU_REG(CRC_BASE_PTR) + 1;
...
void test_CoreDebug(void) {
  (void)CoreDebug_BASE_PTR;
  DHCSR_Read = DHCSR_Read + 1;
  DHCSR_Write = DHCSR_Write + 1;
  DCRSR = DCRSR + 1;
  DCRDR = DCRDR + 1;
  DEMCR = DEMCR + 1;
  CoreDebug_base_DHCSR_Read_REG(CoreDebug_BASE_PTR) = CoreDebug_base_DHCSR_Read_REG(CoreDebug_BASE_PTR) + 1;
  CoreDebug_base_DHCSR_Write_REG(CoreDebug_BASE_PTR) = CoreDebug_base_DHCSR_Write_REG(CoreDebug_BASE_PTR) + 1;
  CoreDebug_base_DCRSR_REG(CoreDebug_BASE_PTR) = CoreDebug_base_DCRSR_REG(CoreDebug_BASE_PTR) + 1;
  CoreDebug_base_DCRDR_REG(CoreDebug_BASE_PTR) = CoreDebug_base_DCRDR_REG(CoreDebug_BASE_PTR) + 1;
  CoreDebug_base_DEMCR_REG(CoreDebug_BASE_PTR) = CoreDebug_base_DEMCR_REG(CoreDebug_BASE_PTR) + 1;
}
...
void test_DMA(void) {
  ...
  DMA_DSR3 = DMA_DSR3 + 1;
  DMA_DCR3 = DMA_DCR3 + 1;
  DMA_SAR_REG(DMA_BASE_PTR,0) = DMA_SAR_REG(DMA_BASE_PTR,0) + 1;
  ...
  DMA_DAR_REG(DMA_BASE_PTR,0) = DMA_DAR_REG(DMA_BASE_PTR,0) + 1;
  ...
  DMA_DSR_BCR_REG(DMA_BASE_PTR,0) = DMA_DSR_BCR_REG(DMA_BASE_PTR,0) + 1;
  ...
  DMA_DSR_REG(DMA_BASE_PTR,0) = DMA_DSR_REG(DMA_BASE_PTR,0) + 1;
  DMA_DSR(0) = DMA_DSR(0) + 1;
  DMA_DCR_REG(DMA_BASE_PTR,0) = DMA_DCR_REG(DMA_BASE_PTR,0) + 1;
...
void test_DMAMUX(void) {
  (void)DMAMUX0_BASE_PTR;
  (void)DMAMUX1_BASE_PTR;
  (void)DMAMUX2_BASE_PTR;
  (void)DMAMUX3_BASE_PTR;
  DMAMUX0_CHCFG = DMAMUX0_CHCFG + 1;
  DMAMUX1_CHCFG = DMAMUX1_CHCFG + 1;
  DMAMUX2_CHCFG = DMAMUX2_CHCFG + 1;
  DMAMUX3_CHCFG = DMAMUX3_CHCFG + 1;
  DMAMUX_CHCFG_REG(DMAMUX0_BASE_PTR) = DMAMUX_CHCFG_REG(DMAMUX0_BASE_PTR) + 1;
  DMAMUX_CHCFG_REG(DMAMUX1_BASE_PTR) = DMAMUX_CHCFG_REG(DMAMUX1_BASE_PTR) + 1;
  DMAMUX_CHCFG_REG(DMAMUX2_BASE_PTR) = DMAMUX_CHCFG_REG(DMAMUX2_BASE_PTR) + 1;
  DMAMUX_CHCFG_REG(DMAMUX3_BASE_PTR) = DMAMUX_CHCFG_REG(DMAMUX3_BASE_PTR) + 1;
...
void test_DWT(void) {
  (void)DWT_BASE_PTR;
  DWT_CTRL = DWT_CTRL + 1;
  DWT_COMP0 = DWT_COMP0 + 1;
  DWT_MASK0 = DWT_MASK0 + 1;
  DWT_FUNCTION0 = DWT_FUNCTION0 + 1;
  DWT_COMP1 = DWT_COMP1 + 1;
  DWT_MASK1 = DWT_MASK1 + 1;
  DWT_FUNCTION1 = DWT_FUNCTION1 + 1;
  DWT_CTRL_REG(DWT_BASE_PTR) = DWT_CTRL_REG(DWT_BASE_PTR) + 1;
  DWT_COMP_REG(DWT_BASE_PTR,0) = DWT_COMP_REG(DWT_BASE_PTR,0) + 1;
  DWT_COMP(0) = DWT_COMP(0) + 1;
  DWT_MASK_REG(DWT_BASE_PTR,0) = DWT_MASK_REG(DWT_BASE_PTR,0) + 1;
  DWT_MASK(0) = DWT_MASK(0) + 1;
  DWT_FUNCTION_REG(DWT_BASE_PTR,0) = DWT_FUNCTION_REG(DWT_BASE_PTR,0) + 1;
  DWT_FUNCTION(0) = DWT_FUNCTION(0) + 1;
}
...
void test_EWM(void) {
  ...
  EWM_CMPL = EWM_CMPL + 1;
  EWM_CMPH = EWM_CMPH + 1;
  EWM_CTRL_REG(EWM_BASE_PTR) = EWM_CTRL_REG(EWM_BASE_PTR) + 1;
  ...
  EWM_SERV_REG(EWM_BASE_PTR) = EWM_SERV_REG(EWM_BASE_PTR) + 1;
  ...
  EWM_CMPL_REG(EWM_BASE_PTR) = EWM_CMPL_REG(EWM_BASE_PTR) + 1;
  ...
  EWM_CMPH_REG(EWM_BASE_PTR) = EWM_CMPH_REG(EWM_BASE_PTR) + 1;
...
void test_FTFA(void) {
  ...
  FTFA_FSTAT_REG(FTFA_BASE_PTR) = FTFA_FSTAT_REG(FTFA_BASE_PTR) + 1;
  ...
  FTFA_FCNFG_REG(FTFA_BASE_PTR) = FTFA_FCNFG_REG(FTFA_BASE_PTR) + 1;
  ...
  FTFA_FSEC |= FTFA_FSEC_SEC_MASK;
  FTFA_FSEC &= ~(1U << FTFA_FSEC_SEC_SHIFT);
  (void)FTFA_FSEC_FSLACC_MASK;
  (void)FTFA_FSEC_FSLACC_SHIFT;
  (void)FTFA_FSEC_FSLACC(1);
  FTFA_FSEC |= FTFA_FSEC_FSLACC_MASK;
  FTFA_FSEC &= ~(1U << FTFA_FSEC_FSLACC_SHIFT);
  (void)FTFA_FSEC_MEEN_MASK;
  (void)FTFA_FSEC_MEEN_SHIFT;
  (void)FTFA_FSEC_MEEN(1);
  FTFA_FSEC |= FTFA_FSEC_MEEN_MASK;
  FTFA_FSEC &= ~(1U << FTFA_FSEC_MEEN_SHIFT);
  (void)FTFA_FSEC_KEYEN_MASK;
  (void)FTFA_FSEC_KEYEN_SHIFT;
  (void)FTFA_FSEC_KEYEN(1);
  FTFA_FSEC |= FTFA_FSEC_KEYEN_MASK;
  FTFA_FSEC &= ~(1U << FTFA_FSEC_KEYEN_SHIFT);
  (void)FTFA_FOPT_OPT_MASK;
  (void)FTFA_FOPT_OPT_SHIFT;
  (void)FTFA_FOPT_OPT(1);
  FTFA_FOPT |= FTFA_FOPT_OPT_MASK;
  FTFA_FOPT &= ~(1U << FTFA_FOPT_OPT_SHIFT);
  FTFA_FCCOB3_REG(FTFA_BASE_PTR) = FTFA_FCCOB3_REG(FTFA_BASE_PTR) + 1;
  ...
  FTFA_FCCOB2_REG(FTFA_BASE_PTR) = FTFA_FCCOB2_REG(FTFA_BASE_PTR) + 1;
  ...
  FTFA_FCCOB1_REG(FTFA_BASE_PTR) = FTFA_FCCOB1_REG(FTFA_BASE_PTR) + 1;
  ...
  FTFA_FCCOB0_REG(FTFA_BASE_PTR) = FTFA_FCCOB0_REG(FTFA_BASE_PTR) + 1;
  ...
  FTFA_FCCOB7_REG(FTFA_BASE_PTR) = FTFA_FCCOB7_REG(FTFA_BASE_PTR) + 1;
  ...
  FTFA_FCCOB6_REG(FTFA_BASE_PTR) = FTFA_FCCOB6_REG(FTFA_BASE_PTR) + 1;
  ...
  FTFA_FCCOB5_REG(FTFA_BASE_PTR) = FTFA_FCCOB5_REG(FTFA_BASE_PTR) + 1;
  ...
  FTFA_FCCOB4_REG(FTFA_BASE_PTR) = FTFA_FCCOB4_REG(FTFA_BASE_PTR) + 1;
  ...
  FTFA_FCCOBB_REG(FTFA_BASE_PTR) = FTFA_FCCOBB_REG(FTFA_BASE_PTR) + 1;
  ...
  FTFA_FCCOBA_REG(FTFA_BASE_PTR) = FTFA_FCCOBA_REG(FTFA_BASE_PTR) + 1;
  ...
  FTFA_FCCOB9_REG(FTFA_BASE_PTR) = FTFA_FCCOB9_REG(FTFA_BASE_PTR) + 1;
  ...
  FTFA_FCCOB8_REG(FTFA_BASE_PTR) = FTFA_FCCOB8_REG(FTFA_BASE_PTR) + 1;
  ...
  FTFA_FPROT3_REG(FTFA_BASE_PTR) = FTFA_FPROT3_REG(FTFA_BASE_PTR) + 1;
  ...
  FTFA_FPROT2_REG(FTFA_BASE_PTR) = FTFA_FPROT2_REG(FTFA_BASE_PTR) + 1;
  ...
  FTFA_FPROT1_REG(FTFA_BASE_PTR) = FTFA_FPROT1_REG(FTFA_BASE_PTR) + 1;
  ...
  FTFA_FPROT0_REG(FTFA_BASE_PTR) = FTFA_FPROT0_REG(FTFA_BASE_PTR) + 1;
...
void test_GPIO(void) {
  ...
  GPIO_PDOR_REG(GPIOA_BASE_PTR) = GPIO_PDOR_REG(GPIOA_BASE_PTR) + 1;
  GPIO_PDOR_REG(GPIOB_BASE_PTR) = GPIO_PDOR_REG(GPIOB_BASE_PTR) + 1;
  GPIO_PDOR_REG(GPIOC_BASE_PTR) = GPIO_PDOR_REG(GPIOC_BASE_PTR) + 1;
  GPIO_PDOR_REG(GPIOD_BASE_PTR) = GPIO_PDOR_REG(GPIOD_BASE_PTR) + 1;
  GPIO_PDOR_REG(GPIOE_BASE_PTR) = GPIO_PDOR_REG(GPIOE_BASE_PTR) + 1;
  GPIO_PDOR_REG(GPIOF_BASE_PTR) = GPIO_PDOR_REG(GPIOF_BASE_PTR) + 1;
  GPIO_PDOR_REG(GPIOG_BASE_PTR) = GPIO_PDOR_REG(GPIOG_BASE_PTR) + 1;
  GPIO_PDOR_REG(GPIOH_BASE_PTR) = GPIO_PDOR_REG(GPIOH_BASE_PTR) + 1;
  GPIO_PDOR_REG(GPIOI_BASE_PTR) = GPIO_PDOR_REG(GPIOI_BASE_PTR) + 1;
  ...
  GPIOA_PDIR |= GPIO_PDIR_PDI_MASK;
  GPIOA_PDIR &= ~(1U << GPIO_PDIR_PDI_SHIFT);
  GPIO_PDDR_REG(GPIOA_BASE_PTR) = GPIO_PDDR_REG(GPIOA_BASE_PTR) + 1;
  GPIO_PDDR_REG(GPIOB_BASE_PTR) = GPIO_PDDR_REG(GPIOB_BASE_PTR) + 1;
  GPIO_PDDR_REG(GPIOC_BASE_PTR) = GPIO_PDDR_REG(GPIOC_BASE_PTR) + 1;
  GPIO_PDDR_REG(GPIOD_BASE_PTR) = GPIO_PDDR_REG(GPIOD_BASE_PTR) + 1;
  GPIO_PDDR_REG(GPIOE_BASE_PTR) = GPIO_PDDR_REG(GPIOE_BASE_PTR) + 1;
  GPIO_PDDR_REG(GPIOF_BASE_PTR) = GPIO_PDDR_REG(GPIOF_BASE_PTR) + 1;
  GPIO_PDDR_REG(GPIOG_BASE_PTR) = GPIO_PDDR_REG(GPIOG_BASE_PTR) + 1;
  GPIO_PDDR_REG(GPIOH_BASE_PTR) = GPIO_PDDR_REG(GPIOH_BASE_PTR) + 1;
  GPIO_PDDR_REG(GPIOI_BASE_PTR) = GPIO_PDDR_REG(GPIOI_BASE_PTR) + 1;
  ...
  GPIO_GACR_REG(GPIOA_BASE_PTR) = GPIO_GACR_REG(GPIOA_BASE_PTR) + 1;
  GPIO_GACR_REG(GPIOB_BASE_PTR) = GPIO_GACR_REG(GPIOB_BASE_PTR) + 1;
  GPIO_GACR_REG(GPIOC_BASE_PTR) = GPIO_GACR_REG(GPIOC_BASE_PTR) + 1;
  GPIO_GACR_REG(GPIOD_BASE_PTR) = GPIO_GACR_REG(GPIOD_BASE_PTR) + 1;
  GPIO_GACR_REG(GPIOE_BASE_PTR) = GPIO_GACR_REG(GPIOE_BASE_PTR) + 1;
  GPIO_GACR_REG(GPIOF_BASE_PTR) = GPIO_GACR_REG(GPIOF_BASE_PTR) + 1;
  GPIO_GACR_REG(GPIOG_BASE_PTR) = GPIO_GACR_REG(GPIOG_BASE_PTR) + 1;
  GPIO_GACR_REG(GPIOH_BASE_PTR) = GPIO_GACR_REG(GPIOH_BASE_PTR) + 1;
  GPIO_GACR_REG(GPIOI_BASE_PTR) = GPIO_GACR_REG(GPIOI_BASE_PTR) + 1;
...
void test_I2C(void) {
  ...
  I2C_A1_REG(I2C0_BASE_PTR) = I2C_A1_REG(I2C0_BASE_PTR) + 1;
  I2C_A1_REG(I2C1_BASE_PTR) = I2C_A1_REG(I2C1_BASE_PTR) + 1;
  (void)I2C_A1_AD_MASK;
  (void)I2C_A1_AD_SHIFT;
  (void)I2C_A1_AD(1);
  I2C0_A1 |= I2C_A1_AD_MASK;
  I2C0_A1 &= ~(1U << I2C_A1_AD_SHIFT);
  I2C_F_REG(I2C0_BASE_PTR) = I2C_F_REG(I2C0_BASE_PTR) + 1;
  I2C_F_REG(I2C1_BASE_PTR) = I2C_F_REG(I2C1_BASE_PTR) + 1;
  (void)I2C_F_ICR_MASK;
  ...
  I2C_C1_REG(I2C0_BASE_PTR) = I2C_C1_REG(I2C0_BASE_PTR) + 1;
  I2C_C1_REG(I2C1_BASE_PTR) = I2C_C1_REG(I2C1_BASE_PTR) + 1;
  ...
  I2C_S_REG(I2C0_BASE_PTR) = I2C_S_REG(I2C0_BASE_PTR) + 1;
  I2C_S_REG(I2C1_BASE_PTR) = I2C_S_REG(I2C1_BASE_PTR) + 1;
  ...
  I2C_D_REG(I2C0_BASE_PTR) = I2C_D_REG(I2C0_BASE_PTR) + 1;
  I2C_D_REG(I2C1_BASE_PTR) = I2C_D_REG(I2C1_BASE_PTR) + 1;
  (void)I2C_D_DATA_MASK;
  (void)I2C_D_DATA_SHIFT;
  (void)I2C_D_DATA(1);
  I2C0_D |= I2C_D_DATA_MASK;
  I2C0_D &= ~(1U << I2C_D_DATA_SHIFT);
  I2C_C2_REG(I2C0_BASE_PTR) = I2C_C2_REG(I2C0_BASE_PTR) + 1;
  I2C_C2_REG(I2C1_BASE_PTR) = I2C_C2_REG(I2C1_BASE_PTR) + 1;
  (void)I2C_C2_AD_MASK;
  ...
  I2C_FLT_REG(I2C0_BASE_PTR) = I2C_FLT_REG(I2C0_BASE_PTR) + 1;
  I2C_FLT_REG(I2C1_BASE_PTR) = I2C_FLT_REG(I2C1_BASE_PTR) + 1;
  ...
  I2C_RA_REG(I2C0_BASE_PTR) = I2C_RA_REG(I2C0_BASE_PTR) + 1;
  I2C_RA_REG(I2C1_BASE_PTR) = I2C_RA_REG(I2C1_BASE_PTR) + 1;
  (void)I2C_RA_RAD_MASK;
  (void)I2C_RA_RAD_SHIFT;
  (void)I2C_RA_RAD(1);
  I2C0_RA |= I2C_RA_RAD_MASK;
  I2C0_RA &= ~(1U << I2C_RA_RAD_SHIFT);
  I2C_SMB_REG(I2C0_BASE_PTR) = I2C_SMB_REG(I2C0_BASE_PTR) + 1;
  I2C_SMB_REG(I2C1_BASE_PTR) = I2C_SMB_REG(I2C1_BASE_PTR) + 1;
  ...
  I2C_A2_REG(I2C0_BASE_PTR) = I2C_A2_REG(I2C0_BASE_PTR) + 1;
  I2C_A2_REG(I2C1_BASE_PTR) = I2C_A2_REG(I2C1_BASE_PTR) + 1;
  (void)I2C_A2_SAD_MASK;
  (void)I2C_A2_SAD_SHIFT;
  (void)I2C_A2_SAD(1);
  I2C0_A2 |= I2C_A2_SAD_MASK;
  I2C0_A2 &= ~(1U << I2C_A2_SAD_SHIFT);
  I2C_SLTH_REG(I2C0_BASE_PTR) = I2C_SLTH_REG(I2C0_BASE_PTR) + 1;
  I2C_SLTH_REG(I2C1_BASE_PTR) = I2C_SLTH_REG(I2C1_BASE_PTR) + 1;
  ...
  I2C_SLTL_REG(I2C0_BASE_PTR) = I2C_SLTL_REG(I2C0_BASE_PTR) + 1;
  I2C_SLTL_REG(I2C1_BASE_PTR) = I2C_SLTL_REG(I2C1_BASE_PTR) + 1;
...
void test_LCD(void) {
  ...
  LCD_WF62 = LCD_WF62 + 1;
  LCD_WF63 = LCD_WF63 + 1;
  LCD_GCR_REG(LCD_BASE_PTR) = LCD_GCR_REG(LCD_BASE_PTR) + 1;
  ...
  LCD_AR_REG(LCD_BASE_PTR) = LCD_AR_REG(LCD_BASE_PTR) + 1;
  ...
  LCD_FDCR_REG(LCD_BASE_PTR) = LCD_FDCR_REG(LCD_BASE_PTR) + 1;
  ...
  LCD_FDSR_REG(LCD_BASE_PTR) = LCD_FDSR_REG(LCD_BASE_PTR) + 1;
  ...
  LCD_PEN_REG(LCD_BASE_PTR,0) = LCD_PEN_REG(LCD_BASE_PTR,0) + 1;
  ...
  LCD_BPEN_REG(LCD_BASE_PTR,0) = LCD_BPEN_REG(LCD_BASE_PTR,0) + 1;
  ...
  LCD_WF_REG(LCD_BASE_PTR,0) = LCD_WF_REG(LCD_BASE_PTR,0) + 1;
  LCD_WF(0) = LCD_WF(0) + 1;
  ...
  LCD_WF8B_REG(LCD_BASE_PTR,0) = LCD_WF8B_REG(LCD_BASE_PTR,0) + 1;
...
void test_LLWU(void) {
  ...
  LLWU_PE1_REG(LLWU_BASE_PTR) = LLWU_PE1_REG(LLWU_BASE_PTR) + 1;
  ...
  LLWU_PE2_REG(LLWU_BASE_PTR) = LLWU_PE2_REG(LLWU_BASE_PTR) + 1;
  ...
  LLWU_PE3_REG(LLWU_BASE_PTR) = LLWU_PE3_REG(LLWU_BASE_PTR) + 1;
  ...
  LLWU_PE4_REG(LLWU_BASE_PTR) = LLWU_PE4_REG(LLWU_BASE_PTR) + 1;
  ...
  LLWU_ME_REG(LLWU_BASE_PTR) = LLWU_ME_REG(LLWU_BASE_PTR) + 1;
  ...
  LLWU_F1_REG(LLWU_BASE_PTR) = LLWU_F1_REG(LLWU_BASE_PTR) + 1;
  ...
  LLWU_F2_REG(LLWU_BASE_PTR) = LLWU_F2_REG(LLWU_BASE_PTR) + 1;
  ...
  LLWU_FILT2_REG(LLWU_BASE_PTR) = LLWU_FILT2_REG(LLWU_BASE_PTR) + 1;
...
void test_LPTMR(void) {
  ...
  LPTMR_CSR_REG(LPTMR_BASE_PTR) = LPTMR_CSR_REG(LPTMR_BASE_PTR) + 1;
  ...
  LPTMR_PSR_REG(LPTMR_BASE_PTR) = LPTMR_PSR_REG(LPTMR_BASE_PTR) + 1;
  ...
  LPTMR_CMR_REG(LPTMR_BASE_PTR) = LPTMR_CMR_REG(LPTMR_BASE_PTR) + 1;
  ...
  LPTMR_CNR_REG(LPTMR_BASE_PTR) = LPTMR_CNR_REG(LPTMR_BASE_PTR) + 1;
...
void test_MCG(void) {
  ...
  MCG_C7 = MCG_C7 + 1;
  MCG_C8 = MCG_C8 + 1;
  MCG_C1_REG(MCG_BASE_PTR) = MCG_C1_REG(MCG_BASE_PTR) + 1;
  ...
  MCG_C2_REG(MCG_BASE_PTR) = MCG_C2_REG(MCG_BASE_PTR) + 1;
  ...
  MCG_C3_REG(MCG_BASE_PTR) = MCG_C3_REG(MCG_BASE_PTR) + 1;
  ...
  MCG_C4_REG(MCG_BASE_PTR) = MCG_C4_REG(MCG_BASE_PTR) + 1;
  ...
  MCG_C5_REG(MCG_BASE_PTR) = MCG_C5_REG(MCG_BASE_PTR) + 1;
  ...
  MCG_C6_REG(MCG_BASE_PTR) = MCG_C6_REG(MCG_BASE_PTR) + 1;
  ...
  MCG_S_REG(MCG_BASE_PTR) = MCG_S_REG(MCG_BASE_PTR) + 1;
  ...
  MCG_SC_REG(MCG_BASE_PTR) = MCG_SC_REG(MCG_BASE_PTR) + 1;
  ...
  MCG_ATCVH_REG(MCG_BASE_PTR) = MCG_ATCVH_REG(MCG_BASE_PTR) + 1;
  ...
  MCG_ATCVL_REG(MCG_BASE_PTR) = MCG_ATCVL_REG(MCG_BASE_PTR) + 1;
  ...
  MCG_C7_REG(MCG_BASE_PTR) = MCG_C7_REG(MCG_BASE_PTR) + 1;
  ...
  MCG_C8_REG(MCG_BASE_PTR) = MCG_C8_REG(MCG_BASE_PTR) + 1;
  ...
  MCG_C9 |= MCG_C9_COARSE_LOCK_MASK;
  MCG_C9 &= ~(1U << MCG_C9_COARSE_LOCK_SHIFT);
  (void)MCG_C9_COARSE_LOLS_MASK;
  (void)MCG_C9_COARSE_LOLS_SHIFT;
  MCG_C9 |= MCG_C9_COARSE_LOLS_MASK;
  MCG_C9 &= ~(1U << MCG_C9_COARSE_LOLS_SHIFT);
}
...
void test_MCM(void) {
  ...
  MCM_PLASC |= MCM_PLASC_ASC_MASK;
  MCM_PLASC &= ~(1U << MCM_PLASC_ASC_SHIFT);
  (void)MCM_PLAMC_AMC_MASK;
  (void)MCM_PLAMC_AMC_SHIFT;
  (void)MCM_PLAMC_AMC(1);
  MCM_PLAMC |= MCM_PLAMC_AMC_MASK;
  MCM_PLAMC &= ~(1U << MCM_PLAMC_AMC_SHIFT);
  MCM_PLACR_REG(MCM_BASE_PTR) = MCM_PLACR_REG(MCM_BASE_PTR) + 1;
  ...
  MCM_PID_REG(MCM_BASE_PTR) = MCM_PID_REG(MCM_BASE_PTR) + 1;
  (void)MCM_PID_PID_MASK;
  (void)MCM_PID_PID_SHIFT;
  (void)MCM_PID_PID(1);
  MCM_PID |= MCM_PID_PID_MASK;
  MCM_PID &= ~(1U << MCM_PID_PID_SHIFT);
  MCM_CPO_REG(MCM_BASE_PTR) = MCM_CPO_REG(MCM_BASE_PTR) + 1;
  ...
  MCM_MATCR_REG(MCM_BASE_PTR,0) = MCM_MATCR_REG(MCM_BASE_PTR,0) + 1;
...
void test_MPU(void) {
  ...
  MPU_CESR_REG(MPU_BASE_PTR) = MPU_CESR_REG(MPU_BASE_PTR) + 1;
  ...
  MPU_EAR0 |= MPU_EAR_EADDR_MASK;
  MPU_EAR0 &= ~(1U << MPU_EAR_EADDR_SHIFT);
  (void)MPU_EDR_ERW_MASK;
  (void)MPU_EDR_ERW_SHIFT;
  MPU_EDR0 |= MPU_EDR_ERW_MASK;
  MPU_EDR0 &= ~(1U << MPU_EDR_ERW_SHIFT);
  (void)MPU_EDR_EATTR_MASK;
  (void)MPU_EDR_EATTR_SHIFT;
  (void)MPU_EDR_EATTR(1);
  MPU_EDR0 |= MPU_EDR_EATTR_MASK;
  MPU_EDR0 &= ~(1U << MPU_EDR_EATTR_SHIFT);
  (void)MPU_EDR_EMN_MASK;
  (void)MPU_EDR_EMN_SHIFT;
  (void)MPU_EDR_EMN(1);
  MPU_EDR0 |= MPU_EDR_EMN_MASK;
  MPU_EDR0 &= ~(1U << MPU_EDR_EMN_SHIFT);
  (void)MPU_EDR_EPID_MASK;
  (void)MPU_EDR_EPID_SHIFT;
  (void)MPU_EDR_EPID(1);
  MPU_EDR0 |= MPU_EDR_EPID_MASK;
  MPU_EDR0 &= ~(1U << MPU_EDR_EPID_SHIFT);
  (void)MPU_EDR_EACD_MASK;
  (void)MPU_EDR_EACD_SHIFT;
  (void)MPU_EDR_EACD(1);
  MPU_EDR0 |= MPU_EDR_EACD_MASK;
  MPU_EDR0 &= ~(1U << MPU_EDR_EACD_SHIFT);
  MPU_WORD_REG(MPU_BASE_PTR,0,0) = MPU_WORD_REG(MPU_BASE_PTR,0,0) + 1;
  ...
  MPU_RGDAAC_REG(MPU_BASE_PTR,0) = MPU_RGDAAC_REG(MPU_BASE_PTR,0) + 1;
...
void test_MTB(void) {
  ...
  MTB_FLOW = MTB_FLOW + 1;
  MTB_POSITION_REG(MTB_BASE_PTR) = MTB_POSITION_REG(MTB_BASE_PTR) + 1;
  ...
  MTB_MASTER_REG(MTB_BASE_PTR) = MTB_MASTER_REG(MTB_BASE_PTR) + 1;
  ...
  MTB_FLOW_REG(MTB_BASE_PTR) = MTB_FLOW_REG(MTB_BASE_PTR) + 1;
  ...
  MTB_BASE |= MTB_BASE_BASEADDR_MASK;
  MTB_BASE &= ~(1U << MTB_BASE_BASEADDR_SHIFT);
  (void)MTB_MODECTRL_MODECTRL_MASK;
  (void)MTB_MODECTRL_MODECTRL_SHIFT;
  (void)MTB_MODECTRL_MODECTRL(1);
  MTB_MODECTRL |= MTB_MODECTRL_MODECTRL_MASK;
  MTB_MODECTRL &= ~(1U << MTB_MODECTRL_MODECTRL_SHIFT);
  (void)MTB_TAGSET_TAGSET_MASK;
  (void)MTB_TAGSET_TAGSET_SHIFT;
  (void)MTB_TAGSET_TAGSET(1);
  MTB_TAGSET |= MTB_TAGSET_TAGSET_MASK;
  MTB_TAGSET &= ~(1U << MTB_TAGSET_TAGSET_SHIFT);
  (void)MTB_TAGCLEAR_TAGCLEAR_MASK;
  (void)MTB_TAGCLEAR_TAGCLEAR_SHIFT;
  (void)MTB_TAGCLEAR_TAGCLEAR(1);
  MTB_TAGCLEAR |= MTB_TAGCLEAR_TAGCLEAR_MASK;
  MTB_TAGCLEAR &= ~(1U << MTB_TAGCLEAR_TAGCLEAR_SHIFT);
  (void)MTB_LOCKACCESS_LOCKACCESS_MASK;
  (void)MTB_LOCKACCESS_LOCKACCESS_SHIFT;
  (void)MTB_LOCKACCESS_LOCKACCESS(1);
  MTB_LOCKACCESS |= MTB_LOCKACCESS_LOCKACCESS_MASK;
  MTB_LOCKACCESS &= ~(1U << MTB_LOCKACCESS_LOCKACCESS_SHIFT);
  (void)MTB_LOCKSTAT_LOCKSTAT_MASK;
  (void)MTB_LOCKSTAT_LOCKSTAT_SHIFT;
  (void)MTB_LOCKSTAT_LOCKSTAT(1);
  MTB_LOCKSTAT |= MTB_LOCKSTAT_LOCKSTAT_MASK;
  MTB_LOCKSTAT &= ~(1U << MTB_LOCKSTAT_LOCKSTAT_SHIFT);
  (void)MTB_AUTHSTAT_BIT0_MASK;
  (void)MTB_AUTHSTAT_BIT0_SHIFT;
  MTB_AUTHSTAT |= MTB_AUTHSTAT_BIT0_MASK;
  MTB_AUTHSTAT &= ~(1U << MTB_AUTHSTAT_BIT0_SHIFT);
  (void)MTB_AUTHSTAT_BIT1_MASK;
  (void)MTB_AUTHSTAT_BIT1_SHIFT;
  MTB_AUTHSTAT |= MTB_AUTHSTAT_BIT1_MASK;
  MTB_AUTHSTAT &= ~(1U << MTB_AUTHSTAT_BIT1_SHIFT);
  (void)MTB_AUTHSTAT_BIT2_MASK;
  (void)MTB_AUTHSTAT_BIT2_SHIFT;
  MTB_AUTHSTAT |= MTB_AUTHSTAT_BIT2_MASK;
  MTB_AUTHSTAT &= ~(1U << MTB_AUTHSTAT_BIT2_SHIFT);
  (void)MTB_AUTHSTAT_BIT3_MASK;
  (void)MTB_AUTHSTAT_BIT3_SHIFT;
  MTB_AUTHSTAT |= MTB_AUTHSTAT_BIT3_MASK;
  MTB_AUTHSTAT &= ~(1U << MTB_AUTHSTAT_BIT3_SHIFT);
  (void)MTB_DEVICEARCH_DEVICEARCH_MASK;
  (void)MTB_DEVICEARCH_DEVICEARCH_SHIFT;
  (void)MTB_DEVICEARCH_DEVICEARCH(1);
  MTB_DEVICEARCH |= MTB_DEVICEARCH_DEVICEARCH_MASK;
  MTB_DEVICEARCH &= ~(1U << MTB_DEVICEARCH_DEVICEARCH_SHIFT);
  (void)MTB_DEVICECFG_DEVICECFG_MASK;
  (void)MTB_DEVICECFG_DEVICECFG_SHIFT;
  (void)MTB_DEVICECFG_DEVICECFG(1);
  MTB_DEVICECFG |= MTB_DEVICECFG_DEVICECFG_MASK;
  MTB_DEVICECFG &= ~(1U << MTB_DEVICECFG_DEVICECFG_SHIFT);
  (void)MTB_DEVICETYPID_DEVICETYPID_MASK;
  (void)MTB_DEVICETYPID_DEVICETYPID_SHIFT;
  (void)MTB_DEVICETYPID_DEVICETYPID(1);
  MTB_DEVICETYPID |= MTB_DEVICETYPID_DEVICETYPID_MASK;
  MTB_DEVICETYPID &= ~(1U << MTB_DEVICETYPID_DEVICETYPID_SHIFT);
  (void)MTB_PERIPHID_PERIPHID_MASK;
  (void)MTB_PERIPHID_PERIPHID_SHIFT;
  (void)MTB_PERIPHID_PERIPHID(1);
  MTB_PERIPHID4 |= MTB_PERIPHID_PERIPHID_MASK;
  MTB_PERIPHID4 &= ~(1U << MTB_PERIPHID_PERIPHID_SHIFT);
  (void)MTB_COMPID_COMPID_MASK;
  (void)MTB_COMPID_COMPID_SHIFT;
  (void)MTB_COMPID_COMPID(1);
  MTB_COMPID0 |= MTB_COMPID_COMPID_MASK;
  MTB_COMPID0 &= ~(1U << MTB_COMPID_COMPID_SHIFT);
}

void test_MTBDWT(void) {
  (void)MTBDWT_BASE_PTR;
  ...
  MTBDWT_CTRL |= MTBDWT_CTRL_DWTCFGCTRL_MASK;
  MTBDWT_CTRL &= ~(1U << MTBDWT_CTRL_DWTCFGCTRL_SHIFT);
  (void)MTBDWT_CTRL_NUMCMP_MASK;
  (void)MTBDWT_CTRL_NUMCMP_SHIFT;
  (void)MTBDWT_CTRL_NUMCMP(1);
  MTBDWT_CTRL |= MTBDWT_CTRL_NUMCMP_MASK;
  MTBDWT_CTRL &= ~(1U << MTBDWT_CTRL_NUMCMP_SHIFT);
  MTBDWT_COMP_REG(MTBDWT_BASE_PTR,0) = MTBDWT_COMP_REG(MTBDWT_BASE_PTR,0) + 1;
  ...
  MTBDWT_MASK_REG(MTBDWT_BASE_PTR,0) = MTBDWT_MASK_REG(MTBDWT_BASE_PTR,0) + 1;
  ...
  MTBDWT_FCT_REG(MTBDWT_BASE_PTR,0) = MTBDWT_FCT_REG(MTBDWT_BASE_PTR,0) + 1;
  ...
  MTBDWT_TBCTRL_REG(MTBDWT_BASE_PTR) = MTBDWT_TBCTRL_REG(MTBDWT_BASE_PTR) + 1;
  ...
  MTBDWT_DEVICECFG |= MTBDWT_DEVICECFG_DEVICECFG_MASK;
  MTBDWT_DEVICECFG &= ~(1U << MTBDWT_DEVICECFG_DEVICECFG_SHIFT);
  (void)MTBDWT_DEVICETYPID_DEVICETYPID_MASK;
  (void)MTBDWT_DEVICETYPID_DEVICETYPID_SHIFT;
  (void)MTBDWT_DEVICETYPID_DEVICETYPID(1);
  MTBDWT_DEVICETYPID |= MTBDWT_DEVICETYPID_DEVICETYPID_MASK;
  MTBDWT_DEVICETYPID &= ~(1U << MTBDWT_DEVICETYPID_DEVICETYPID_SHIFT);
  (void)MTBDWT_PERIPHID_PERIPHID_MASK;
  (void)MTBDWT_PERIPHID_PERIPHID_SHIFT;
  (void)MTBDWT_PERIPHID_PERIPHID(1);
  MTBDWT_PERIPHID4 |= MTBDWT_PERIPHID_PERIPHID_MASK;
  MTBDWT_PERIPHID4 &= ~(1U << MTBDWT_PERIPHID_PERIPHID_SHIFT);
  (void)MTBDWT_COMPID_COMPID_MASK;
  (void)MTBDWT_COMPID_COMPID_SHIFT;
  (void)MTBDWT_COMPID_COMPID(1);
  MTBDWT_COMPID0 |= MTBDWT_COMPID_COMPID_MASK;
  MTBDWT_COMPID0 &= ~(1U << MTBDWT_COMPID_COMPID_SHIFT);
}

void test_NV(void) {
  (void)FTFA_FlashConfig_BASE_PTR;
  (void)NV_BACKKEY3_KEY_MASK;
  (void)NV_BACKKEY3_KEY_SHIFT;
  (void)NV_BACKKEY3_KEY(1);
  NV_BACKKEY3 |= NV_BACKKEY3_KEY_MASK;
  NV_BACKKEY3 &= ~(1U << NV_BACKKEY3_KEY_SHIFT);
  (void)NV_BACKKEY2_KEY_MASK;
  (void)NV_BACKKEY2_KEY_SHIFT;
  (void)NV_BACKKEY2_KEY(1);
  NV_BACKKEY2 |= NV_BACKKEY2_KEY_MASK;
  NV_BACKKEY2 &= ~(1U << NV_BACKKEY2_KEY_SHIFT);
  (void)NV_BACKKEY1_KEY_MASK;
  (void)NV_BACKKEY1_KEY_SHIFT;
  (void)NV_BACKKEY1_KEY(1);
  NV_BACKKEY1 |= NV_BACKKEY1_KEY_MASK;
  NV_BACKKEY1 &= ~(1U << NV_BACKKEY1_KEY_SHIFT);
  (void)NV_BACKKEY0_KEY_MASK;
  (void)NV_BACKKEY0_KEY_SHIFT;
  (void)NV_BACKKEY0_KEY(1);
  NV_BACKKEY0 |= NV_BACKKEY0_KEY_MASK;
  NV_BACKKEY0 &= ~(1U << NV_BACKKEY0_KEY_SHIFT);
  (void)NV_BACKKEY7_KEY_MASK;
  (void)NV_BACKKEY7_KEY_SHIFT;
  (void)NV_BACKKEY7_KEY(1);
  NV_BACKKEY7 |= NV_BACKKEY7_KEY_MASK;
  NV_BACKKEY7 &= ~(1U << NV_BACKKEY7_KEY_SHIFT);
  (void)NV_BACKKEY6_KEY_MASK;
  (void)NV_BACKKEY6_KEY_SHIFT;
  (void)NV_BACKKEY6_KEY(1);
  NV_BACKKEY6 |= NV_BACKKEY6_KEY_MASK;
  NV_BACKKEY6 &= ~(1U << NV_BACKKEY6_KEY_SHIFT);
  (void)NV_BACKKEY5_KEY_MASK;
  (void)NV_BACKKEY5_KEY_SHIFT;
  (void)NV_BACKKEY5_KEY(1);
  NV_BACKKEY5 |= NV_BACKKEY5_KEY_MASK;
  NV_BACKKEY5 &= ~(1U << NV_BACKKEY5_KEY_SHIFT);
  (void)NV_BACKKEY4_KEY_MASK;
  (void)NV_BACKKEY4_KEY_SHIFT;
  (void)NV_BACKKEY4_KEY(1);
  NV_BACKKEY4 |= NV_BACKKEY4_KEY_MASK;
  NV_BACKKEY4 &= ~(1U << NV_BACKKEY4_KEY_SHIFT);
  (void)NV_FPROT3_PROT_MASK;
  (void)NV_FPROT3_PROT_SHIFT;
  (void)NV_FPROT3_PROT(1);
  NV_FPROT3 |= NV_FPROT3_PROT_MASK;
  NV_FPROT3 &= ~(1U << NV_FPROT3_PROT_SHIFT);
  (void)NV_FPROT2_PROT_MASK;
  (void)NV_FPROT2_PROT_SHIFT;
  (void)NV_FPROT2_PROT(1);
  NV_FPROT2 |= NV_FPROT2_PROT_MASK;
  NV_FPROT2 &= ~(1U << NV_FPROT2_PROT_SHIFT);
  (void)NV_FPROT1_PROT_MASK;
  (void)NV_FPROT1_PROT_SHIFT;
  (void)NV_FPROT1_PROT(1);
  NV_FPROT1 |= NV_FPROT1_PROT_MASK;
  NV_FPROT1 &= ~(1U << NV_FPROT1_PROT_SHIFT);
  (void)NV_FPROT0_PROT_MASK;
  (void)NV_FPROT0_PROT_SHIFT;
  (void)NV_FPROT0_PROT(1);
  NV_FPROT0 |= NV_FPROT0_PROT_MASK;
  NV_FPROT0 &= ~(1U << NV_FPROT0_PROT_SHIFT);
  (void)NV_FSEC_SEC_MASK;
  (void)NV_FSEC_SEC_SHIFT;
  (void)NV_FSEC_SEC(1);
  NV_FSEC |= NV_FSEC_SEC_MASK;
  NV_FSEC &= ~(1U << NV_FSEC_SEC_SHIFT);
  (void)NV_FSEC_FSLACC_MASK;
  (void)NV_FSEC_FSLACC_SHIFT;
  (void)NV_FSEC_FSLACC(1);
  NV_FSEC |= NV_FSEC_FSLACC_MASK;
  NV_FSEC &= ~(1U << NV_FSEC_FSLACC_SHIFT);
  (void)NV_FSEC_MEEN_MASK;
  (void)NV_FSEC_MEEN_SHIFT;
  (void)NV_FSEC_MEEN(1);
  NV_FSEC |= NV_FSEC_MEEN_MASK;
  NV_FSEC &= ~(1U << NV_FSEC_MEEN_SHIFT);
  (void)NV_FSEC_KEYEN_MASK;
  (void)NV_FSEC_KEYEN_SHIFT;
  (void)NV_FSEC_KEYEN(1);
  NV_FSEC |= NV_FSEC_KEYEN_MASK;
  NV_FSEC &= ~(1U << NV_FSEC_KEYEN_SHIFT);
  (void)NV_FOPT_LPBOOT_MASK;
  (void)NV_FOPT_LPBOOT_SHIFT;
  NV_FOPT |= NV_FOPT_LPBOOT_MASK;
  NV_FOPT &= ~(1U << NV_FOPT_LPBOOT_SHIFT);
  (void)NV_FOPT_NMI_EN_MASK;
  (void)NV_FOPT_NMI_EN_SHIFT;
  NV_FOPT |= NV_FOPT_NMI_EN_MASK;
  NV_FOPT &= ~(1U << NV_FOPT_NMI_EN_SHIFT);
  (void)NV_FOPT_EXE_MODE_MASK;
  (void)NV_FOPT_EXE_MODE_SHIFT;
  NV_FOPT |= NV_FOPT_EXE_MODE_MASK;
  NV_FOPT &= ~(1U << NV_FOPT_EXE_MODE_SHIFT);
  (void)NV_FOPT_CLK_SRC_MASK;
  (void)NV_FOPT_CLK_SRC_SHIFT;
  NV_FOPT |= NV_FOPT_CLK_SRC_MASK;
  NV_FOPT &= ~(1U << NV_FOPT_CLK_SRC_SHIFT);
}

void test_NVIC(void) {
  (void)NVIC_BASE_PTR;
  NVIC_ISER = NVIC_ISER + 1;
  NVIC_ICER = NVIC_ICER + 1;
  NVIC_ISPR = NVIC_ISPR + 1;
  NVIC_ICPR = NVIC_ICPR + 1;
  NVIC_IPR0 = NVIC_IPR0 + 1;
  NVIC_IPR1 = NVIC_IPR1 + 1;
  NVIC_IPR2 = NVIC_IPR2 + 1;
  NVIC_IPR3 = NVIC_IPR3 + 1;
  NVIC_IPR4 = NVIC_IPR4 + 1;
  NVIC_IPR5 = NVIC_IPR5 + 1;
  NVIC_IPR6 = NVIC_IPR6 + 1;
  NVIC_IPR7 = NVIC_IPR7 + 1;
  NVIC_ISER_REG(NVIC_BASE_PTR) = NVIC_ISER_REG(NVIC_BASE_PTR) + 1;
  (void)NVIC_ISER_SETENA0_MASK;
  (void)NVIC_ISER_SETENA0_SHIFT;
  NVIC_ISER |= NVIC_ISER_SETENA0_MASK;
  NVIC_ISER &= ~(1U << NVIC_ISER_SETENA0_SHIFT);
  (void)NVIC_ISER_SETENA1_MASK;
  (void)NVIC_ISER_SETENA1_SHIFT;
  NVIC_ISER |= NVIC_ISER_SETENA1_MASK;
  NVIC_ISER &= ~(1U << NVIC_ISER_SETENA1_SHIFT);
  (void)NVIC_ISER_SETENA2_MASK;
  (void)NVIC_ISER_SETENA2_SHIFT;
  NVIC_ISER |= NVIC_ISER_SETENA2_MASK;
  NVIC_ISER &= ~(1U << NVIC_ISER_SETENA2_SHIFT);
  (void)NVIC_ISER_SETENA3_MASK;
  (void)NVIC_ISER_SETENA3_SHIFT;
  NVIC_ISER |= NVIC_ISER_SETENA3_MASK;
  NVIC_ISER &= ~(1U << NVIC_ISER_SETENA3_SHIFT);
  (void)NVIC_ISER_SETENA4_MASK;
  (void)NVIC_ISER_SETENA4_SHIFT;
  NVIC_ISER |= NVIC_ISER_SETENA4_MASK;
  NVIC_ISER &= ~(1U << NVIC_ISER_SETENA4_SHIFT);
  (void)NVIC_ISER_SETENA5_MASK;
  (void)NVIC_ISER_SETENA5_SHIFT;
  NVIC_ISER |= NVIC_ISER_SETENA5_MASK;
  NVIC_ISER &= ~(1U << NVIC_ISER_SETENA5_SHIFT);
  (void)NVIC_ISER_SETENA6_MASK;
  (void)NVIC_ISER_SETENA6_SHIFT;
  NVIC_ISER |= NVIC_ISER_SETENA6_MASK;
  NVIC_ISER &= ~(1U << NVIC_ISER_SETENA6_SHIFT);
  (void)NVIC_ISER_SETENA7_MASK;
  (void)NVIC_ISER_SETENA7_SHIFT;
  NVIC_ISER |= NVIC_ISER_SETENA7_MASK;
  NVIC_ISER &= ~(1U << NVIC_ISER_SETENA7_SHIFT);
  (void)NVIC_ISER_SETENA8_MASK;
  (void)NVIC_ISER_SETENA8_SHIFT;
  NVIC_ISER |= NVIC_ISER_SETENA8_MASK;
  NVIC_ISER &= ~(1U << NVIC_ISER_SETENA8_SHIFT);
  (void)NVIC_ISER_SETENA9_MASK;
  (void)NVIC_ISER_SETENA9_SHIFT;
  NVIC_ISER |= NVIC_ISER_SETENA9_MASK;
  NVIC_ISER &= ~(1U << NVIC_ISER_SETENA9_SHIFT);
  (void)NVIC_ISER_SETENA10_MASK;
  (void)NVIC_ISER_SETENA10_SHIFT;
  NVIC_ISER |= NVIC_ISER_SETENA10_MASK;
  NVIC_ISER &= ~(1U << NVIC_ISER_SETENA10_SHIFT);
  (void)NVIC_ISER_SETENA11_MASK;
  (void)NVIC_ISER_SETENA11_SHIFT;
  NVIC_ISER |= NVIC_ISER_SETENA11_MASK;
  NVIC_ISER &= ~(1U << NVIC_ISER_SETENA11_SHIFT);
  (void)NVIC_ISER_SETENA12_MASK;
  (void)NVIC_ISER_SETENA12_SHIFT;
  NVIC_ISER |= NVIC_ISER_SETENA12_MASK;
  NVIC_ISER &= ~(1U << NVIC_ISER_SETENA12_SHIFT);
  (void)NVIC_ISER_SETENA13_MASK;
  (void)NVIC_ISER_SETENA13_SHIFT;
  NVIC_ISER |= NVIC_ISER_SETENA13_MASK;
  NVIC_ISER &= ~(1U << NVIC_ISER_SETENA13_SHIFT);
  (void)NVIC_ISER_SETENA14_MASK;
  (void)NVIC_ISER_SETENA14_SHIFT;
  NVIC_ISER |= NVIC_ISER_SETENA14_MASK;
  NVIC_ISER &= ~(1U << NVIC_ISER_SETENA14_SHIFT);
  (void)NVIC_ISER_SETENA15_MASK;
  (void)NVIC_ISER_SETENA15_SHIFT;
  NVIC_ISER |= NVIC_ISER_SETENA15_MASK;
  NVIC_ISER &= ~(1U << NVIC_ISER_SETENA15_SHIFT);
  (void)NVIC_ISER_SETENA16_MASK;
  (void)NVIC_ISER_SETENA16_SHIFT;
  NVIC_ISER |= NVIC_ISER_SETENA16_MASK;
  NVIC_ISER &= ~(1U << NVIC_ISER_SETENA16_SHIFT);
  (void)NVIC_ISER_SETENA17_MASK;
  (void)NVIC_ISER_SETENA17_SHIFT;
  NVIC_ISER |= NVIC_ISER_SETENA17_MASK;
  NVIC_ISER &= ~(1U << NVIC_ISER_SETENA17_SHIFT);
  (void)NVIC_ISER_SETENA18_MASK;
  (void)NVIC_ISER_SETENA18_SHIFT;
  NVIC_ISER |= NVIC_ISER_SETENA18_MASK;
  NVIC_ISER &= ~(1U << NVIC_ISER_SETENA18_SHIFT);
  (void)NVIC_ISER_SETENA19_MASK;
  (void)NVIC_ISER_SETENA19_SHIFT;
  NVIC_ISER |= NVIC_ISER_SETENA19_MASK;
  NVIC_ISER &= ~(1U << NVIC_ISER_SETENA19_SHIFT);
  (void)NVIC_ISER_SETENA20_MASK;
  (void)NVIC_ISER_SETENA20_SHIFT;
  NVIC_ISER |= NVIC_ISER_SETENA20_MASK;
  NVIC_ISER &= ~(1U << NVIC_ISER_SETENA20_SHIFT);
  (void)NVIC_ISER_SETENA21_MASK;
  (void)NVIC_ISER_SETENA21_SHIFT;
  NVIC_ISER |= NVIC_ISER_SETENA21_MASK;
  NVIC_ISER &= ~(1U << NVIC_ISER_SETENA21_SHIFT);
  (void)NVIC_ISER_SETENA22_MASK;
  (void)NVIC_ISER_SETENA22_SHIFT;
  NVIC_ISER |= NVIC_ISER_SETENA22_MASK;
  NVIC_ISER &= ~(1U << NVIC_ISER_SETENA22_SHIFT);
  (void)NVIC_ISER_SETENA23_MASK;
  (void)NVIC_ISER_SETENA23_SHIFT;
  NVIC_ISER |= NVIC_ISER_SETENA23_MASK;
  NVIC_ISER &= ~(1U << NVIC_ISER_SETENA23_SHIFT);
  (void)NVIC_ISER_SETENA24_MASK;
  (void)NVIC_ISER_SETENA24_SHIFT;
  NVIC_ISER |= NVIC_ISER_SETENA24_MASK;
  NVIC_ISER &= ~(1U << NVIC_ISER_SETENA24_SHIFT);
  (void)NVIC_ISER_SETENA25_MASK;
  (void)NVIC_ISER_SETENA25_SHIFT;
  NVIC_ISER |= NVIC_ISER_SETENA25_MASK;
  NVIC_ISER &= ~(1U << NVIC_ISER_SETENA25_SHIFT);
  (void)NVIC_ISER_SETENA26_MASK;
  (void)NVIC_ISER_SETENA26_SHIFT;
  NVIC_ISER |= NVIC_ISER_SETENA26_MASK;
  NVIC_ISER &= ~(1U << NVIC_ISER_SETENA26_SHIFT);
  (void)NVIC_ISER_SETENA27_MASK;
  (void)NVIC_ISER_SETENA27_SHIFT;
  NVIC_ISER |= NVIC_ISER_SETENA27_MASK;
  NVIC_ISER &= ~(1U << NVIC_ISER_SETENA27_SHIFT);
  (void)NVIC_ISER_SETENA28_MASK;
  (void)NVIC_ISER_SETENA28_SHIFT;
  NVIC_ISER |= NVIC_ISER_SETENA28_MASK;
  NVIC_ISER &= ~(1U << NVIC_ISER_SETENA28_SHIFT);
  (void)NVIC_ISER_SETENA29_MASK;
  (void)NVIC_ISER_SETENA29_SHIFT;
  NVIC_ISER |= NVIC_ISER_SETENA29_MASK;
  NVIC_ISER &= ~(1U << NVIC_ISER_SETENA29_SHIFT);
  (void)NVIC_ISER_SETENA30_MASK;
  (void)NVIC_ISER_SETENA30_SHIFT;
  NVIC_ISER |= NVIC_ISER_SETENA30_MASK;
  NVIC_ISER &= ~(1U << NVIC_ISER_SETENA30_SHIFT);
  (void)NVIC_ISER_SETENA31_MASK;
  (void)NVIC_ISER_SETENA31_SHIFT;
  NVIC_ISER |= NVIC_ISER_SETENA31_MASK;
  NVIC_ISER &= ~(1U << NVIC_ISER_SETENA31_SHIFT);
  NVIC_ICER_REG(NVIC_BASE_PTR) = NVIC_ICER_REG(NVIC_BASE_PTR) + 1;
  (void)NVIC_ICER_CLRENA0_MASK;
  (void)NVIC_ICER_CLRENA0_SHIFT;
  NVIC_ICER |= NVIC_ICER_CLRENA0_MASK;
  NVIC_ICER &= ~(1U << NVIC_ICER_CLRENA0_SHIFT);
  (void)NVIC_ICER_CLRENA1_MASK;
  (void)NVIC_ICER_CLRENA1_SHIFT;
  NVIC_ICER |= NVIC_ICER_CLRENA1_MASK;
  NVIC_ICER &= ~(1U << NVIC_ICER_CLRENA1_SHIFT);
  (void)NVIC_ICER_CLRENA2_MASK;
  (void)NVIC_ICER_CLRENA2_SHIFT;
  NVIC_ICER |= NVIC_ICER_CLRENA2_MASK;
  NVIC_ICER &= ~(1U << NVIC_ICER_CLRENA2_SHIFT);
  (void)NVIC_ICER_CLRENA3_MASK;
  (void)NVIC_ICER_CLRENA3_SHIFT;
  NVIC_ICER |= NVIC_ICER_CLRENA3_MASK;
  NVIC_ICER &= ~(1U << NVIC_ICER_CLRENA3_SHIFT);
  (void)NVIC_ICER_CLRENA4_MASK;
  (void)NVIC_ICER_CLRENA4_SHIFT;
  NVIC_ICER |= NVIC_ICER_CLRENA4_MASK;
  NVIC_ICER &= ~(1U << NVIC_ICER_CLRENA4_SHIFT);
  (void)NVIC_ICER_CLRENA5_MASK;
  (void)NVIC_ICER_CLRENA5_SHIFT;
  NVIC_ICER |= NVIC_ICER_CLRENA5_MASK;
  NVIC_ICER &= ~(1U << NVIC_ICER_CLRENA5_SHIFT);
  (void)NVIC_ICER_CLRENA6_MASK;
  (void)NVIC_ICER_CLRENA6_SHIFT;
  NVIC_ICER |= NVIC_ICER_CLRENA6_MASK;
  NVIC_ICER &= ~(1U << NVIC_ICER_CLRENA6_SHIFT);
  (void)NVIC_ICER_CLRENA7_MASK;
  (void)NVIC_ICER_CLRENA7_SHIFT;
  NVIC_ICER |= NVIC_ICER_CLRENA7_MASK;
  NVIC_ICER &= ~(1U << NVIC_ICER_CLRENA7_SHIFT);
  (void)NVIC_ICER_CLRENA8_MASK;
  (void)NVIC_ICER_CLRENA8_SHIFT;
  NVIC_ICER |= NVIC_ICER_CLRENA8_MASK;
  NVIC_ICER &= ~(1U << NVIC_ICER_CLRENA8_SHIFT);
  (void)NVIC_ICER_CLRENA9_MASK;
  (void)NVIC_ICER_CLRENA9_SHIFT;
  NVIC_ICER |= NVIC_ICER_CLRENA9_MASK;
  NVIC_ICER &= ~(1U << NVIC_ICER_CLRENA9_SHIFT);
  (void)NVIC_ICER_CLRENA10_MASK;
  (void)NVIC_ICER_CLRENA10_SHIFT;
  NVIC_ICER |= NVIC_ICER_CLRENA10_MASK;
  NVIC_ICER &= ~(1U << NVIC_ICER_CLRENA10_SHIFT);
  (void)NVIC_ICER_CLRENA11_MASK;
  (void)NVIC_ICER_CLRENA11_SHIFT;
  NVIC_ICER |= NVIC_ICER_CLRENA11_MASK;
  NVIC_ICER &= ~(1U << NVIC_ICER_CLRENA11_SHIFT);
  (void)NVIC_ICER_CLRENA12_MASK;
  (void)NVIC_ICER_CLRENA12_SHIFT;
  NVIC_ICER |= NVIC_ICER_CLRENA12_MASK;
  NVIC_ICER &= ~(1U << NVIC_ICER_CLRENA12_SHIFT);
  (void)NVIC_ICER_CLRENA13_MASK;
  (void)NVIC_ICER_CLRENA13_SHIFT;
  NVIC_ICER |= NVIC_ICER_CLRENA13_MASK;
  NVIC_ICER &= ~(1U << NVIC_ICER_CLRENA13_SHIFT);
  (void)NVIC_ICER_CLRENA14_MASK;
  (void)NVIC_ICER_CLRENA14_SHIFT;
  NVIC_ICER |= NVIC_ICER_CLRENA14_MASK;
  NVIC_ICER &= ~(1U << NVIC_ICER_CLRENA14_SHIFT);
  (void)NVIC_ICER_CLRENA15_MASK;
  (void)NVIC_ICER_CLRENA15_SHIFT;
  NVIC_ICER |= NVIC_ICER_CLRENA15_MASK;
  NVIC_ICER &= ~(1U << NVIC_ICER_CLRENA15_SHIFT);
  (void)NVIC_ICER_CLRENA16_MASK;
  (void)NVIC_ICER_CLRENA16_SHIFT;
  NVIC_ICER |= NVIC_ICER_CLRENA16_MASK;
  NVIC_ICER &= ~(1U << NVIC_ICER_CLRENA16_SHIFT);
  (void)NVIC_ICER_CLRENA17_MASK;
  (void)NVIC_ICER_CLRENA17_SHIFT;
  NVIC_ICER |= NVIC_ICER_CLRENA17_MASK;
  NVIC_ICER &= ~(1U << NVIC_ICER_CLRENA17_SHIFT);
  (void)NVIC_ICER_CLRENA18_MASK;
  (void)NVIC_ICER_CLRENA18_SHIFT;
  NVIC_ICER |= NVIC_ICER_CLRENA18_MASK;
  NVIC_ICER &= ~(1U << NVIC_ICER_CLRENA18_SHIFT);
  (void)NVIC_ICER_CLRENA19_MASK;
  (void)NVIC_ICER_CLRENA19_SHIFT;
  NVIC_ICER |= NVIC_ICER_CLRENA19_MASK;
  NVIC_ICER &= ~(1U << NVIC_ICER_CLRENA19_SHIFT);
  (void)NVIC_ICER_CLRENA20_MASK;
  (void)NVIC_ICER_CLRENA20_SHIFT;
  NVIC_ICER |= NVIC_ICER_CLRENA20_MASK;
  NVIC_ICER &= ~(1U << NVIC_ICER_CLRENA20_SHIFT);
  (void)NVIC_ICER_CLRENA21_MASK;
  (void)NVIC_ICER_CLRENA21_SHIFT;
  NVIC_ICER |= NVIC_ICER_CLRENA21_MASK;
  NVIC_ICER &= ~(1U << NVIC_ICER_CLRENA21_SHIFT);
  (void)NVIC_ICER_CLRENA22_MASK;
  (void)NVIC_ICER_CLRENA22_SHIFT;
  NVIC_ICER |= NVIC_ICER_CLRENA22_MASK;
  NVIC_ICER &= ~(1U << NVIC_ICER_CLRENA22_SHIFT);
  (void)NVIC_ICER_CLRENA23_MASK;
  (void)NVIC_ICER_CLRENA23_SHIFT;
  NVIC_ICER |= NVIC_ICER_CLRENA23_MASK;
  NVIC_ICER &= ~(1U << NVIC_ICER_CLRENA23_SHIFT);
  (void)NVIC_ICER_CLRENA24_MASK;
  (void)NVIC_ICER_CLRENA24_SHIFT;
  NVIC_ICER |= NVIC_ICER_CLRENA24_MASK;
  NVIC_ICER &= ~(1U << NVIC_ICER_CLRENA24_SHIFT);
  (void)NVIC_ICER_CLRENA25_MASK;
  (void)NVIC_ICER_CLRENA25_SHIFT;
  NVIC_ICER |= NVIC_ICER_CLRENA25_MASK;
  NVIC_ICER &= ~(1U << NVIC_ICER_CLRENA25_SHIFT);
  (void)NVIC_ICER_CLRENA26_MASK;
  (void)NVIC_ICER_CLRENA26_SHIFT;
  NVIC_ICER |= NVIC_ICER_CLRENA26_MASK;
  NVIC_ICER &= ~(1U << NVIC_ICER_CLRENA26_SHIFT);
  (void)NVIC_ICER_CLRENA27_MASK;
  (void)NVIC_ICER_CLRENA27_SHIFT;
  NVIC_ICER |= NVIC_ICER_CLRENA27_MASK;
  NVIC_ICER &= ~(1U << NVIC_ICER_CLRENA27_SHIFT);
  (void)NVIC_ICER_CLRENA28_MASK;
  (void)NVIC_ICER_CLRENA28_SHIFT;
  NVIC_ICER |= NVIC_ICER_CLRENA28_MASK;
  NVIC_ICER &= ~(1U << NVIC_ICER_CLRENA28_SHIFT);
  (void)NVIC_ICER_CLRENA29_MASK;
  (void)NVIC_ICER_CLRENA29_SHIFT;
  NVIC_ICER |= NVIC_ICER_CLRENA29_MASK;
  NVIC_ICER &= ~(1U << NVIC_ICER_CLRENA29_SHIFT);
  (void)NVIC_ICER_CLRENA30_MASK;
  (void)NVIC_ICER_CLRENA30_SHIFT;
  NVIC_ICER |= NVIC_ICER_CLRENA30_MASK;
  NVIC_ICER &= ~(1U << NVIC_ICER_CLRENA30_SHIFT);
  (void)NVIC_ICER_CLRENA31_MASK;
  (void)NVIC_ICER_CLRENA31_SHIFT;
  NVIC_ICER |= NVIC_ICER_CLRENA31_MASK;
  NVIC_ICER &= ~(1U << NVIC_ICER_CLRENA31_SHIFT);
  NVIC_ISPR_REG(NVIC_BASE_PTR) = NVIC_ISPR_REG(NVIC_BASE_PTR) + 1;
  (void)NVIC_ISPR_SETPEND0_MASK;
  (void)NVIC_ISPR_SETPEND0_SHIFT;
  NVIC_ISPR |= NVIC_ISPR_SETPEND0_MASK;
  NVIC_ISPR &= ~(1U << NVIC_ISPR_SETPEND0_SHIFT);
  (void)NVIC_ISPR_SETPEND1_MASK;
  (void)NVIC_ISPR_SETPEND1_SHIFT;
  NVIC_ISPR |= NVIC_ISPR_SETPEND1_MASK;
  NVIC_ISPR &= ~(1U << NVIC_ISPR_SETPEND1_SHIFT);
  (void)NVIC_ISPR_SETPEND2_MASK;
  (void)NVIC_ISPR_SETPEND2_SHIFT;
  NVIC_ISPR |= NVIC_ISPR_SETPEND2_MASK;
  NVIC_ISPR &= ~(1U << NVIC_ISPR_SETPEND2_SHIFT);
  (void)NVIC_ISPR_SETPEND3_MASK;
  (void)NVIC_ISPR_SETPEND3_SHIFT;
  NVIC_ISPR |= NVIC_ISPR_SETPEND3_MASK;
  NVIC_ISPR &= ~(1U << NVIC_ISPR_SETPEND3_SHIFT);
  (void)NVIC_ISPR_SETPEND4_MASK;
  (void)NVIC_ISPR_SETPEND4_SHIFT;
  NVIC_ISPR |= NVIC_ISPR_SETPEND4_MASK;
  NVIC_ISPR &= ~(1U << NVIC_ISPR_SETPEND4_SHIFT);
  (void)NVIC_ISPR_SETPEND5_MASK;
  (void)NVIC_ISPR_SETPEND5_SHIFT;
  NVIC_ISPR |= NVIC_ISPR_SETPEND5_MASK;
  NVIC_ISPR &= ~(1U << NVIC_ISPR_SETPEND5_SHIFT);
  (void)NVIC_ISPR_SETPEND6_MASK;
  (void)NVIC_ISPR_SETPEND6_SHIFT;
  NVIC_ISPR |= NVIC_ISPR_SETPEND6_MASK;
  NVIC_ISPR &= ~(1U << NVIC_ISPR_SETPEND6_SHIFT);
  (void)NVIC_ISPR_SETPEND7_MASK;
  (void)NVIC_ISPR_SETPEND7_SHIFT;
  NVIC_ISPR |= NVIC_ISPR_SETPEND7_MASK;
  NVIC_ISPR &= ~(1U << NVIC_ISPR_SETPEND7_SHIFT);
  (void)NVIC_ISPR_SETPEND8_MASK;
  (void)NVIC_ISPR_SETPEND8_SHIFT;
  NVIC_ISPR |= NVIC_ISPR_SETPEND8_MASK;
  NVIC_ISPR &= ~(1U << NVIC_ISPR_SETPEND8_SHIFT);
  (void)NVIC_ISPR_SETPEND9_MASK;
  (void)NVIC_ISPR_SETPEND9_SHIFT;
  NVIC_ISPR |= NVIC_ISPR_SETPEND9_MASK;
  NVIC_ISPR &= ~(1U << NVIC_ISPR_SETPEND9_SHIFT);
  (void)NVIC_ISPR_SETPEND10_MASK;
  (void)NVIC_ISPR_SETPEND10_SHIFT;
  NVIC_ISPR |= NVIC_ISPR_SETPEND10_MASK;
  NVIC_ISPR &= ~(1U << NVIC_ISPR_SETPEND10_SHIFT);
  (void)NVIC_ISPR_SETPEND11_MASK;
  (void)NVIC_ISPR_SETPEND11_SHIFT;
  NVIC_ISPR |= NVIC_ISPR_SETPEND11_MASK;
  NVIC_ISPR &= ~(1U << NVIC_ISPR_SETPEND11_SHIFT);
  (void)NVIC_ISPR_SETPEND12_MASK;
  (void)NVIC_ISPR_SETPEND12_SHIFT;
  NVIC_ISPR |= NVIC_ISPR_SETPEND12_MASK;
  NVIC_ISPR &= ~(1U << NVIC_ISPR_SETPEND12_SHIFT);
  (void)NVIC_ISPR_SETPEND13_MASK;
  (void)NVIC_ISPR_SETPEND13_SHIFT;
  NVIC_ISPR |= NVIC_ISPR_SETPEND13_MASK;
  NVIC_ISPR &= ~(1U << NVIC_ISPR_SETPEND13_SHIFT);
  (void)NVIC_ISPR_SETPEND14_MASK;
  (void)NVIC_ISPR_SETPEND14_SHIFT;
  NVIC_ISPR |= NVIC_ISPR_SETPEND14_MASK;
  NVIC_ISPR &= ~(1U << NVIC_ISPR_SETPEND14_SHIFT);
  (void)NVIC_ISPR_SETPEND15_MASK;
  (void)NVIC_ISPR_SETPEND15_SHIFT;
  NVIC_ISPR |= NVIC_ISPR_SETPEND15_MASK;
  NVIC_ISPR &= ~(1U << NVIC_ISPR_SETPEND15_SHIFT);
  (void)NVIC_ISPR_SETPEND16_MASK;
  (void)NVIC_ISPR_SETPEND16_SHIFT;
  NVIC_ISPR |= NVIC_ISPR_SETPEND16_MASK;
  NVIC_ISPR &= ~(1U << NVIC_ISPR_SETPEND16_SHIFT);
  (void)NVIC_ISPR_SETPEND17_MASK;
  (void)NVIC_ISPR_SETPEND17_SHIFT;
  NVIC_ISPR |= NVIC_ISPR_SETPEND17_MASK;
  NVIC_ISPR &= ~(1U << NVIC_ISPR_SETPEND17_SHIFT);
  (void)NVIC_ISPR_SETPEND18_MASK;
  (void)NVIC_ISPR_SETPEND18_SHIFT;
  NVIC_ISPR |= NVIC_ISPR_SETPEND18_MASK;
  NVIC_ISPR &= ~(1U << NVIC_ISPR_SETPEND18_SHIFT);
  (void)NVIC_ISPR_SETPEND19_MASK;
  (void)NVIC_ISPR_SETPEND19_SHIFT;
  NVIC_ISPR |= NVIC_ISPR_SETPEND19_MASK;
  NVIC_ISPR &= ~(1U << NVIC_ISPR_SETPEND19_SHIFT);
  (void)NVIC_ISPR_SETPEND20_MASK;
  (void)NVIC_ISPR_SETPEND20_SHIFT;
  NVIC_ISPR |= NVIC_ISPR_SETPEND20_MASK;
  NVIC_ISPR &= ~(1U << NVIC_ISPR_SETPEND20_SHIFT);
  (void)NVIC_ISPR_SETPEND21_MASK;
  (void)NVIC_ISPR_SETPEND21_SHIFT;
  NVIC_ISPR |= NVIC_ISPR_SETPEND21_MASK;
  NVIC_ISPR &= ~(1U << NVIC_ISPR_SETPEND21_SHIFT);
  (void)NVIC_ISPR_SETPEND22_MASK;
  (void)NVIC_ISPR_SETPEND22_SHIFT;
  NVIC_ISPR |= NVIC_ISPR_SETPEND22_MASK;
  NVIC_ISPR &= ~(1U << NVIC_ISPR_SETPEND22_SHIFT);
  (void)NVIC_ISPR_SETPEND23_MASK;
  (void)NVIC_ISPR_SETPEND23_SHIFT;
  NVIC_ISPR |= NVIC_ISPR_SETPEND23_MASK;
  NVIC_ISPR &= ~(1U << NVIC_ISPR_SETPEND23_SHIFT);
  (void)NVIC_ISPR_SETPEND24_MASK;
  (void)NVIC_ISPR_SETPEND24_SHIFT;
  NVIC_ISPR |= NVIC_ISPR_SETPEND24_MASK;
  NVIC_ISPR &= ~(1U << NVIC_ISPR_SETPEND24_SHIFT);
  (void)NVIC_ISPR_SETPEND25_MASK;
  (void)NVIC_ISPR_SETPEND25_SHIFT;
  NVIC_ISPR |= NVIC_ISPR_SETPEND25_MASK;
  NVIC_ISPR &= ~(1U << NVIC_ISPR_SETPEND25_SHIFT);
  (void)NVIC_ISPR_SETPEND26_MASK;
  (void)NVIC_ISPR_SETPEND26_SHIFT;
  NVIC_ISPR |= NVIC_ISPR_SETPEND26_MASK;
  NVIC_ISPR &= ~(1U << NVIC_ISPR_SETPEND26_SHIFT);
  (void)NVIC_ISPR_SETPEND27_MASK;
  (void)NVIC_ISPR_SETPEND27_SHIFT;
  NVIC_ISPR |= NVIC_ISPR_SETPEND27_MASK;
  NVIC_ISPR &= ~(1U << NVIC_ISPR_SETPEND27_SHIFT);
  (void)NVIC_ISPR_SETPEND28_MASK;
  (void)NVIC_ISPR_SETPEND28_SHIFT;
  NVIC_ISPR |= NVIC_ISPR_SETPEND28_MASK;
  NVIC_ISPR &= ~(1U << NVIC_ISPR_SETPEND28_SHIFT);
  (void)NVIC_ISPR_SETPEND29_MASK;
  (void)NVIC_ISPR_SETPEND29_SHIFT;
  NVIC_ISPR |= NVIC_ISPR_SETPEND29_MASK;
  NVIC_ISPR &= ~(1U << NVIC_ISPR_SETPEND29_SHIFT);
  (void)NVIC_ISPR_SETPEND30_MASK;
  (void)NVIC_ISPR_SETPEND30_SHIFT;
  NVIC_ISPR |= NVIC_ISPR_SETPEND30_MASK;
  NVIC_ISPR &= ~(1U << NVIC_ISPR_SETPEND30_SHIFT);
  (void)NVIC_ISPR_SETPEND31_MASK;
  (void)NVIC_ISPR_SETPEND31_SHIFT;
  NVIC_ISPR |= NVIC_ISPR_SETPEND31_MASK;
  NVIC_ISPR &= ~(1U << NVIC_ISPR_SETPEND31_SHIFT);
  NVIC_ICPR_REG(NVIC_BASE_PTR) = NVIC_ICPR_REG(NVIC_BASE_PTR) + 1;
  (void)NVIC_ICPR_CLRPEND0_MASK;
  (void)NVIC_ICPR_CLRPEND0_SHIFT;
  NVIC_ICPR |= NVIC_ICPR_CLRPEND0_MASK;
  NVIC_ICPR &= ~(1U << NVIC_ICPR_CLRPEND0_SHIFT);
  (void)NVIC_ICPR_CLRPEND1_MASK;
  (void)NVIC_ICPR_CLRPEND1_SHIFT;
  NVIC_ICPR |= NVIC_ICPR_CLRPEND1_MASK;
  NVIC_ICPR &= ~(1U << NVIC_ICPR_CLRPEND1_SHIFT);
  (void)NVIC_ICPR_CLRPEND2_MASK;
  (void)NVIC_ICPR_CLRPEND2_SHIFT;
  NVIC_ICPR |= NVIC_ICPR_CLRPEND2_MASK;
  NVIC_ICPR &= ~(1U << NVIC_ICPR_CLRPEND2_SHIFT);
  (void)NVIC_ICPR_CLRPEND3_MASK;
  (void)NVIC_ICPR_CLRPEND3_SHIFT;
  NVIC_ICPR |= NVIC_ICPR_CLRPEND3_MASK;
  NVIC_ICPR &= ~(1U << NVIC_ICPR_CLRPEND3_SHIFT);
  (void)NVIC_ICPR_CLRPEND4_MASK;
  (void)NVIC_ICPR_CLRPEND4_SHIFT;
  NVIC_ICPR |= NVIC_ICPR_CLRPEND4_MASK;
  NVIC_ICPR &= ~(1U << NVIC_ICPR_CLRPEND4_SHIFT);
  (void)NVIC_ICPR_CLRPEND5_MASK;
  (void)NVIC_ICPR_CLRPEND5_SHIFT;
  NVIC_ICPR |= NVIC_ICPR_CLRPEND5_MASK;
  NVIC_ICPR &= ~(1U << NVIC_ICPR_CLRPEND5_SHIFT);
  (void)NVIC_ICPR_CLRPEND6_MASK;
  (void)NVIC_ICPR_CLRPEND6_SHIFT;
  NVIC_ICPR |= NVIC_ICPR_CLRPEND6_MASK;
  NVIC_ICPR &= ~(1U << NVIC_ICPR_CLRPEND6_SHIFT);
  (void)NVIC_ICPR_CLRPEND7_MASK;
  (void)NVIC_ICPR_CLRPEND7_SHIFT;
  NVIC_ICPR |= NVIC_ICPR_CLRPEND7_MASK;
  NVIC_ICPR &= ~(1U << NVIC_ICPR_CLRPEND7_SHIFT);
  (void)NVIC_ICPR_CLRPEND8_MASK;
  (void)NVIC_ICPR_CLRPEND8_SHIFT;
  NVIC_ICPR |= NVIC_ICPR_CLRPEND8_MASK;
  NVIC_ICPR &= ~(1U << NVIC_ICPR_CLRPEND8_SHIFT);
  (void)NVIC_ICPR_CLRPEND9_MASK;
  (void)NVIC_ICPR_CLRPEND9_SHIFT;
  NVIC_ICPR |= NVIC_ICPR_CLRPEND9_MASK;
  NVIC_ICPR &= ~(1U << NVIC_ICPR_CLRPEND9_SHIFT);
  (void)NVIC_ICPR_CLRPEND10_MASK;
  (void)NVIC_ICPR_CLRPEND10_SHIFT;
  NVIC_ICPR |= NVIC_ICPR_CLRPEND10_MASK;
  NVIC_ICPR &= ~(1U << NVIC_ICPR_CLRPEND10_SHIFT);
  (void)NVIC_ICPR_CLRPEND11_MASK;
  (void)NVIC_ICPR_CLRPEND11_SHIFT;
  NVIC_ICPR |= NVIC_ICPR_CLRPEND11_MASK;
  NVIC_ICPR &= ~(1U << NVIC_ICPR_CLRPEND11_SHIFT);
  (void)NVIC_ICPR_CLRPEND12_MASK;
  (void)NVIC_ICPR_CLRPEND12_SHIFT;
  NVIC_ICPR |= NVIC_ICPR_CLRPEND12_MASK;
  NVIC_ICPR &= ~(1U << NVIC_ICPR_CLRPEND12_SHIFT);
  (void)NVIC_ICPR_CLRPEND13_MASK;
  (void)NVIC_ICPR_CLRPEND13_SHIFT;
  NVIC_ICPR |= NVIC_ICPR_CLRPEND13_MASK;
  NVIC_ICPR &= ~(1U << NVIC_ICPR_CLRPEND13_SHIFT);
  (void)NVIC_ICPR_CLRPEND14_MASK;
  (void)NVIC_ICPR_CLRPEND14_SHIFT;
  NVIC_ICPR |= NVIC_ICPR_CLRPEND14_MASK;
  NVIC_ICPR &= ~(1U << NVIC_ICPR_CLRPEND14_SHIFT);
  (void)NVIC_ICPR_CLRPEND15_MASK;
  (void)NVIC_ICPR_CLRPEND15_SHIFT;
  NVIC_ICPR |= NVIC_ICPR_CLRPEND15_MASK;
  NVIC_ICPR &= ~(1U << NVIC_ICPR_CLRPEND15_SHIFT);
  (void)NVIC_ICPR_CLRPEND16_MASK;
  (void)NVIC_ICPR_CLRPEND16_SHIFT;
  NVIC_ICPR |= NVIC_ICPR_CLRPEND16_MASK;
  NVIC_ICPR &= ~(1U << NVIC_ICPR_CLRPEND16_SHIFT);
  (void)NVIC_ICPR_CLRPEND17_MASK;
  (void)NVIC_ICPR_CLRPEND17_SHIFT;
  NVIC_ICPR |= NVIC_ICPR_CLRPEND17_MASK;
  NVIC_ICPR &= ~(1U << NVIC_ICPR_CLRPEND17_SHIFT);
  (void)NVIC_ICPR_CLRPEND18_MASK;
  (void)NVIC_ICPR_CLRPEND18_SHIFT;
  NVIC_ICPR |= NVIC_ICPR_CLRPEND18_MASK;
  NVIC_ICPR &= ~(1U << NVIC_ICPR_CLRPEND18_SHIFT);
  (void)NVIC_ICPR_CLRPEND19_MASK;
  (void)NVIC_ICPR_CLRPEND19_SHIFT;
  NVIC_ICPR |= NVIC_ICPR_CLRPEND19_MASK;
  NVIC_ICPR &= ~(1U << NVIC_ICPR_CLRPEND19_SHIFT);
  (void)NVIC_ICPR_CLRPEND20_MASK;
  (void)NVIC_ICPR_CLRPEND20_SHIFT;
  NVIC_ICPR |= NVIC_ICPR_CLRPEND20_MASK;
  NVIC_ICPR &= ~(1U << NVIC_ICPR_CLRPEND20_SHIFT);
  (void)NVIC_ICPR_CLRPEND21_MASK;
  (void)NVIC_ICPR_CLRPEND21_SHIFT;
  NVIC_ICPR |= NVIC_ICPR_CLRPEND21_MASK;
  NVIC_ICPR &= ~(1U << NVIC_ICPR_CLRPEND21_SHIFT);
  (void)NVIC_ICPR_CLRPEND22_MASK;
  (void)NVIC_ICPR_CLRPEND22_SHIFT;
  NVIC_ICPR |= NVIC_ICPR_CLRPEND22_MASK;
  NVIC_ICPR &= ~(1U << NVIC_ICPR_CLRPEND22_SHIFT);
  (void)NVIC_ICPR_CLRPEND23_MASK;
  (void)NVIC_ICPR_CLRPEND23_SHIFT;
  NVIC_ICPR |= NVIC_ICPR_CLRPEND23_MASK;
  NVIC_ICPR &= ~(1U << NVIC_ICPR_CLRPEND23_SHIFT);
  (void)NVIC_ICPR_CLRPEND24_MASK;
  (void)NVIC_ICPR_CLRPEND24_SHIFT;
  NVIC_ICPR |= NVIC_ICPR_CLRPEND24_MASK;
  NVIC_ICPR &= ~(1U << NVIC_ICPR_CLRPEND24_SHIFT);
  (void)NVIC_ICPR_CLRPEND25_MASK;
  (void)NVIC_ICPR_CLRPEND25_SHIFT;
  NVIC_ICPR |= NVIC_ICPR_CLRPEND25_MASK;
  NVIC_ICPR &= ~(1U << NVIC_ICPR_CLRPEND25_SHIFT);
  (void)NVIC_ICPR_CLRPEND26_MASK;
  (void)NVIC_ICPR_CLRPEND26_SHIFT;
  NVIC_ICPR |= NVIC_ICPR_CLRPEND26_MASK;
  NVIC_ICPR &= ~(1U << NVIC_ICPR_CLRPEND26_SHIFT);
  (void)NVIC_ICPR_CLRPEND27_MASK;
  (void)NVIC_ICPR_CLRPEND27_SHIFT;
  NVIC_ICPR |= NVIC_ICPR_CLRPEND27_MASK;
  NVIC_ICPR &= ~(1U << NVIC_ICPR_CLRPEND27_SHIFT);
  (void)NVIC_ICPR_CLRPEND28_MASK;
  (void)NVIC_ICPR_CLRPEND28_SHIFT;
  NVIC_ICPR |= NVIC_ICPR_CLRPEND28_MASK;
  NVIC_ICPR &= ~(1U << NVIC_ICPR_CLRPEND28_SHIFT);
  (void)NVIC_ICPR_CLRPEND29_MASK;
  (void)NVIC_ICPR_CLRPEND29_SHIFT;
  NVIC_ICPR |= NVIC_ICPR_CLRPEND29_MASK;
  NVIC_ICPR &= ~(1U << NVIC_ICPR_CLRPEND29_SHIFT);
  (void)NVIC_ICPR_CLRPEND30_MASK;
  (void)NVIC_ICPR_CLRPEND30_SHIFT;
  NVIC_ICPR |= NVIC_ICPR_CLRPEND30_MASK;
  NVIC_ICPR &= ~(1U << NVIC_ICPR_CLRPEND30_SHIFT);
  (void)NVIC_ICPR_CLRPEND31_MASK;
  (void)NVIC_ICPR_CLRPEND31_SHIFT;
  NVIC_ICPR |= NVIC_ICPR_CLRPEND31_MASK;
  NVIC_ICPR &= ~(1U << NVIC_ICPR_CLRPEND31_SHIFT);
  NVIC_IP_REG(NVIC_BASE_PTR,0) = NVIC_IP_REG(NVIC_BASE_PTR,0) + 1;
  NVIC_IP(0) = NVIC_IP(0) + 1;
  (void)NVIC_IP_PRI_0_MASK;
  (void)NVIC_IP_PRI_0_SHIFT;
  (void)NVIC_IP_PRI_0(1);
  NVIC_IPR0 |= NVIC_IP_PRI_0_MASK;
  NVIC_IPR0 &= ~(1U << NVIC_IP_PRI_0_SHIFT);
  (void)NVIC_IP_PRI_28_MASK;
  (void)NVIC_IP_PRI_28_SHIFT;
  (void)NVIC_IP_PRI_28(1);
  NVIC_IPR0 |= NVIC_IP_PRI_28_MASK;
  NVIC_IPR0 &= ~(1U << NVIC_IP_PRI_28_SHIFT);
  (void)NVIC_IP_PRI_24_MASK;
  (void)NVIC_IP_PRI_24_SHIFT;
  (void)NVIC_IP_PRI_24(1);
  NVIC_IPR0 |= NVIC_IP_PRI_24_MASK;
  NVIC_IPR0 &= ~(1U << NVIC_IP_PRI_24_SHIFT);
  (void)NVIC_IP_PRI_20_MASK;
  (void)NVIC_IP_PRI_20_SHIFT;
  (void)NVIC_IP_PRI_20(1);
  NVIC_IPR0 |= NVIC_IP_PRI_20_MASK;
  NVIC_IPR0 &= ~(1U << NVIC_IP_PRI_20_SHIFT);
  (void)NVIC_IP_PRI_4_MASK;
  (void)NVIC_IP_PRI_4_SHIFT;
  (void)NVIC_IP_PRI_4(1);
  NVIC_IPR0 |= NVIC_IP_PRI_4_MASK;
  NVIC_IPR0 &= ~(1U << NVIC_IP_PRI_4_SHIFT);
  (void)NVIC_IP_PRI_16_MASK;
  (void)NVIC_IP_PRI_16_SHIFT;
  (void)NVIC_IP_PRI_16(1);
  NVIC_IPR0 |= NVIC_IP_PRI_16_MASK;
  NVIC_IPR0 &= ~(1U << NVIC_IP_PRI_16_SHIFT);
  (void)NVIC_IP_PRI_12_MASK;
  (void)NVIC_IP_PRI_12_SHIFT;
  (void)NVIC_IP_PRI_12(1);
  NVIC_IPR0 |= NVIC_IP_PRI_12_MASK;
  NVIC_IPR0 &= ~(1U << NVIC_IP_PRI_12_SHIFT);
  (void)NVIC_IP_PRI_8_MASK;
  (void)NVIC_IP_PRI_8_SHIFT;
  (void)NVIC_IP_PRI_8(1);
  NVIC_IPR0 |= NVIC_IP_PRI_8_MASK;
  NVIC_IPR0 &= ~(1U << NVIC_IP_PRI_8_SHIFT);
  (void)NVIC_IP_PRI_13_MASK;
  (void)NVIC_IP_PRI_13_SHIFT;
  (void)NVIC_IP_PRI_13(1);
  NVIC_IPR0 |= NVIC_IP_PRI_13_MASK;
  NVIC_IPR0 &= ~(1U << NVIC_IP_PRI_13_SHIFT);
  (void)NVIC_IP_PRI_21_MASK;
  (void)NVIC_IP_PRI_21_SHIFT;
  (void)NVIC_IP_PRI_21(1);
  NVIC_IPR0 |= NVIC_IP_PRI_21_MASK;
  NVIC_IPR0 &= ~(1U << NVIC_IP_PRI_21_SHIFT);
  (void)NVIC_IP_PRI_29_MASK;
  (void)NVIC_IP_PRI_29_SHIFT;
  (void)NVIC_IP_PRI_29(1);
  NVIC_IPR0 |= NVIC_IP_PRI_29_MASK;
  NVIC_IPR0 &= ~(1U << NVIC_IP_PRI_29_SHIFT);
  (void)NVIC_IP_PRI_1_MASK;
  (void)NVIC_IP_PRI_1_SHIFT;
  (void)NVIC_IP_PRI_1(1);
  NVIC_IPR0 |= NVIC_IP_PRI_1_MASK;
  NVIC_IPR0 &= ~(1U << NVIC_IP_PRI_1_SHIFT);
  (void)NVIC_IP_PRI_9_MASK;
  (void)NVIC_IP_PRI_9_SHIFT;
  (void)NVIC_IP_PRI_9(1);
  NVIC_IPR0 |= NVIC_IP_PRI_9_MASK;
  NVIC_IPR0 &= ~(1U << NVIC_IP_PRI_9_SHIFT);
  (void)NVIC_IP_PRI_17_MASK;
  (void)NVIC_IP_PRI_17_SHIFT;
  (void)NVIC_IP_PRI_17(1);
  NVIC_IPR0 |= NVIC_IP_PRI_17_MASK;
  NVIC_IPR0 &= ~(1U << NVIC_IP_PRI_17_SHIFT);
  (void)NVIC_IP_PRI_25_MASK;
  (void)NVIC_IP_PRI_25_SHIFT;
  (void)NVIC_IP_PRI_25(1);
  NVIC_IPR0 |= NVIC_IP_PRI_25_MASK;
  NVIC_IPR0 &= ~(1U << NVIC_IP_PRI_25_SHIFT);
  (void)NVIC_IP_PRI_5_MASK;
  (void)NVIC_IP_PRI_5_SHIFT;
  (void)NVIC_IP_PRI_5(1);
  NVIC_IPR0 |= NVIC_IP_PRI_5_MASK;
  NVIC_IPR0 &= ~(1U << NVIC_IP_PRI_5_SHIFT);
  (void)NVIC_IP_PRI_2_MASK;
  (void)NVIC_IP_PRI_2_SHIFT;
  (void)NVIC_IP_PRI_2(1);
  NVIC_IPR0 |= NVIC_IP_PRI_2_MASK;
  NVIC_IPR0 &= ~(1U << NVIC_IP_PRI_2_SHIFT);
  (void)NVIC_IP_PRI_26_MASK;
  (void)NVIC_IP_PRI_26_SHIFT;
  (void)NVIC_IP_PRI_26(1);
  NVIC_IPR0 |= NVIC_IP_PRI_26_MASK;
  NVIC_IPR0 &= ~(1U << NVIC_IP_PRI_26_SHIFT);
  (void)NVIC_IP_PRI_18_MASK;
  (void)NVIC_IP_PRI_18_SHIFT;
  (void)NVIC_IP_PRI_18(1);
  NVIC_IPR0 |= NVIC_IP_PRI_18_MASK;
  NVIC_IPR0 &= ~(1U << NVIC_IP_PRI_18_SHIFT);
  (void)NVIC_IP_PRI_14_MASK;
  (void)NVIC_IP_PRI_14_SHIFT;
  (void)NVIC_IP_PRI_14(1);
  NVIC_IPR0 |= NVIC_IP_PRI_14_MASK;
  NVIC_IPR0 &= ~(1U << NVIC_IP_PRI_14_SHIFT);
  (void)NVIC_IP_PRI_6_MASK;
  (void)NVIC_IP_PRI_6_SHIFT;
  (void)NVIC_IP_PRI_6(1);
  NVIC_IPR0 |= NVIC_IP_PRI_6_MASK;
  NVIC_IPR0 &= ~(1U << NVIC_IP_PRI_6_SHIFT);
  (void)NVIC_IP_PRI_30_MASK;
  (void)NVIC_IP_PRI_30_SHIFT;
  (void)NVIC_IP_PRI_30(1);
  NVIC_IPR0 |= NVIC_IP_PRI_30_MASK;
  NVIC_IPR0 &= ~(1U << NVIC_IP_PRI_30_SHIFT);
  (void)NVIC_IP_PRI_22_MASK;
  (void)NVIC_IP_PRI_22_SHIFT;
  (void)NVIC_IP_PRI_22(1);
  NVIC_IPR0 |= NVIC_IP_PRI_22_MASK;
  NVIC_IPR0 &= ~(1U << NVIC_IP_PRI_22_SHIFT);
  (void)NVIC_IP_PRI_10_MASK;
  (void)NVIC_IP_PRI_10_SHIFT;
  (void)NVIC_IP_PRI_10(1);
  NVIC_IPR0 |= NVIC_IP_PRI_10_MASK;
  NVIC_IPR0 &= ~(1U << NVIC_IP_PRI_10_SHIFT);
  (void)NVIC_IP_PRI_31_MASK;
  (void)NVIC_IP_PRI_31_SHIFT;
  (void)NVIC_IP_PRI_31(1);
  NVIC_IPR0 |= NVIC_IP_PRI_31_MASK;
  NVIC_IPR0 &= ~(1U << NVIC_IP_PRI_31_SHIFT);
  (void)NVIC_IP_PRI_27_MASK;
  (void)NVIC_IP_PRI_27_SHIFT;
  (void)NVIC_IP_PRI_27(1);
  NVIC_IPR0 |= NVIC_IP_PRI_27_MASK;
  NVIC_IPR0 &= ~(1U << NVIC_IP_PRI_27_SHIFT);
  (void)NVIC_IP_PRI_23_MASK;
  (void)NVIC_IP_PRI_23_SHIFT;
  (void)NVIC_IP_PRI_23(1);
  NVIC_IPR0 |= NVIC_IP_PRI_23_MASK;
  NVIC_IPR0 &= ~(1U << NVIC_IP_PRI_23_SHIFT);
  (void)NVIC_IP_PRI_3_MASK;
  (void)NVIC_IP_PRI_3_SHIFT;
  (void)NVIC_IP_PRI_3(1);
  NVIC_IPR0 |= NVIC_IP_PRI_3_MASK;
  NVIC_IPR0 &= ~(1U << NVIC_IP_PRI_3_SHIFT);
  (void)NVIC_IP_PRI_19_MASK;
  (void)NVIC_IP_PRI_19_SHIFT;
  (void)NVIC_IP_PRI_19(1);
  NVIC_IPR0 |= NVIC_IP_PRI_19_MASK;
  NVIC_IPR0 &= ~(1U << NVIC_IP_PRI_19_SHIFT);
  (void)NVIC_IP_PRI_15_MASK;
  (void)NVIC_IP_PRI_15_SHIFT;
  (void)NVIC_IP_PRI_15(1);
  NVIC_IPR0 |= NVIC_IP_PRI_15_MASK;
  NVIC_IPR0 &= ~(1U << NVIC_IP_PRI_15_SHIFT);
  (void)NVIC_IP_PRI_11_MASK;
  (void)NVIC_IP_PRI_11_SHIFT;
  (void)NVIC_IP_PRI_11(1);
  NVIC_IPR0 |= NVIC_IP_PRI_11_MASK;
  NVIC_IPR0 &= ~(1U << NVIC_IP_PRI_11_SHIFT);
  (void)NVIC_IP_PRI_7_MASK;
  (void)NVIC_IP_PRI_7_SHIFT;
  (void)NVIC_IP_PRI_7(1);
  NVIC_IPR0 |= NVIC_IP_PRI_7_MASK;
  NVIC_IPR0 &= ~(1U << NVIC_IP_PRI_7_SHIFT);
}

void test_OSC(void) {
  (void)OSC_BASE_PTR;
  OSC_CR = OSC_CR + 1;
  OSC_CR_REG(OSC_BASE_PTR) = OSC_CR_REG(OSC_BASE_PTR) + 1;
...
void test_PIT(void) {
  ...
  PIT_MCR_REG(PIT0_BASE_PTR) = PIT_MCR_REG(PIT0_BASE_PTR) + 1;
  PIT_MCR_REG(PIT1_BASE_PTR) = PIT_MCR_REG(PIT1_BASE_PTR) + 1;
  ...
  PIT_LDVAL_REG(PIT0_BASE_PTR,0) = PIT_LDVAL_REG(PIT0_BASE_PTR,0) + 1;
  PIT0_LDVAL(0) = PIT0_LDVAL(0) + 1;
  PIT1_LDVAL(0) = PIT1_LDVAL(0) + 1;
  PIT_LDVAL_REG(PIT1_BASE_PTR,0) = PIT_LDVAL_REG(PIT1_BASE_PTR,0) + 1;
  PIT0_LDVAL(0) = PIT0_LDVAL(0) + 1;
  PIT1_LDVAL(0) = PIT1_LDVAL(0) + 1;
  ...
  (void)PIT_CVAL_TVL(1);
  PIT0_CVAL0 |= PIT_CVAL_TVL_MASK;
  PIT0_CVAL0 &= ~(1U << PIT_CVAL_TVL_SHIFT);
  PIT_TCTRL_REG(PIT0_BASE_PTR,0) = PIT_TCTRL_REG(PIT0_BASE_PTR,0) + 1;
  PIT0_TCTRL(0) = PIT0_TCTRL(0) + 1;
  PIT1_TCTRL(0) = PIT1_TCTRL(0) + 1;
  PIT_TCTRL_REG(PIT1_BASE_PTR,0) = PIT_TCTRL_REG(PIT1_BASE_PTR,0) + 1;
  PIT0_TCTRL(0) = PIT0_TCTRL(0) + 1;
  PIT1_TCTRL(0) = PIT1_TCTRL(0) + 1;
  ...
  PIT_TFLG_REG(PIT0_BASE_PTR,0) = PIT_TFLG_REG(PIT0_BASE_PTR,0) + 1;
  PIT0_TFLG(0) = PIT0_TFLG(0) + 1;
  PIT1_TFLG(0) = PIT1_TFLG(0) + 1;
  PIT_TFLG_REG(PIT1_BASE_PTR,0) = PIT_TFLG_REG(PIT1_BASE_PTR,0) + 1;
  PIT0_TFLG(0) = PIT0_TFLG(0) + 1;
  PIT1_TFLG(0) = PIT1_TFLG(0) + 1;
...
void test_PMC(void) {
  ...
  PMC_LVDSC1_REG(PMC_BASE_PTR) = PMC_LVDSC1_REG(PMC_BASE_PTR) + 1;
  ...
  PMC_LVDSC2_REG(PMC_BASE_PTR) = PMC_LVDSC2_REG(PMC_BASE_PTR) + 1;
  ...
  PMC_REGSC_REG(PMC_BASE_PTR) = PMC_REGSC_REG(PMC_BASE_PTR) + 1;
...
void test_PORT(void) {
  ...
  PORT_PCR_REG(PORTA_BASE_PTR,0) = PORT_PCR_REG(PORTA_BASE_PTR,0) + 1;
  ...
  PORT_PCR_REG(PORTB_BASE_PTR,0) = PORT_PCR_REG(PORTB_BASE_PTR,0) + 1;
  PORTA_PCR(0) = PORTA_PCR(0) + 1;
  PORTB_PCR(0) = PORTB_PCR(0) + 1;
  PORTC_PCR(0) = PORTC_PCR(0) + 1;
  PORTD_PCR(0) = PORTD_PCR(0) + 1;
  ...
  PORTH_PCR(0) = PORTH_PCR(0) + 1;
  PORTI_PCR(0) = PORTI_PCR(0) + 1;
  PORT_PCR_REG(PORTC_BASE_PTR,0) = PORT_PCR_REG(PORTC_BASE_PTR,0) + 1;
  PORTA_PCR(0) = PORTA_PCR(0) + 1;
  PORTB_PCR(0) = PORTB_PCR(0) + 1;
  PORTC_PCR(0) = PORTC_PCR(0) + 1;
  PORTD_PCR(0) = PORTD_PCR(0) + 1;
  ...
  PORTH_PCR(0) = PORTH_PCR(0) + 1;
  PORTI_PCR(0) = PORTI_PCR(0) + 1;
  PORT_PCR_REG(PORTD_BASE_PTR,0) = PORT_PCR_REG(PORTD_BASE_PTR,0) + 1;
  PORTA_PCR(0) = PORTA_PCR(0) + 1;
  PORTB_PCR(0) = PORTB_PCR(0) + 1;
  PORTC_PCR(0) = PORTC_PCR(0) + 1;
  PORTD_PCR(0) = PORTD_PCR(0) + 1;
  ...
  PORTH_PCR(0) = PORTH_PCR(0) + 1;
  PORTI_PCR(0) = PORTI_PCR(0) + 1;
  PORT_PCR_REG(PORTE_BASE_PTR,0) = PORT_PCR_REG(PORTE_BASE_PTR,0) + 1;
  PORTA_PCR(0) = PORTA_PCR(0) + 1;
  PORTB_PCR(0) = PORTB_PCR(0) + 1;
  PORTC_PCR(0) = PORTC_PCR(0) + 1;
  PORTD_PCR(0) = PORTD_PCR(0) + 1;
  ...
  PORTH_PCR(0) = PORTH_PCR(0) + 1;
  PORTI_PCR(0) = PORTI_PCR(0) + 1;
  PORT_PCR_REG(PORTF_BASE_PTR,0) = PORT_PCR_REG(PORTF_BASE_PTR,0) + 1;
  PORTA_PCR(0) = PORTA_PCR(0) + 1;
  PORTB_PCR(0) = PORTB_PCR(0) + 1;
  PORTC_PCR(0) = PORTC_PCR(0) + 1;
  PORTD_PCR(0) = PORTD_PCR(0) + 1;
  ...
  PORTH_PCR(0) = PORTH_PCR(0) + 1;
  PORTI_PCR(0) = PORTI_PCR(0) + 1;
  PORT_PCR_REG(PORTG_BASE_PTR,0) = PORT_PCR_REG(PORTG_BASE_PTR,0) + 1;
  PORTA_PCR(0) = PORTA_PCR(0) + 1;
  PORTB_PCR(0) = PORTB_PCR(0) + 1;
  PORTC_PCR(0) = PORTC_PCR(0) + 1;
  PORTD_PCR(0) = PORTD_PCR(0) + 1;
  ...
  PORTH_PCR(0) = PORTH_PCR(0) + 1;
  PORTI_PCR(0) = PORTI_PCR(0) + 1;
  PORT_PCR_REG(PORTH_BASE_PTR,0) = PORT_PCR_REG(PORTH_BASE_PTR,0) + 1;
  PORTA_PCR(0) = PORTA_PCR(0) + 1;
  PORTB_PCR(0) = PORTB_PCR(0) + 1;
  PORTC_PCR(0) = PORTC_PCR(0) + 1;
  PORTD_PCR(0) = PORTD_PCR(0) + 1;
  ...
  PORTH_PCR(0) = PORTH_PCR(0) + 1;
  PORTI_PCR(0) = PORTI_PCR(0) + 1;
  PORT_PCR_REG(PORTI_BASE_PTR,0) = PORT_PCR_REG(PORTI_BASE_PTR,0) + 1;
  PORTA_PCR(0) = PORTA_PCR(0) + 1;
  PORTB_PCR(0) = PORTB_PCR(0) + 1;
  PORTC_PCR(0) = PORTC_PCR(0) + 1;
  PORTD_PCR(0) = PORTD_PCR(0) + 1;
  ...
  PORT_GPCLR_REG(PORTA_BASE_PTR) = PORT_GPCLR_REG(PORTA_BASE_PTR) + 1;
  PORT_GPCLR_REG(PORTB_BASE_PTR) = PORT_GPCLR_REG(PORTB_BASE_PTR) + 1;
  PORT_GPCLR_REG(PORTC_BASE_PTR) = PORT_GPCLR_REG(PORTC_BASE_PTR) + 1;
  PORT_GPCLR_REG(PORTD_BASE_PTR) = PORT_GPCLR_REG(PORTD_BASE_PTR) + 1;
  PORT_GPCLR_REG(PORTE_BASE_PTR) = PORT_GPCLR_REG(PORTE_BASE_PTR) + 1;
  PORT_GPCLR_REG(PORTF_BASE_PTR) = PORT_GPCLR_REG(PORTF_BASE_PTR) + 1;
  PORT_GPCLR_REG(PORTG_BASE_PTR) = PORT_GPCLR_REG(PORTG_BASE_PTR) + 1;
  PORT_GPCLR_REG(PORTH_BASE_PTR) = PORT_GPCLR_REG(PORTH_BASE_PTR) + 1;
  PORT_GPCLR_REG(PORTI_BASE_PTR) = PORT_GPCLR_REG(PORTI_BASE_PTR) + 1;
  ...
  PORT_GPCHR_REG(PORTA_BASE_PTR) = PORT_GPCHR_REG(PORTA_BASE_PTR) + 1;
  PORT_GPCHR_REG(PORTB_BASE_PTR) = PORT_GPCHR_REG(PORTB_BASE_PTR) + 1;
  PORT_GPCHR_REG(PORTC_BASE_PTR) = PORT_GPCHR_REG(PORTC_BASE_PTR) + 1;
  PORT_GPCHR_REG(PORTD_BASE_PTR) = PORT_GPCHR_REG(PORTD_BASE_PTR) + 1;
  PORT_GPCHR_REG(PORTE_BASE_PTR) = PORT_GPCHR_REG(PORTE_BASE_PTR) + 1;
  PORT_GPCHR_REG(PORTF_BASE_PTR) = PORT_GPCHR_REG(PORTF_BASE_PTR) + 1;
  PORT_GPCHR_REG(PORTG_BASE_PTR) = PORT_GPCHR_REG(PORTG_BASE_PTR) + 1;
  PORT_GPCHR_REG(PORTH_BASE_PTR) = PORT_GPCHR_REG(PORTH_BASE_PTR) + 1;
  PORT_GPCHR_REG(PORTI_BASE_PTR) = PORT_GPCHR_REG(PORTI_BASE_PTR) + 1;
  ...
  PORT_ISFR_REG(PORTA_BASE_PTR) = PORT_ISFR_REG(PORTA_BASE_PTR) + 1;
  PORT_ISFR_REG(PORTB_BASE_PTR) = PORT_ISFR_REG(PORTB_BASE_PTR) + 1;
  PORT_ISFR_REG(PORTC_BASE_PTR) = PORT_ISFR_REG(PORTC_BASE_PTR) + 1;
  PORT_ISFR_REG(PORTD_BASE_PTR) = PORT_ISFR_REG(PORTD_BASE_PTR) + 1;
  PORT_ISFR_REG(PORTE_BASE_PTR) = PORT_ISFR_REG(PORTE_BASE_PTR) + 1;
  PORT_ISFR_REG(PORTF_BASE_PTR) = PORT_ISFR_REG(PORTF_BASE_PTR) + 1;
  PORT_ISFR_REG(PORTG_BASE_PTR) = PORT_ISFR_REG(PORTG_BASE_PTR) + 1;
  PORT_ISFR_REG(PORTH_BASE_PTR) = PORT_ISFR_REG(PORTH_BASE_PTR) + 1;
  PORT_ISFR_REG(PORTI_BASE_PTR) = PORT_ISFR_REG(PORTI_BASE_PTR) + 1;
  ...
  PORT_DFER_REG(PORTE_BASE_PTR) = PORT_DFER_REG(PORTE_BASE_PTR) + 1;
  ...
  PORT_DFCR_REG(PORTE_BASE_PTR) = PORT_DFCR_REG(PORTE_BASE_PTR) + 1;
  (void)PORT_DFCR_CS_MASK;
  (void)PORT_DFCR_CS_SHIFT;
  PORTE_DFCR |= PORT_DFCR_CS_MASK;
  PORTE_DFCR &= ~(1U << PORT_DFCR_CS_SHIFT);
  PORT_DFWR_REG(PORTE_BASE_PTR) = PORT_DFWR_REG(PORTE_BASE_PTR) + 1;
...
void test_RCM(void) {
  ...
  RCM_SRS0 |= RCM_SRS0_WAKEUP_MASK;
  RCM_SRS0 &= ~(1U << RCM_SRS0_WAKEUP_SHIFT);
  (void)RCM_SRS0_LVD_MASK;
  (void)RCM_SRS0_LVD_SHIFT;
  RCM_SRS0 |= RCM_SRS0_LVD_MASK;
  RCM_SRS0 &= ~(1U << RCM_SRS0_LVD_SHIFT);
  (void)RCM_SRS0_LOC_MASK;
  (void)RCM_SRS0_LOC_SHIFT;
  RCM_SRS0 |= RCM_SRS0_LOC_MASK;
  RCM_SRS0 &= ~(1U << RCM_SRS0_LOC_SHIFT);
  (void)RCM_SRS0_LOL_MASK;
  (void)RCM_SRS0_LOL_SHIFT;
  RCM_SRS0 |= RCM_SRS0_LOL_MASK;
  RCM_SRS0 &= ~(1U << RCM_SRS0_LOL_SHIFT);
  (void)RCM_SRS0_WDOG_MASK;
  (void)RCM_SRS0_WDOG_SHIFT;
  RCM_SRS0 |= RCM_SRS0_WDOG_MASK;
  RCM_SRS0 &= ~(1U << RCM_SRS0_WDOG_SHIFT);
  (void)RCM_SRS0_PIN_MASK;
  (void)RCM_SRS0_PIN_SHIFT;
  RCM_SRS0 |= RCM_SRS0_PIN_MASK;
  RCM_SRS0 &= ~(1U << RCM_SRS0_PIN_SHIFT);
  (void)RCM_SRS0_POR_MASK;
  (void)RCM_SRS0_POR_SHIFT;
  RCM_SRS0 |= RCM_SRS0_POR_MASK;
  RCM_SRS0 &= ~(1U << RCM_SRS0_POR_SHIFT);
  (void)RCM_SRS1_LOCKUP_MASK;
  (void)RCM_SRS1_LOCKUP_SHIFT;
  RCM_SRS1 |= RCM_SRS1_LOCKUP_MASK;
  RCM_SRS1 &= ~(1U << RCM_SRS1_LOCKUP_SHIFT);
  (void)RCM_SRS1_SW_MASK;
  (void)RCM_SRS1_SW_SHIFT;
  RCM_SRS1 |= RCM_SRS1_SW_MASK;
  RCM_SRS1 &= ~(1U << RCM_SRS1_SW_SHIFT);
  (void)RCM_SRS1_MDM_AP_MASK;
  (void)RCM_SRS1_MDM_AP_SHIFT;
  RCM_SRS1 |= RCM_SRS1_MDM_AP_MASK;
  RCM_SRS1 &= ~(1U << RCM_SRS1_MDM_AP_SHIFT);
  (void)RCM_SRS1_SACKERR_MASK;
  (void)RCM_SRS1_SACKERR_SHIFT;
  RCM_SRS1 |= RCM_SRS1_SACKERR_MASK;
  RCM_SRS1 &= ~(1U << RCM_SRS1_SACKERR_SHIFT);
  RCM_RPFC_REG(RCM_BASE_PTR) = RCM_RPFC_REG(RCM_BASE_PTR) + 1;
  ...
  RCM_RPFW_REG(RCM_BASE_PTR) = RCM_RPFW_REG(RCM_BASE_PTR) + 1;
...
void test_RNG(void) {
  ...
  RNG_CR = RNG_CR + 1;
  RNG_ER = RNG_ER + 1;
  RNG_CR_REG(RNG_BASE_PTR) = RNG_CR_REG(RNG_BASE_PTR) + 1;
  (void)RNG_CR_GO_MASK;
  ...
  RNG_SR |= RNG_SR_SECV_MASK;
  RNG_SR &= ~(1U << RNG_SR_SECV_SHIFT);
  (void)RNG_SR_LRS_MASK;
  (void)RNG_SR_LRS_SHIFT;
  RNG_SR |= RNG_SR_LRS_MASK;
  RNG_SR &= ~(1U << RNG_SR_LRS_SHIFT);
  (void)RNG_SR_ORU_MASK;
  (void)RNG_SR_ORU_SHIFT;
  RNG_SR |= RNG_SR_ORU_MASK;
  RNG_SR &= ~(1U << RNG_SR_ORU_SHIFT);
  (void)RNG_SR_ERRI_MASK;
  (void)RNG_SR_ERRI_SHIFT;
  RNG_SR |= RNG_SR_ERRI_MASK;
  RNG_SR &= ~(1U << RNG_SR_ERRI_SHIFT);
  (void)RNG_SR_SLP_MASK;
  (void)RNG_SR_SLP_SHIFT;
  RNG_SR |= RNG_SR_SLP_MASK;
  RNG_SR &= ~(1U << RNG_SR_SLP_SHIFT);
  (void)RNG_SR_OREG_LVL_MASK;
  (void)RNG_SR_OREG_LVL_SHIFT;
  (void)RNG_SR_OREG_LVL(1);
  RNG_SR |= RNG_SR_OREG_LVL_MASK;
  RNG_SR &= ~(1U << RNG_SR_OREG_LVL_SHIFT);
  (void)RNG_SR_OREG_SIZE_MASK;
  (void)RNG_SR_OREG_SIZE_SHIFT;
  (void)RNG_SR_OREG_SIZE(1);
  RNG_SR |= RNG_SR_OREG_SIZE_MASK;
  RNG_SR &= ~(1U << RNG_SR_OREG_SIZE_SHIFT);
  RNG_ER_REG(RNG_BASE_PTR) = RNG_ER_REG(RNG_BASE_PTR) + 1;
  ...
  RNG_OR |= RNG_OR_RANDOUT_MASK;
  RNG_OR &= ~(1U << RNG_OR_RANDOUT_SHIFT);
}
...
void test_RTC(void) {
  ...
  RTC_YEARMON_REG(RTC_BASE_PTR) = RTC_YEARMON_REG(RTC_BASE_PTR) + 1;
  ...
  RTC_DAYS_REG(RTC_BASE_PTR) = RTC_DAYS_REG(RTC_BASE_PTR) + 1;
  ...
  RTC_HOURMIN_REG(RTC_BASE_PTR) = RTC_HOURMIN_REG(RTC_BASE_PTR) + 1;
  ...
  RTC_SECONDS_REG(RTC_BASE_PTR) = RTC_SECONDS_REG(RTC_BASE_PTR) + 1;
  ...
  RTC_ALM_YEARMON_REG(RTC_BASE_PTR) = RTC_ALM_YEARMON_REG(RTC_BASE_PTR) + 1;
  ...
  RTC_ALM_DAYS_REG(RTC_BASE_PTR) = RTC_ALM_DAYS_REG(RTC_BASE_PTR) + 1;
  ...
  RTC_ALM_HOURMIN_REG(RTC_BASE_PTR) = RTC_ALM_HOURMIN_REG(RTC_BASE_PTR) + 1;
  ...
  RTC_ALM_SECONDS_REG(RTC_BASE_PTR) = RTC_ALM_SECONDS_REG(RTC_BASE_PTR) + 1;
  ...
  RTC_CTRL_REG(RTC_BASE_PTR) = RTC_CTRL_REG(RTC_BASE_PTR) + 1;
  ...
  RTC_STATUS_REG(RTC_BASE_PTR) = RTC_STATUS_REG(RTC_BASE_PTR) + 1;
  ...
  RTC_ISR_REG(RTC_BASE_PTR) = RTC_ISR_REG(RTC_BASE_PTR) + 1;
  ...
  RTC_IER_REG(RTC_BASE_PTR) = RTC_IER_REG(RTC_BASE_PTR) + 1;
  ...
  RTC_GP_DATA_REG_REG(RTC_BASE_PTR) = RTC_GP_DATA_REG_REG(RTC_BASE_PTR) + 1;
  ...
  RTC_DST_HOUR_REG(RTC_BASE_PTR) = RTC_DST_HOUR_REG(RTC_BASE_PTR) + 1;
  ...
  RTC_DST_MONTH_REG(RTC_BASE_PTR) = RTC_DST_MONTH_REG(RTC_BASE_PTR) + 1;
  ...
  RTC_DST_DAY_REG(RTC_BASE_PTR) = RTC_DST_DAY_REG(RTC_BASE_PTR) + 1;
  ...
  RTC_COMPEN_REG(RTC_BASE_PTR) = RTC_COMPEN_REG(RTC_BASE_PTR) + 1;
  ...
  RTC_TAMPER_DIRECTION_REG(RTC_BASE_PTR) = RTC_TAMPER_DIRECTION_REG(RTC_BASE_PTR) + 1;
  ...
  RTC_TAMPER_QSCR_REG(RTC_BASE_PTR) = RTC_TAMPER_QSCR_REG(RTC_BASE_PTR) + 1;
  ...
  RTC_TAMPER_SCR_REG(RTC_BASE_PTR) = RTC_TAMPER_SCR_REG(RTC_BASE_PTR) + 1;
  ...
  RTC_FILTER01_CFG_REG(RTC_BASE_PTR) = RTC_FILTER01_CFG_REG(RTC_BASE_PTR) + 1;
  ...
  RTC_FILTER2_CFG_REG(RTC_BASE_PTR) = RTC_FILTER2_CFG_REG(RTC_BASE_PTR) + 1;
  ...
  RTC_TAMPER_QUEUE |= RTC_TAMPER_QUEUE_TAMPER_DATA_MASK;
  RTC_TAMPER_QUEUE &= ~(1U << RTC_TAMPER_QUEUE_TAMPER_DATA_SHIFT);
  RTC_CTRL2_REG(RTC_BASE_PTR) = RTC_CTRL2_REG(RTC_BASE_PTR) + 1;
...
void test_SCB(void) {
  (void)SystemControl_BASE_PTR;
  SCB_ICSR = SCB_ICSR + 1;
  SCB_VTOR = SCB_VTOR + 1;
  SCB_AIRCR = SCB_AIRCR + 1;
  SCB_SCR = SCB_SCR + 1;
  SCB_SHPR2 = SCB_SHPR2 + 1;
  SCB_SHPR3 = SCB_SHPR3 + 1;
  SCB_SHCSR = SCB_SHCSR + 1;
  SCB_DFSR = SCB_DFSR + 1;
  (void)SCB_CPUID_REVISION_MASK;
  (void)SCB_CPUID_REVISION_SHIFT;
  (void)SCB_CPUID_REVISION(1);
  SCB_CPUID |= SCB_CPUID_REVISION_MASK;
  SCB_CPUID &= ~(1U << SCB_CPUID_REVISION_SHIFT);
  (void)SCB_CPUID_PARTNO_MASK;
  (void)SCB_CPUID_PARTNO_SHIFT;
  (void)SCB_CPUID_PARTNO(1);
  SCB_CPUID |= SCB_CPUID_PARTNO_MASK;
  SCB_CPUID &= ~(1U << SCB_CPUID_PARTNO_SHIFT);
  (void)SCB_CPUID_VARIANT_MASK;
  (void)SCB_CPUID_VARIANT_SHIFT;
  (void)SCB_CPUID_VARIANT(1);
  SCB_CPUID |= SCB_CPUID_VARIANT_MASK;
  SCB_CPUID &= ~(1U << SCB_CPUID_VARIANT_SHIFT);
  (void)SCB_CPUID_IMPLEMENTER_MASK;
  (void)SCB_CPUID_IMPLEMENTER_SHIFT;
  (void)SCB_CPUID_IMPLEMENTER(1);
  SCB_CPUID |= SCB_CPUID_IMPLEMENTER_MASK;
  SCB_CPUID &= ~(1U << SCB_CPUID_IMPLEMENTER_SHIFT);
  SCB_ICSR_REG(SystemControl_BASE_PTR) = SCB_ICSR_REG(SystemControl_BASE_PTR) + 1;
  (void)SCB_ICSR_VECTACTIVE_MASK;
  (void)SCB_ICSR_VECTACTIVE_SHIFT;
  (void)SCB_ICSR_VECTACTIVE(1);
  SCB_ICSR |= SCB_ICSR_VECTACTIVE_MASK;
  SCB_ICSR &= ~(1U << SCB_ICSR_VECTACTIVE_SHIFT);
  (void)SCB_ICSR_VECTPENDING_MASK;
  (void)SCB_ICSR_VECTPENDING_SHIFT;
  (void)SCB_ICSR_VECTPENDING(1);
  SCB_ICSR |= SCB_ICSR_VECTPENDING_MASK;
  SCB_ICSR &= ~(1U << SCB_ICSR_VECTPENDING_SHIFT);
  (void)SCB_ICSR_ISRPENDING_MASK;
  (void)SCB_ICSR_ISRPENDING_SHIFT;
  SCB_ICSR |= SCB_ICSR_ISRPENDING_MASK;
  SCB_ICSR &= ~(1U << SCB_ICSR_ISRPENDING_SHIFT);
  (void)SCB_ICSR_PENDSTCLR_MASK;
  (void)SCB_ICSR_PENDSTCLR_SHIFT;
  SCB_ICSR |= SCB_ICSR_PENDSTCLR_MASK;
  SCB_ICSR &= ~(1U << SCB_ICSR_PENDSTCLR_SHIFT);
  (void)SCB_ICSR_PENDSTSET_MASK;
  (void)SCB_ICSR_PENDSTSET_SHIFT;
  SCB_ICSR |= SCB_ICSR_PENDSTSET_MASK;
  SCB_ICSR &= ~(1U << SCB_ICSR_PENDSTSET_SHIFT);
  (void)SCB_ICSR_PENDSVCLR_MASK;
  (void)SCB_ICSR_PENDSVCLR_SHIFT;
  SCB_ICSR |= SCB_ICSR_PENDSVCLR_MASK;
  SCB_ICSR &= ~(1U << SCB_ICSR_PENDSVCLR_SHIFT);
  (void)SCB_ICSR_PENDSVSET_MASK;
  (void)SCB_ICSR_PENDSVSET_SHIFT;
  SCB_ICSR |= SCB_ICSR_PENDSVSET_MASK;
  SCB_ICSR &= ~(1U << SCB_ICSR_PENDSVSET_SHIFT);
  (void)SCB_ICSR_NMIPENDSET_MASK;
  (void)SCB_ICSR_NMIPENDSET_SHIFT;
  SCB_ICSR |= SCB_ICSR_NMIPENDSET_MASK;
  SCB_ICSR &= ~(1U << SCB_ICSR_NMIPENDSET_SHIFT);
  SCB_VTOR_REG(SystemControl_BASE_PTR) = SCB_VTOR_REG(SystemControl_BASE_PTR) + 1;
  (void)SCB_VTOR_TBLOFF_MASK;
  (void)SCB_VTOR_TBLOFF_SHIFT;
  (void)SCB_VTOR_TBLOFF(1);
  SCB_VTOR |= SCB_VTOR_TBLOFF_MASK;
  SCB_VTOR &= ~(1U << SCB_VTOR_TBLOFF_SHIFT);
  SCB_AIRCR_REG(SystemControl_BASE_PTR) = SCB_AIRCR_REG(SystemControl_BASE_PTR) + 1;
  (void)SCB_AIRCR_VECTCLRACTIVE_MASK;
  (void)SCB_AIRCR_VECTCLRACTIVE_SHIFT;
  SCB_AIRCR |= SCB_AIRCR_VECTCLRACTIVE_MASK;
  SCB_AIRCR &= ~(1U << SCB_AIRCR_VECTCLRACTIVE_SHIFT);
  (void)SCB_AIRCR_SYSRESETREQ_MASK;
  (void)SCB_AIRCR_SYSRESETREQ_SHIFT;
  SCB_AIRCR |= SCB_AIRCR_SYSRESETREQ_MASK;
  SCB_AIRCR &= ~(1U << SCB_AIRCR_SYSRESETREQ_SHIFT);
  (void)SCB_AIRCR_ENDIANNESS_MASK;
  (void)SCB_AIRCR_ENDIANNESS_SHIFT;
  SCB_AIRCR |= SCB_AIRCR_ENDIANNESS_MASK;
  SCB_AIRCR &= ~(1U << SCB_AIRCR_ENDIANNESS_SHIFT);
  (void)SCB_AIRCR_VECTKEY_MASK;
  (void)SCB_AIRCR_VECTKEY_SHIFT;
  (void)SCB_AIRCR_VECTKEY(1);
  SCB_AIRCR |= SCB_AIRCR_VECTKEY_MASK;
  SCB_AIRCR &= ~(1U << SCB_AIRCR_VECTKEY_SHIFT);
  SCB_SCR_REG(SystemControl_BASE_PTR) = SCB_SCR_REG(SystemControl_BASE_PTR) + 1;
  (void)SCB_SCR_SLEEPONEXIT_MASK;
  (void)SCB_SCR_SLEEPONEXIT_SHIFT;
  SCB_SCR |= SCB_SCR_SLEEPONEXIT_MASK;
  SCB_SCR &= ~(1U << SCB_SCR_SLEEPONEXIT_SHIFT);
  (void)SCB_SCR_SLEEPDEEP_MASK;
  (void)SCB_SCR_SLEEPDEEP_SHIFT;
  SCB_SCR |= SCB_SCR_SLEEPDEEP_MASK;
  SCB_SCR &= ~(1U << SCB_SCR_SLEEPDEEP_SHIFT);
  (void)SCB_SCR_SEVONPEND_MASK;
  (void)SCB_SCR_SEVONPEND_SHIFT;
  SCB_SCR |= SCB_SCR_SEVONPEND_MASK;
  SCB_SCR &= ~(1U << SCB_SCR_SEVONPEND_SHIFT);
  (void)SCB_CCR_UNALIGN_TRP_MASK;
  (void)SCB_CCR_UNALIGN_TRP_SHIFT;
  SCB_CCR |= SCB_CCR_UNALIGN_TRP_MASK;
  SCB_CCR &= ~(1U << SCB_CCR_UNALIGN_TRP_SHIFT);
  (void)SCB_CCR_STKALIGN_MASK;
  (void)SCB_CCR_STKALIGN_SHIFT;
  SCB_CCR |= SCB_CCR_STKALIGN_MASK;
  SCB_CCR &= ~(1U << SCB_CCR_STKALIGN_SHIFT);
  SCB_SHPR2_REG(SystemControl_BASE_PTR) = SCB_SHPR2_REG(SystemControl_BASE_PTR) + 1;
  (void)SCB_SHPR2_PRI_11_MASK;
  (void)SCB_SHPR2_PRI_11_SHIFT;
  (void)SCB_SHPR2_PRI_11(1);
  SCB_SHPR2 |= SCB_SHPR2_PRI_11_MASK;
  SCB_SHPR2 &= ~(1U << SCB_SHPR2_PRI_11_SHIFT);
  SCB_SHPR3_REG(SystemControl_BASE_PTR) = SCB_SHPR3_REG(SystemControl_BASE_PTR) + 1;
  (void)SCB_SHPR3_PRI_14_MASK;
  (void)SCB_SHPR3_PRI_14_SHIFT;
  (void)SCB_SHPR3_PRI_14(1);
  SCB_SHPR3 |= SCB_SHPR3_PRI_14_MASK;
  SCB_SHPR3 &= ~(1U << SCB_SHPR3_PRI_14_SHIFT);
  (void)SCB_SHPR3_PRI_15_MASK;
  (void)SCB_SHPR3_PRI_15_SHIFT;
  (void)SCB_SHPR3_PRI_15(1);
  SCB_SHPR3 |= SCB_SHPR3_PRI_15_MASK;
  SCB_SHPR3 &= ~(1U << SCB_SHPR3_PRI_15_SHIFT);
  SCB_SHCSR_REG(SystemControl_BASE_PTR) = SCB_SHCSR_REG(SystemControl_BASE_PTR) + 1;
  (void)SCB_SHCSR_SVCALLPENDED_MASK;
  (void)SCB_SHCSR_SVCALLPENDED_SHIFT;
  SCB_SHCSR |= SCB_SHCSR_SVCALLPENDED_MASK;
  SCB_SHCSR &= ~(1U << SCB_SHCSR_SVCALLPENDED_SHIFT);
  SCB_DFSR_REG(SystemControl_BASE_PTR) = SCB_DFSR_REG(SystemControl_BASE_PTR) + 1;
  (void)SCB_DFSR_HALTED_MASK;
  (void)SCB_DFSR_HALTED_SHIFT;
  SCB_DFSR |= SCB_DFSR_HALTED_MASK;
  SCB_DFSR &= ~(1U << SCB_DFSR_HALTED_SHIFT);
  (void)SCB_DFSR_BKPT_MASK;
  (void)SCB_DFSR_BKPT_SHIFT;
  SCB_DFSR |= SCB_DFSR_BKPT_MASK;
  SCB_DFSR &= ~(1U << SCB_DFSR_BKPT_SHIFT);
  (void)SCB_DFSR_DWTTRAP_MASK;
  (void)SCB_DFSR_DWTTRAP_SHIFT;
  SCB_DFSR |= SCB_DFSR_DWTTRAP_MASK;
  SCB_DFSR &= ~(1U << SCB_DFSR_DWTTRAP_SHIFT);
  (void)SCB_DFSR_VCATCH_MASK;
  (void)SCB_DFSR_VCATCH_SHIFT;
  SCB_DFSR |= SCB_DFSR_VCATCH_MASK;
  SCB_DFSR &= ~(1U << SCB_DFSR_VCATCH_SHIFT);
  (void)SCB_DFSR_EXTERNAL_MASK;
  (void)SCB_DFSR_EXTERNAL_SHIFT;
  SCB_DFSR |= SCB_DFSR_EXTERNAL_MASK;
  SCB_DFSR &= ~(1U << SCB_DFSR_EXTERNAL_SHIFT);
}
...
void test_SIM(void) {
  ...
  SIM_SOPT1_REG(SIM_BASE_PTR) = SIM_SOPT1_REG(SIM_BASE_PTR) + 1;
  ...
  SIM_SOPT1_CFG_REG(SIM_BASE_PTR) = SIM_SOPT1_CFG_REG(SIM_BASE_PTR) + 1;
  ...
  SIM_CTRL_REG_REG(SIM_BASE_PTR) = SIM_CTRL_REG_REG(SIM_BASE_PTR) + 1;
  ...
  SIM_SDID |= SIM_SDID_PINID_MASK;
  SIM_SDID &= ~(1U << SIM_SDID_PINID_SHIFT);
  (void)SIM_SDID_DIEID_MASK;
  (void)SIM_SDID_DIEID_SHIFT;
  (void)SIM_SDID_DIEID(1);
  SIM_SDID |= SIM_SDID_DIEID_MASK;
  SIM_SDID &= ~(1U << SIM_SDID_DIEID_SHIFT);
  (void)SIM_SDID_REVID_MASK;
  (void)SIM_SDID_REVID_SHIFT;
  (void)SIM_SDID_REVID(1);
  SIM_SDID |= SIM_SDID_REVID_MASK;
  SIM_SDID &= ~(1U << SIM_SDID_REVID_SHIFT);
  (void)SIM_SDID_SRAMSIZE_MASK;
  (void)SIM_SDID_SRAMSIZE_SHIFT;
  (void)SIM_SDID_SRAMSIZE(1);
  SIM_SDID |= SIM_SDID_SRAMSIZE_MASK;
  SIM_SDID &= ~(1U << SIM_SDID_SRAMSIZE_SHIFT);
  (void)SIM_SDID_ATTR_MASK;
  (void)SIM_SDID_ATTR_SHIFT;
  (void)SIM_SDID_ATTR(1);
  SIM_SDID |= SIM_SDID_ATTR_MASK;
  SIM_SDID &= ~(1U << SIM_SDID_ATTR_SHIFT);
  (void)SIM_SDID_SERIESID_MASK;
  (void)SIM_SDID_SERIESID_SHIFT;
  (void)SIM_SDID_SERIESID(1);
  SIM_SDID |= SIM_SDID_SERIESID_MASK;
  SIM_SDID &= ~(1U << SIM_SDID_SERIESID_SHIFT);
  (void)SIM_SDID_SUBFAMID_MASK;
  (void)SIM_SDID_SUBFAMID_SHIFT;
  (void)SIM_SDID_SUBFAMID(1);
  SIM_SDID |= SIM_SDID_SUBFAMID_MASK;
  SIM_SDID &= ~(1U << SIM_SDID_SUBFAMID_SHIFT);
  (void)SIM_SDID_FAMID_MASK;
  (void)SIM_SDID_FAMID_SHIFT;
  (void)SIM_SDID_FAMID(1);
  SIM_SDID |= SIM_SDID_FAMID_MASK;
  SIM_SDID &= ~(1U << SIM_SDID_FAMID_SHIFT);
  SIM_SCGC4_REG(SIM_BASE_PTR) = SIM_SCGC4_REG(SIM_BASE_PTR) + 1;
  ...
  SIM_SCGC5_REG(SIM_BASE_PTR) = SIM_SCGC5_REG(SIM_BASE_PTR) + 1;
  ...
  SIM_SCGC6_REG(SIM_BASE_PTR) = SIM_SCGC6_REG(SIM_BASE_PTR) + 1;
  ...
  SIM_SCGC7_REG(SIM_BASE_PTR) = SIM_SCGC7_REG(SIM_BASE_PTR) + 1;
  ...
  SIM_CLKDIV1_REG(SIM_BASE_PTR) = SIM_CLKDIV1_REG(SIM_BASE_PTR) + 1;
  ...
  SIM_FCFG1_REG(SIM_BASE_PTR) = SIM_FCFG1_REG(SIM_BASE_PTR) + 1;
  ...
  SIM_FCFG2 |= SIM_FCFG2_MAXADDR_MASK;
  SIM_FCFG2 &= ~(1U << SIM_FCFG2_MAXADDR_SHIFT);
  (void)SIM_UID0_UID_MASK;
  (void)SIM_UID0_UID_SHIFT;
  (void)SIM_UID0_UID(1);
  SIM_UID0 |= SIM_UID0_UID_MASK;
  SIM_UID0 &= ~(1U << SIM_UID0_UID_SHIFT);
  (void)SIM_UID1_UID_MASK;
  (void)SIM_UID1_UID_SHIFT;
  (void)SIM_UID1_UID(1);
  SIM_UID1 |= SIM_UID1_UID_MASK;
  SIM_UID1 &= ~(1U << SIM_UID1_UID_SHIFT);
  (void)SIM_UID2_UID_MASK;
  (void)SIM_UID2_UID_SHIFT;
  (void)SIM_UID2_UID(1);
  SIM_UID2 |= SIM_UID2_UID_MASK;
  SIM_UID2 &= ~(1U << SIM_UID2_UID_SHIFT);
  (void)SIM_UID3_UID_MASK;
  (void)SIM_UID3_UID_SHIFT;
  (void)SIM_UID3_UID(1);
  SIM_UID3 |= SIM_UID3_UID_MASK;
  SIM_UID3 &= ~(1U << SIM_UID3_UID_SHIFT);
  SIM_MISC_CTL_REG(SIM_BASE_PTR) = SIM_MISC_CTL_REG(SIM_BASE_PTR) + 1;
...
void test_SMC(void) {
  ...
  SMC_PMPROT_REG(SMC_BASE_PTR) = SMC_PMPROT_REG(SMC_BASE_PTR) + 1;
  ...
  SMC_PMCTRL_REG(SMC_BASE_PTR) = SMC_PMCTRL_REG(SMC_BASE_PTR) + 1;
  ...
  SMC_STOPCTRL_REG(SMC_BASE_PTR) = SMC_STOPCTRL_REG(SMC_BASE_PTR) + 1;
  ...
  SMC_PMSTAT |= SMC_PMSTAT_PMSTAT_MASK;
  SMC_PMSTAT &= ~(1U << SMC_PMSTAT_PMSTAT_SHIFT);
}
...
void test_SPI(void) {
  ...
  SPI0_S |= SPI_S_RFIFOEF_MASK;
  SPI0_S &= ~(1U << SPI_S_RFIFOEF_SHIFT);
  (void)SPI_S_TXFULLF_MASK;
  (void)SPI_S_TXFULLF_SHIFT;
  SPI0_S |= SPI_S_TXFULLF_MASK;
  SPI0_S &= ~(1U << SPI_S_TXFULLF_SHIFT);
  (void)SPI_S_TNEAREF_MASK;
  (void)SPI_S_TNEAREF_SHIFT;
  SPI0_S |= SPI_S_TNEAREF_MASK;
  SPI0_S &= ~(1U << SPI_S_TNEAREF_SHIFT);
  (void)SPI_S_RNFULLF_MASK;
  (void)SPI_S_RNFULLF_SHIFT;
  SPI0_S |= SPI_S_RNFULLF_MASK;
  SPI0_S &= ~(1U << SPI_S_RNFULLF_SHIFT);
  (void)SPI_S_MODF_MASK;
  (void)SPI_S_MODF_SHIFT;
  SPI0_S |= SPI_S_MODF_MASK;
  SPI0_S &= ~(1U << SPI_S_MODF_SHIFT);
  (void)SPI_S_SPTEF_MASK;
  (void)SPI_S_SPTEF_SHIFT;
  SPI0_S |= SPI_S_SPTEF_MASK;
  SPI0_S &= ~(1U << SPI_S_SPTEF_SHIFT);
  (void)SPI_S_SPMF_MASK;
  (void)SPI_S_SPMF_SHIFT;
  SPI0_S |= SPI_S_SPMF_MASK;
  SPI0_S &= ~(1U << SPI_S_SPMF_SHIFT);
  (void)SPI_S_SPRF_MASK;
  (void)SPI_S_SPRF_SHIFT;
  SPI0_S |= SPI_S_SPRF_MASK;
  SPI0_S &= ~(1U << SPI_S_SPRF_SHIFT);
  SPI_BR_REG(SPI0_BASE_PTR) = SPI_BR_REG(SPI0_BASE_PTR) + 1;
  SPI_BR_REG(SPI1_BASE_PTR) = SPI_BR_REG(SPI1_BASE_PTR) + 1;
  ...
  SPI_C2_REG(SPI0_BASE_PTR) = SPI_C2_REG(SPI0_BASE_PTR) + 1;
  SPI_C2_REG(SPI1_BASE_PTR) = SPI_C2_REG(SPI1_BASE_PTR) + 1;
  ...
  SPI_C1_REG(SPI0_BASE_PTR) = SPI_C1_REG(SPI0_BASE_PTR) + 1;
  SPI_C1_REG(SPI1_BASE_PTR) = SPI_C1_REG(SPI1_BASE_PTR) + 1;
  ...
  SPI_ML_REG(SPI0_BASE_PTR) = SPI_ML_REG(SPI0_BASE_PTR) + 1;
  SPI_ML_REG(SPI1_BASE_PTR) = SPI_ML_REG(SPI1_BASE_PTR) + 1;
  (void)SPI_ML_Bits_MASK;
  (void)SPI_ML_Bits_SHIFT;
  (void)SPI_ML_Bits(1);
  SPI0_ML |= SPI_ML_Bits_MASK;
  SPI0_ML &= ~(1U << SPI_ML_Bits_SHIFT);
  SPI_MH_REG(SPI0_BASE_PTR) = SPI_MH_REG(SPI0_BASE_PTR) + 1;
  SPI_MH_REG(SPI1_BASE_PTR) = SPI_MH_REG(SPI1_BASE_PTR) + 1;
  (void)SPI_MH_Bits_MASK;
  (void)SPI_MH_Bits_SHIFT;
  (void)SPI_MH_Bits(1);
  SPI0_MH |= SPI_MH_Bits_MASK;
  SPI0_MH &= ~(1U << SPI_MH_Bits_SHIFT);
  SPI_DL_REG(SPI0_BASE_PTR) = SPI_DL_REG(SPI0_BASE_PTR) + 1;
  SPI_DL_REG(SPI1_BASE_PTR) = SPI_DL_REG(SPI1_BASE_PTR) + 1;
  (void)SPI_DL_Bits_MASK;
  (void)SPI_DL_Bits_SHIFT;
  (void)SPI_DL_Bits(1);
  SPI0_DL |= SPI_DL_Bits_MASK;
  SPI0_DL &= ~(1U << SPI_DL_Bits_SHIFT);
  SPI_DH_REG(SPI0_BASE_PTR) = SPI_DH_REG(SPI0_BASE_PTR) + 1;
  SPI_DH_REG(SPI1_BASE_PTR) = SPI_DH_REG(SPI1_BASE_PTR) + 1;
  (void)SPI_DH_Bits_MASK;
  (void)SPI_DH_Bits_SHIFT;
  (void)SPI_DH_Bits(1);
  SPI0_DH |= SPI_DH_Bits_MASK;
  SPI0_DH &= ~(1U << SPI_DH_Bits_SHIFT);
  SPI_CI_REG(SPI0_BASE_PTR) = SPI_CI_REG(SPI0_BASE_PTR) + 1;
  SPI_CI_REG(SPI1_BASE_PTR) = SPI_CI_REG(SPI1_BASE_PTR) + 1;
  ...
  SPI_C3_REG(SPI0_BASE_PTR) = SPI_C3_REG(SPI0_BASE_PTR) + 1;
  SPI_C3_REG(SPI1_BASE_PTR) = SPI_C3_REG(SPI1_BASE_PTR) + 1;
...
void test_SysTick(void) {
  (void)SysTick_BASE_PTR;
  SYST_CSR = SYST_CSR + 1;
  SYST_RVR = SYST_RVR + 1;
  SYST_CVR = SYST_CVR + 1;
  SysTick_CSR_REG(SysTick_BASE_PTR) = SysTick_CSR_REG(SysTick_BASE_PTR) + 1;
  (void)SysTick_CSR_ENABLE_MASK;
  (void)SysTick_CSR_ENABLE_SHIFT;
  SYST_CSR |= SysTick_CSR_ENABLE_MASK;
  SYST_CSR &= ~(1U << SysTick_CSR_ENABLE_SHIFT);
  (void)SysTick_CSR_TICKINT_MASK;
  (void)SysTick_CSR_TICKINT_SHIFT;
  SYST_CSR |= SysTick_CSR_TICKINT_MASK;
  SYST_CSR &= ~(1U << SysTick_CSR_TICKINT_SHIFT);
  (void)SysTick_CSR_CLKSOURCE_MASK;
  (void)SysTick_CSR_CLKSOURCE_SHIFT;
  SYST_CSR |= SysTick_CSR_CLKSOURCE_MASK;
  SYST_CSR &= ~(1U << SysTick_CSR_CLKSOURCE_SHIFT);
  (void)SysTick_CSR_COUNTFLAG_MASK;
  (void)SysTick_CSR_COUNTFLAG_SHIFT;
  SYST_CSR |= SysTick_CSR_COUNTFLAG_MASK;
  SYST_CSR &= ~(1U << SysTick_CSR_COUNTFLAG_SHIFT);
  SysTick_RVR_REG(SysTick_BASE_PTR) = SysTick_RVR_REG(SysTick_BASE_PTR) + 1;
  (void)SysTick_RVR_RELOAD_MASK;
  (void)SysTick_RVR_RELOAD_SHIFT;
  (void)SysTick_RVR_RELOAD(1);
  SYST_RVR |= SysTick_RVR_RELOAD_MASK;
  SYST_RVR &= ~(1U << SysTick_RVR_RELOAD_SHIFT);
  SysTick_CVR_REG(SysTick_BASE_PTR) = SysTick_CVR_REG(SysTick_BASE_PTR) + 1;
  (void)SysTick_CVR_CURRENT_MASK;
  (void)SysTick_CVR_CURRENT_SHIFT;
  (void)SysTick_CVR_CURRENT(1);
  SYST_CVR |= SysTick_CVR_CURRENT_MASK;
  SYST_CVR &= ~(1U << SysTick_CVR_CURRENT_SHIFT);
  (void)SysTick_CALIB_TENMS_MASK;
  (void)SysTick_CALIB_TENMS_SHIFT;
  (void)SysTick_CALIB_TENMS(1);
  SYST_CALIB |= SysTick_CALIB_TENMS_MASK;
  SYST_CALIB &= ~(1U << SysTick_CALIB_TENMS_SHIFT);
  (void)SysTick_CALIB_SKEW_MASK;
  (void)SysTick_CALIB_SKEW_SHIFT;
  SYST_CALIB |= SysTick_CALIB_SKEW_MASK;
  SYST_CALIB &= ~(1U << SysTick_CALIB_SKEW_SHIFT);
  (void)SysTick_CALIB_NOREF_MASK;
  (void)SysTick_CALIB_NOREF_SHIFT;
  SYST_CALIB |= SysTick_CALIB_NOREF_MASK;
  SYST_CALIB &= ~(1U << SysTick_CALIB_NOREF_SHIFT);
}
...
void test_TMR(void) {
  ...
  TMR_COMP1_REG(TMR0_BASE_PTR) = TMR_COMP1_REG(TMR0_BASE_PTR) + 1;
  TMR_COMP1_REG(TMR1_BASE_PTR) = TMR_COMP1_REG(TMR1_BASE_PTR) + 1;
  TMR_COMP1_REG(TMR2_BASE_PTR) = TMR_COMP1_REG(TMR2_BASE_PTR) + 1;
  TMR_COMP1_REG(TMR3_BASE_PTR) = TMR_COMP1_REG(TMR3_BASE_PTR) + 1;
  ...
  TMR_COMP2_REG(TMR0_BASE_PTR) = TMR_COMP2_REG(TMR0_BASE_PTR) + 1;
  TMR_COMP2_REG(TMR1_BASE_PTR) = TMR_COMP2_REG(TMR1_BASE_PTR) + 1;
  TMR_COMP2_REG(TMR2_BASE_PTR) = TMR_COMP2_REG(TMR2_BASE_PTR) + 1;
  TMR_COMP2_REG(TMR3_BASE_PTR) = TMR_COMP2_REG(TMR3_BASE_PTR) + 1;
  ...
  TMR_CAPT_REG(TMR0_BASE_PTR) = TMR_CAPT_REG(TMR0_BASE_PTR) + 1;
  TMR_CAPT_REG(TMR1_BASE_PTR) = TMR_CAPT_REG(TMR1_BASE_PTR) + 1;
  TMR_CAPT_REG(TMR2_BASE_PTR) = TMR_CAPT_REG(TMR2_BASE_PTR) + 1;
  TMR_CAPT_REG(TMR3_BASE_PTR) = TMR_CAPT_REG(TMR3_BASE_PTR) + 1;
  ...
  TMR_LOAD_REG(TMR0_BASE_PTR) = TMR_LOAD_REG(TMR0_BASE_PTR) + 1;
  TMR_LOAD_REG(TMR1_BASE_PTR) = TMR_LOAD_REG(TMR1_BASE_PTR) + 1;
  TMR_LOAD_REG(TMR2_BASE_PTR) = TMR_LOAD_REG(TMR2_BASE_PTR) + 1;
  TMR_LOAD_REG(TMR3_BASE_PTR) = TMR_LOAD_REG(TMR3_BASE_PTR) + 1;
  ...
  TMR_HOLD_REG(TMR0_BASE_PTR) = TMR_HOLD_REG(TMR0_BASE_PTR) + 1;
  TMR_HOLD_REG(TMR1_BASE_PTR) = TMR_HOLD_REG(TMR1_BASE_PTR) + 1;
  TMR_HOLD_REG(TMR2_BASE_PTR) = TMR_HOLD_REG(TMR2_BASE_PTR) + 1;
  TMR_HOLD_REG(TMR3_BASE_PTR) = TMR_HOLD_REG(TMR3_BASE_PTR) + 1;
  ...
  TMR_CNTR_REG(TMR0_BASE_PTR) = TMR_CNTR_REG(TMR0_BASE_PTR) + 1;
  TMR_CNTR_REG(TMR1_BASE_PTR) = TMR_CNTR_REG(TMR1_BASE_PTR) + 1;
  TMR_CNTR_REG(TMR2_BASE_PTR) = TMR_CNTR_REG(TMR2_BASE_PTR) + 1;
  TMR_CNTR_REG(TMR3_BASE_PTR) = TMR_CNTR_REG(TMR3_BASE_PTR) + 1;
  ...
  TMR_CTRL_REG(TMR0_BASE_PTR) = TMR_CTRL_REG(TMR0_BASE_PTR) + 1;
  TMR_CTRL_REG(TMR1_BASE_PTR) = TMR_CTRL_REG(TMR1_BASE_PTR) + 1;
  TMR_CTRL_REG(TMR2_BASE_PTR) = TMR_CTRL_REG(TMR2_BASE_PTR) + 1;
  TMR_CTRL_REG(TMR3_BASE_PTR) = TMR_CTRL_REG(TMR3_BASE_PTR) + 1;
  ...
  TMR_SCTRL_REG(TMR0_BASE_PTR) = TMR_SCTRL_REG(TMR0_BASE_PTR) + 1;
  TMR_SCTRL_REG(TMR1_BASE_PTR) = TMR_SCTRL_REG(TMR1_BASE_PTR) + 1;
  TMR_SCTRL_REG(TMR2_BASE_PTR) = TMR_SCTRL_REG(TMR2_BASE_PTR) + 1;
  TMR_SCTRL_REG(TMR3_BASE_PTR) = TMR_SCTRL_REG(TMR3_BASE_PTR) + 1;
  ...
  TMR_CMPLD1_REG(TMR0_BASE_PTR) = TMR_CMPLD1_REG(TMR0_BASE_PTR) + 1;
  TMR_CMPLD1_REG(TMR1_BASE_PTR) = TMR_CMPLD1_REG(TMR1_BASE_PTR) + 1;
  TMR_CMPLD1_REG(TMR2_BASE_PTR) = TMR_CMPLD1_REG(TMR2_BASE_PTR) + 1;
  TMR_CMPLD1_REG(TMR3_BASE_PTR) = TMR_CMPLD1_REG(TMR3_BASE_PTR) + 1;
  ...
  TMR_CMPLD2_REG(TMR0_BASE_PTR) = TMR_CMPLD2_REG(TMR0_BASE_PTR) + 1;
  TMR_CMPLD2_REG(TMR1_BASE_PTR) = TMR_CMPLD2_REG(TMR1_BASE_PTR) + 1;
  TMR_CMPLD2_REG(TMR2_BASE_PTR) = TMR_CMPLD2_REG(TMR2_BASE_PTR) + 1;
  TMR_CMPLD2_REG(TMR3_BASE_PTR) = TMR_CMPLD2_REG(TMR3_BASE_PTR) + 1;
  ...
  TMR_CSCTRL_REG(TMR0_BASE_PTR) = TMR_CSCTRL_REG(TMR0_BASE_PTR) + 1;
  TMR_CSCTRL_REG(TMR1_BASE_PTR) = TMR_CSCTRL_REG(TMR1_BASE_PTR) + 1;
  TMR_CSCTRL_REG(TMR2_BASE_PTR) = TMR_CSCTRL_REG(TMR2_BASE_PTR) + 1;
  TMR_CSCTRL_REG(TMR3_BASE_PTR) = TMR_CSCTRL_REG(TMR3_BASE_PTR) + 1;
  ...
  TMR_FILT_REG(TMR0_BASE_PTR) = TMR_FILT_REG(TMR0_BASE_PTR) + 1;
  TMR_FILT_REG(TMR1_BASE_PTR) = TMR_FILT_REG(TMR1_BASE_PTR) + 1;
  TMR_FILT_REG(TMR2_BASE_PTR) = TMR_FILT_REG(TMR2_BASE_PTR) + 1;
  TMR_FILT_REG(TMR3_BASE_PTR) = TMR_FILT_REG(TMR3_BASE_PTR) + 1;
  ...
  TMR_ENBL_REG(TMR0_BASE_PTR) = TMR_ENBL_REG(TMR0_BASE_PTR) + 1;
...
void test_UART(void) {
  ...
  UART_BDH_REG(UART0_BASE_PTR) = UART_BDH_REG(UART0_BASE_PTR) + 1;
  UART_BDH_REG(UART1_BASE_PTR) = UART_BDH_REG(UART1_BASE_PTR) + 1;
  UART_BDH_REG(UART2_BASE_PTR) = UART_BDH_REG(UART2_BASE_PTR) + 1;
  UART_BDH_REG(UART3_BASE_PTR) = UART_BDH_REG(UART3_BASE_PTR) + 1;
  ...
  UART_BDL_REG(UART0_BASE_PTR) = UART_BDL_REG(UART0_BASE_PTR) + 1;
  UART_BDL_REG(UART1_BASE_PTR) = UART_BDL_REG(UART1_BASE_PTR) + 1;
  UART_BDL_REG(UART2_BASE_PTR) = UART_BDL_REG(UART2_BASE_PTR) + 1;
  UART_BDL_REG(UART3_BASE_PTR) = UART_BDL_REG(UART3_BASE_PTR) + 1;
  (void)UART_BDL_SBR_MASK;
  (void)UART_BDL_SBR_SHIFT;
  (void)UART_BDL_SBR(1);
  UART0_BDL |= UART_BDL_SBR_MASK;
  UART0_BDL &= ~(1U << UART_BDL_SBR_SHIFT);
  UART_C1_REG(UART0_BASE_PTR) = UART_C1_REG(UART0_BASE_PTR) + 1;
  UART_C1_REG(UART1_BASE_PTR) = UART_C1_REG(UART1_BASE_PTR) + 1;
  UART_C1_REG(UART2_BASE_PTR) = UART_C1_REG(UART2_BASE_PTR) + 1;
  UART_C1_REG(UART3_BASE_PTR) = UART_C1_REG(UART3_BASE_PTR) + 1;
  ...
  UART_C2_REG(UART0_BASE_PTR) = UART_C2_REG(UART0_BASE_PTR) + 1;
  UART_C2_REG(UART1_BASE_PTR) = UART_C2_REG(UART1_BASE_PTR) + 1;
  UART_C2_REG(UART2_BASE_PTR) = UART_C2_REG(UART2_BASE_PTR) + 1;
  UART_C2_REG(UART3_BASE_PTR) = UART_C2_REG(UART3_BASE_PTR) + 1;
  ...
  UART0_S1 &= ~(1U << UART_S1_PF_SHIFT);
  (void)UART_S1_FE_MASK;
  (void)UART_S1_FE_SHIFT;
  UART0_S1 |= UART_S1_FE_MASK;
  UART0_S1 &= ~(1U << UART_S1_FE_SHIFT);
  (void)UART_S1_NF_MASK;
  (void)UART_S1_NF_SHIFT;
  UART0_S1 |= UART_S1_NF_MASK;
  UART0_S1 &= ~(1U << UART_S1_NF_SHIFT);
  (void)UART_S1_OR_MASK;
  (void)UART_S1_OR_SHIFT;
  UART0_S1 |= UART_S1_OR_MASK;
  UART0_S1 &= ~(1U << UART_S1_OR_SHIFT);
  (void)UART_S1_IDLE_MASK;
  (void)UART_S1_IDLE_SHIFT;
  UART0_S1 |= UART_S1_IDLE_MASK;
  UART0_S1 &= ~(1U << UART_S1_IDLE_SHIFT);
  (void)UART_S1_RDRF_MASK;
  (void)UART_S1_RDRF_SHIFT;
  UART0_S1 |= UART_S1_RDRF_MASK;
  UART0_S1 &= ~(1U << UART_S1_RDRF_SHIFT);
  (void)UART_S1_TC_MASK;
  (void)UART_S1_TC_SHIFT;
  UART0_S1 |= UART_S1_TC_MASK;
  UART0_S1 &= ~(1U << UART_S1_TC_SHIFT);
  (void)UART_S1_TDRE_MASK;
  (void)UART_S1_TDRE_SHIFT;
  UART0_S1 |= UART_S1_TDRE_MASK;
  UART0_S1 &= ~(1U << UART_S1_TDRE_SHIFT);
  UART_S2_REG(UART0_BASE_PTR) = UART_S2_REG(UART0_BASE_PTR) + 1;
  UART_S2_REG(UART1_BASE_PTR) = UART_S2_REG(UART1_BASE_PTR) + 1;
  UART_S2_REG(UART2_BASE_PTR) = UART_S2_REG(UART2_BASE_PTR) + 1;
  UART_S2_REG(UART3_BASE_PTR) = UART_S2_REG(UART3_BASE_PTR) + 1;
  ...
  UART_C3_REG(UART0_BASE_PTR) = UART_C3_REG(UART0_BASE_PTR) + 1;
  UART_C3_REG(UART1_BASE_PTR) = UART_C3_REG(UART1_BASE_PTR) + 1;
  UART_C3_REG(UART2_BASE_PTR) = UART_C3_REG(UART2_BASE_PTR) + 1;
  UART_C3_REG(UART3_BASE_PTR) = UART_C3_REG(UART3_BASE_PTR) + 1;
  ...
  UART_D_REG(UART0_BASE_PTR) = UART_D_REG(UART0_BASE_PTR) + 1;
  UART_D_REG(UART1_BASE_PTR) = UART_D_REG(UART1_BASE_PTR) + 1;
  UART_D_REG(UART2_BASE_PTR) = UART_D_REG(UART2_BASE_PTR) + 1;
  UART_D_REG(UART3_BASE_PTR) = UART_D_REG(UART3_BASE_PTR) + 1;
  (void)UART_D_RT_MASK;
  (void)UART_D_RT_SHIFT;
  (void)UART_D_RT(1);
  UART0_D |= UART_D_RT_MASK;
  UART0_D &= ~(1U << UART_D_RT_SHIFT);
  UART_MA1_REG(UART0_BASE_PTR) = UART_MA1_REG(UART0_BASE_PTR) + 1;
  UART_MA1_REG(UART1_BASE_PTR) = UART_MA1_REG(UART1_BASE_PTR) + 1;
  UART_MA1_REG(UART2_BASE_PTR) = UART_MA1_REG(UART2_BASE_PTR) + 1;
  UART_MA1_REG(UART3_BASE_PTR) = UART_MA1_REG(UART3_BASE_PTR) + 1;
  (void)UART_MA1_MA_MASK;
  (void)UART_MA1_MA_SHIFT;
  (void)UART_MA1_MA(1);
  UART0_MA1 |= UART_MA1_MA_MASK;
  UART0_MA1 &= ~(1U << UART_MA1_MA_SHIFT);
  UART_MA2_REG(UART0_BASE_PTR) = UART_MA2_REG(UART0_BASE_PTR) + 1;
  UART_MA2_REG(UART1_BASE_PTR) = UART_MA2_REG(UART1_BASE_PTR) + 1;
  UART_MA2_REG(UART2_BASE_PTR) = UART_MA2_REG(UART2_BASE_PTR) + 1;
  UART_MA2_REG(UART3_BASE_PTR) = UART_MA2_REG(UART3_BASE_PTR) + 1;
  (void)UART_MA2_MA_MASK;
  (void)UART_MA2_MA_SHIFT;
  (void)UART_MA2_MA(1);
  UART0_MA2 |= UART_MA2_MA_MASK;
  UART0_MA2 &= ~(1U << UART_MA2_MA_SHIFT);
  UART_C4_REG(UART0_BASE_PTR) = UART_C4_REG(UART0_BASE_PTR) + 1;
  UART_C4_REG(UART1_BASE_PTR) = UART_C4_REG(UART1_BASE_PTR) + 1;
  UART_C4_REG(UART2_BASE_PTR) = UART_C4_REG(UART2_BASE_PTR) + 1;
  UART_C4_REG(UART3_BASE_PTR) = UART_C4_REG(UART3_BASE_PTR) + 1;
  ...
  UART_C5_REG(UART0_BASE_PTR) = UART_C5_REG(UART0_BASE_PTR) + 1;
  UART_C5_REG(UART1_BASE_PTR) = UART_C5_REG(UART1_BASE_PTR) + 1;
  UART_C5_REG(UART2_BASE_PTR) = UART_C5_REG(UART2_BASE_PTR) + 1;
  UART_C5_REG(UART3_BASE_PTR) = UART_C5_REG(UART3_BASE_PTR) + 1;
  ...
  UART0_ED |= UART_ED_PARITYE_MASK;
  UART0_ED &= ~(1U << UART_ED_PARITYE_SHIFT);
  (void)UART_ED_NOISY_MASK;
  (void)UART_ED_NOISY_SHIFT;
  UART0_ED |= UART_ED_NOISY_MASK;
  UART0_ED &= ~(1U << UART_ED_NOISY_SHIFT);
  UART_MODEM_REG(UART0_BASE_PTR) = UART_MODEM_REG(UART0_BASE_PTR) + 1;
  UART_MODEM_REG(UART1_BASE_PTR) = UART_MODEM_REG(UART1_BASE_PTR) + 1;
  UART_MODEM_REG(UART2_BASE_PTR) = UART_MODEM_REG(UART2_BASE_PTR) + 1;
  UART_MODEM_REG(UART3_BASE_PTR) = UART_MODEM_REG(UART3_BASE_PTR) + 1;
  ...
  UART_PFIFO_REG(UART0_BASE_PTR) = UART_PFIFO_REG(UART0_BASE_PTR) + 1;
  UART_PFIFO_REG(UART1_BASE_PTR) = UART_PFIFO_REG(UART1_BASE_PTR) + 1;
  UART_PFIFO_REG(UART2_BASE_PTR) = UART_PFIFO_REG(UART2_BASE_PTR) + 1;
  UART_PFIFO_REG(UART3_BASE_PTR) = UART_PFIFO_REG(UART3_BASE_PTR) + 1;
  ...
  UART_CFIFO_REG(UART0_BASE_PTR) = UART_CFIFO_REG(UART0_BASE_PTR) + 1;
  UART_CFIFO_REG(UART1_BASE_PTR) = UART_CFIFO_REG(UART1_BASE_PTR) + 1;
  UART_CFIFO_REG(UART2_BASE_PTR) = UART_CFIFO_REG(UART2_BASE_PTR) + 1;
  UART_CFIFO_REG(UART3_BASE_PTR) = UART_CFIFO_REG(UART3_BASE_PTR) + 1;
  ...
  UART_SFIFO_REG(UART0_BASE_PTR) = UART_SFIFO_REG(UART0_BASE_PTR) + 1;
  UART_SFIFO_REG(UART1_BASE_PTR) = UART_SFIFO_REG(UART1_BASE_PTR) + 1;
  UART_SFIFO_REG(UART2_BASE_PTR) = UART_SFIFO_REG(UART2_BASE_PTR) + 1;
  UART_SFIFO_REG(UART3_BASE_PTR) = UART_SFIFO_REG(UART3_BASE_PTR) + 1;
  ...
  UART_TWFIFO_REG(UART0_BASE_PTR) = UART_TWFIFO_REG(UART0_BASE_PTR) + 1;
  UART_TWFIFO_REG(UART1_BASE_PTR) = UART_TWFIFO_REG(UART1_BASE_PTR) + 1;
  UART_TWFIFO_REG(UART2_BASE_PTR) = UART_TWFIFO_REG(UART2_BASE_PTR) + 1;
  UART_TWFIFO_REG(UART3_BASE_PTR) = UART_TWFIFO_REG(UART3_BASE_PTR) + 1;
  ...
  UART0_TCFIFO |= UART_TCFIFO_TXCOUNT_MASK;
  UART0_TCFIFO &= ~(1U << UART_TCFIFO_TXCOUNT_SHIFT);
  UART_RWFIFO_REG(UART0_BASE_PTR) = UART_RWFIFO_REG(UART0_BASE_PTR) + 1;
  UART_RWFIFO_REG(UART1_BASE_PTR) = UART_RWFIFO_REG(UART1_BASE_PTR) + 1;
  UART_RWFIFO_REG(UART2_BASE_PTR) = UART_RWFIFO_REG(UART2_BASE_PTR) + 1;
  UART_RWFIFO_REG(UART3_BASE_PTR) = UART_RWFIFO_REG(UART3_BASE_PTR) + 1;
  ...
  UART0_RCFIFO |= UART_RCFIFO_RXCOUNT_MASK;
  UART0_RCFIFO &= ~(1U << UART_RCFIFO_RXCOUNT_SHIFT);
  UART_C7816_REG(UART1_BASE_PTR) = UART_C7816_REG(UART1_BASE_PTR) + 1;
  UART_C7816_REG(UART3_BASE_PTR) = UART_C7816_REG(UART3_BASE_PTR) + 1;
  ...
  UART_IE7816_REG(UART1_BASE_PTR) = UART_IE7816_REG(UART1_BASE_PTR) + 1;
  UART_IE7816_REG(UART3_BASE_PTR) = UART_IE7816_REG(UART3_BASE_PTR) + 1;
  ...
  UART_IS7816_REG(UART1_BASE_PTR) = UART_IS7816_REG(UART1_BASE_PTR) + 1;
  UART_IS7816_REG(UART3_BASE_PTR) = UART_IS7816_REG(UART3_BASE_PTR) + 1;
  ...
  UART_WP7816T0_REG(UART1_BASE_PTR) = UART_WP7816T0_REG(UART1_BASE_PTR) + 1;
  UART_WP7816T0_REG(UART3_BASE_PTR) = UART_WP7816T0_REG(UART3_BASE_PTR) + 1;
  ...
  UART_WP7816T1_REG(UART1_BASE_PTR) = UART_WP7816T1_REG(UART1_BASE_PTR) + 1;
  UART_WP7816T1_REG(UART3_BASE_PTR) = UART_WP7816T1_REG(UART3_BASE_PTR) + 1;
  ...
  UART_WN7816_REG(UART1_BASE_PTR) = UART_WN7816_REG(UART1_BASE_PTR) + 1;
  UART_WN7816_REG(UART3_BASE_PTR) = UART_WN7816_REG(UART3_BASE_PTR) + 1;
  ...
  UART_WF7816_REG(UART1_BASE_PTR) = UART_WF7816_REG(UART1_BASE_PTR) + 1;
  UART_WF7816_REG(UART3_BASE_PTR) = UART_WF7816_REG(UART3_BASE_PTR) + 1;
  ...
  UART_ET7816_REG(UART1_BASE_PTR) = UART_ET7816_REG(UART1_BASE_PTR) + 1;
  UART_ET7816_REG(UART3_BASE_PTR) = UART_ET7816_REG(UART3_BASE_PTR) + 1;
  ...
  UART_TL7816_REG(UART1_BASE_PTR) = UART_TL7816_REG(UART1_BASE_PTR) + 1;
  UART_TL7816_REG(UART3_BASE_PTR) = UART_TL7816_REG(UART3_BASE_PTR) + 1;
...
void test_VREF(void) {
  ...
  VREF_VREFH_TRM_REG(VREF_BASE_PTR) = VREF_VREFH_TRM_REG(VREF_BASE_PTR) + 1;
  ...
  VREF_VREFH_SC_REG(VREF_BASE_PTR) = VREF_VREFH_SC_REG(VREF_BASE_PTR) + 1;
  ...
  VREF_VREFL_TRM_REG(VREF_BASE_PTR) = VREF_VREFL_TRM_REG(VREF_BASE_PTR) + 1;
...
void test_WDOG(void) {
  ...
  WDOG_STCTRLH_REG(WDOG_BASE_PTR) = WDOG_STCTRLH_REG(WDOG_BASE_PTR) + 1;
  ...
  WDOG_STCTRLL_REG(WDOG_BASE_PTR) = WDOG_STCTRLL_REG(WDOG_BASE_PTR) + 1;
  ...
  WDOG_TOVALH_REG(WDOG_BASE_PTR) = WDOG_TOVALH_REG(WDOG_BASE_PTR) + 1;
  ...
  WDOG_TOVALL_REG(WDOG_BASE_PTR) = WDOG_TOVALL_REG(WDOG_BASE_PTR) + 1;
  ...
  WDOG_WINH_REG(WDOG_BASE_PTR) = WDOG_WINH_REG(WDOG_BASE_PTR) + 1;
  ...
  WDOG_WINL_REG(WDOG_BASE_PTR) = WDOG_WINL_REG(WDOG_BASE_PTR) + 1;
  ...
  WDOG_REFRESH_REG(WDOG_BASE_PTR) = WDOG_REFRESH_REG(WDOG_BASE_PTR) + 1;
  ...
  WDOG_UNLOCK_REG(WDOG_BASE_PTR) = WDOG_UNLOCK_REG(WDOG_BASE_PTR) + 1;
  ...
  WDOG_TMROUTH_REG(WDOG_BASE_PTR) = WDOG_TMROUTH_REG(WDOG_BASE_PTR) + 1;
  ...
  WDOG_TMROUTL_REG(WDOG_BASE_PTR) = WDOG_TMROUTL_REG(WDOG_BASE_PTR) + 1;
  ...
  WDOG_RSTCNT_REG(WDOG_BASE_PTR) = WDOG_RSTCNT_REG(WDOG_BASE_PTR) + 1;
  ...
  WDOG_PRESC_REG(WDOG_BASE_PTR) = WDOG_PRESC_REG(WDOG_BASE_PTR) + 1;
...
void test_XBAR(void) {
  ...
  XBAR_SEL0_REG(XBAR_BASE_PTR) = XBAR_SEL0_REG(XBAR_BASE_PTR) + 1;
  ...
  XBAR_SEL1_REG(XBAR_BASE_PTR) = XBAR_SEL1_REG(XBAR_BASE_PTR) + 1;
  ...
  XBAR_SEL2_REG(XBAR_BASE_PTR) = XBAR_SEL2_REG(XBAR_BASE_PTR) + 1;
  ...
  XBAR_SEL3_REG(XBAR_BASE_PTR) = XBAR_SEL3_REG(XBAR_BASE_PTR) + 1;
  ...
  XBAR_SEL4_REG(XBAR_BASE_PTR) = XBAR_SEL4_REG(XBAR_BASE_PTR) + 1;
  ...
  XBAR_SEL5_REG(XBAR_BASE_PTR) = XBAR_SEL5_REG(XBAR_BASE_PTR) + 1;
  ...
  XBAR_SEL6_REG(XBAR_BASE_PTR) = XBAR_SEL6_REG(XBAR_BASE_PTR) + 1;
  ...
  XBAR_SEL7_REG(XBAR_BASE_PTR) = XBAR_SEL7_REG(XBAR_BASE_PTR) + 1;
  ...
  XBAR_SEL8_REG(XBAR_BASE_PTR) = XBAR_SEL8_REG(XBAR_BASE_PTR) + 1;
  ...
  XBAR_SEL9_REG(XBAR_BASE_PTR) = XBAR_SEL9_REG(XBAR_BASE_PTR) + 1;
  ...
  XBAR_SEL10_REG(XBAR_BASE_PTR) = XBAR_SEL10_REG(XBAR_BASE_PTR) + 1;
  ...
  XBAR_SEL11_REG(XBAR_BASE_PTR) = XBAR_SEL11_REG(XBAR_BASE_PTR) + 1;
  ...
  XBAR_SEL12_REG(XBAR_BASE_PTR) = XBAR_SEL12_REG(XBAR_BASE_PTR) + 1;
  ...
  XBAR_SEL13_REG(XBAR_BASE_PTR) = XBAR_SEL13_REG(XBAR_BASE_PTR) + 1;
  ...
  XBAR_SEL14_REG(XBAR_BASE_PTR) = XBAR_SEL14_REG(XBAR_BASE_PTR) + 1;
  ...
  XBAR_SEL15_REG(XBAR_BASE_PTR) = XBAR_SEL15_REG(XBAR_BASE_PTR) + 1;
  ...
  XBAR_SEL16_REG(XBAR_BASE_PTR) = XBAR_SEL16_REG(XBAR_BASE_PTR) + 1;
  ...
  XBAR_CTRL0_REG(XBAR_BASE_PTR) = XBAR_CTRL0_REG(XBAR_BASE_PTR) + 1;
