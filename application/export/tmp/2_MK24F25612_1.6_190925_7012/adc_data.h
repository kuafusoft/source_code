...
struct DATA ADC_REG_DATA[] = {
	{"OFFSET(DMA_MemMap, CR)", OFFSET(DMA_MemMap,CR[0]), 0},
	{"OFFSET(DMA_MemMap, ES)", OFFSET(DMA_MemMap,ES[0]), 4},
	{"OFFSET(DMA_MemMap, ERQ)", OFFSET(DMA_MemMap,ERQ[0]), 12},
	{"OFFSET(DMA_MemMap, EEI)", OFFSET(DMA_MemMap,EEI[0]), 20},
	{"OFFSET(DMA_MemMap, CEEI)", OFFSET(DMA_MemMap,CEEI[0]), 24},
	{"OFFSET(DMA_MemMap, SEEI)", OFFSET(DMA_MemMap,SEEI[0]), 25},
	{"OFFSET(DMA_MemMap, CERQ)", OFFSET(DMA_MemMap,CERQ[0]), 26},
	{"OFFSET(DMA_MemMap, SERQ)", OFFSET(DMA_MemMap,SERQ[0]), 27},
	{"OFFSET(DMA_MemMap, CDNE)", OFFSET(DMA_MemMap,CDNE[0]), 28},
	{"OFFSET(DMA_MemMap, SSRT)", OFFSET(DMA_MemMap,SSRT[0]), 29},
	{"OFFSET(DMA_MemMap, CERR)", OFFSET(DMA_MemMap,CERR[0]), 30},
	{"OFFSET(DMA_MemMap, CINT)", OFFSET(DMA_MemMap,CINT[0]), 31},
	{"OFFSET(DMA_MemMap, INT)", OFFSET(DMA_MemMap,INT[0]), 36},
	{"OFFSET(DMA_MemMap, ERR)", OFFSET(DMA_MemMap,ERR[0]), 44},
	{"OFFSET(DMA_MemMap, HRS)", OFFSET(DMA_MemMap,HRS[0]), 52},
	{"OFFSET(DMA_MemMap, DCHPRI3)", OFFSET(DMA_MemMap,DCHPRI3[0]), 256},
	{"OFFSET(DMA_MemMap, DCHPRI2)", OFFSET(DMA_MemMap,DCHPRI2[0]), 257},
	{"OFFSET(DMA_MemMap, DCHPRI1)", OFFSET(DMA_MemMap,DCHPRI1[0]), 258},
	{"OFFSET(DMA_MemMap, DCHPRI0)", OFFSET(DMA_MemMap,DCHPRI0[0]), 259},
	{"OFFSET(DMA_MemMap, DCHPRI7)", OFFSET(DMA_MemMap,DCHPRI7[0]), 260},
	{"OFFSET(DMA_MemMap, DCHPRI6)", OFFSET(DMA_MemMap,DCHPRI6[0]), 261},
	{"OFFSET(DMA_MemMap, DCHPRI5)", OFFSET(DMA_MemMap,DCHPRI5[0]), 262},
	{"OFFSET(DMA_MemMap, DCHPRI4)", OFFSET(DMA_MemMap,DCHPRI4[0]), 263},
	{"OFFSET(DMA_MemMap, DCHPRI11)", OFFSET(DMA_MemMap,DCHPRI11[0]), 264},
	{"OFFSET(DMA_MemMap, DCHPRI10)", OFFSET(DMA_MemMap,DCHPRI10[0]), 265},
	{"OFFSET(DMA_MemMap, DCHPRI9)", OFFSET(DMA_MemMap,DCHPRI9[0]), 266},
	{"OFFSET(DMA_MemMap, DCHPRI8)", OFFSET(DMA_MemMap,DCHPRI8[0]), 267},
	{"OFFSET(DMA_MemMap, DCHPRI15)", OFFSET(DMA_MemMap,DCHPRI15[0]), 268},
	{"OFFSET(DMA_MemMap, DCHPRI14)", OFFSET(DMA_MemMap,DCHPRI14[0]), 269},
	{"OFFSET(DMA_MemMap, DCHPRI13)", OFFSET(DMA_MemMap,DCHPRI13[0]), 270},
	{"OFFSET(DMA_MemMap, DCHPRI12)", OFFSET(DMA_MemMap,DCHPRI12[0]), 271},
	{"sizeof(DMA_MemMap)", sizeof(struct DMA_MemMap), 4608},
	{"OFFSET(FMC_MemMap, PFAPR)", OFFSET(FMC_MemMap,PFAPR[0]), 0},
	{"OFFSET(FMC_MemMap, PFB0CR)", OFFSET(FMC_MemMap,PFB0CR[0]), 4},
	...
	{"OFFSET(I2S_MemMap, TCSR)", OFFSET(I2S_MemMap,TCSR[0]), 0},
	{"OFFSET(I2S_MemMap, RCSR)", OFFSET(I2S_MemMap,RCSR[0]), 128},
	{"OFFSET(I2S_MemMap, TCR1)", OFFSET(I2S_MemMap,TCR1[0]), 4},
	{"OFFSET(I2S_MemMap, TCR2)", OFFSET(I2S_MemMap,TCR2[0]), 8},
	{"OFFSET(I2S_MemMap, RCR2)", OFFSET(I2S_MemMap,RCR2[0]), 136},
	{"OFFSET(I2S_MemMap, TCR3)", OFFSET(I2S_MemMap,TCR3[0]), 12},
	{"OFFSET(I2S_MemMap, RCR3)", OFFSET(I2S_MemMap,RCR3[0]), 140},
	{"OFFSET(I2S_MemMap, TCR4)", OFFSET(I2S_MemMap,TCR4[0]), 16},
	{"OFFSET(I2S_MemMap, RCR4)", OFFSET(I2S_MemMap,RCR4[0]), 144},
	{"OFFSET(I2S_MemMap, TCR5)", OFFSET(I2S_MemMap,TCR5[0]), 20},
	{"OFFSET(I2S_MemMap, RCR5)", OFFSET(I2S_MemMap,RCR5[0]), 148},
	...
	{"OFFSET(I2S_MemMap, TMR)", OFFSET(I2S_MemMap,TMR[0]), 96},
	{"OFFSET(I2S_MemMap, RCR1)", OFFSET(I2S_MemMap,RCR1[0]), 132},
	{"OFFSET(I2S_MemMap, RDR)", OFFSET(I2S_MemMap,RDR[0]), 160},
	{"OFFSET(I2S_MemMap, RMR)", OFFSET(I2S_MemMap,RMR[0]), 224},
	{"OFFSET(I2S_MemMap, MCR)", OFFSET(I2S_MemMap,MCR[0]), 256},
	{"OFFSET(I2S_MemMap, MDR)", OFFSET(I2S_MemMap,MDR[0]), 260},
	{"sizeof(I2S_MemMap)", sizeof(struct I2S_MemMap), 264},
	{"OFFSET(USB_MemMap, PERID)", OFFSET(USB_MemMap,PERID[0]), 0},
	{"OFFSET(USB_MemMap, IDCOMP)", OFFSET(USB_MemMap,IDCOMP[0]), 4},
	{"OFFSET(USB_MemMap, REV)", OFFSET(USB_MemMap,REV[0]), 8},
	{"OFFSET(USB_MemMap, ADDINFO)", OFFSET(USB_MemMap,ADDINFO[0]), 12},
	{"OFFSET(USB_MemMap, OTGISTAT)", OFFSET(USB_MemMap,OTGISTAT[0]), 16},
	{"OFFSET(USB_MemMap, OTGICR)", OFFSET(USB_MemMap,OTGICR[0]), 20},
	{"OFFSET(USB_MemMap, OTGSTAT)", OFFSET(USB_MemMap,OTGSTAT[0]), 24},
	{"OFFSET(USB_MemMap, OTGCTL)", OFFSET(USB_MemMap,OTGCTL[0]), 28},
	{"OFFSET(USB_MemMap, ISTAT)", OFFSET(USB_MemMap,ISTAT[0]), 128},
	{"OFFSET(USB_MemMap, INTEN)", OFFSET(USB_MemMap,INTEN[0]), 132},
	{"OFFSET(USB_MemMap, ERRSTAT)", OFFSET(USB_MemMap,ERRSTAT[0]), 136},
	{"OFFSET(USB_MemMap, ERREN)", OFFSET(USB_MemMap,ERREN[0]), 140},
	{"OFFSET(USB_MemMap, STAT)", OFFSET(USB_MemMap,STAT[0]), 144},
	{"OFFSET(USB_MemMap, CTL)", OFFSET(USB_MemMap,CTL[0]), 148},
	{"OFFSET(USB_MemMap, ADDR)", OFFSET(USB_MemMap,ADDR[0]), 152},
	{"OFFSET(USB_MemMap, BDTPAGE1)", OFFSET(USB_MemMap,BDTPAGE1[0]), 156},
	{"OFFSET(USB_MemMap, FRMNUML)", OFFSET(USB_MemMap,FRMNUML[0]), 160},
	{"OFFSET(USB_MemMap, FRMNUMH)", OFFSET(USB_MemMap,FRMNUMH[0]), 164},
	{"OFFSET(USB_MemMap, TOKEN)", OFFSET(USB_MemMap,TOKEN[0]), 168},
	{"OFFSET(USB_MemMap, SOFTHLD)", OFFSET(USB_MemMap,SOFTHLD[0]), 172},
	{"OFFSET(USB_MemMap, BDTPAGE2)", OFFSET(USB_MemMap,BDTPAGE2[0]), 176},
	{"OFFSET(USB_MemMap, BDTPAGE3)", OFFSET(USB_MemMap,BDTPAGE3[0]), 180},
	{"OFFSET(USB_MemMap, USBCTRL)", OFFSET(USB_MemMap,USBCTRL[0]), 256},
	{"OFFSET(USB_MemMap, OBSERVE)", OFFSET(USB_MemMap,OBSERVE[0]), 260},
	{"OFFSET(USB_MemMap, CONTROL)", OFFSET(USB_MemMap,CONTROL[0]), 264},
	{"OFFSET(USB_MemMap, USBTRC0)", OFFSET(USB_MemMap,USBTRC0[0]), 268},
	{"OFFSET(USB_MemMap, USBFRMADJUST)", OFFSET(USB_MemMap,USBFRMADJUST[0]), 276},
	{"OFFSET(USB_MemMap, CLK_RECOVER_CTRL)", OFFSET(USB_MemMap,CLK_RECOVER_CTRL[0]), 320},
	{"OFFSET(USB_MemMap, CLK_RECOVER_IRC_EN)", OFFSET(USB_MemMap,CLK_RECOVER_IRC_EN[0]), 324},
	{"OFFSET(USB_MemMap, CLK_RECOVER_INT_EN)", OFFSET(USB_MemMap,CLK_RECOVER_INT_EN[0]), 340},
	{"OFFSET(USB_MemMap, CLK_RECOVER_INT_STATUS)", OFFSET(USB_MemMap,CLK_RECOVER_INT_STATUS[0]), 348},
	{"sizeof(USB_MemMap)", sizeof(struct USB_MemMap), 349},
	{"OFFSET(CRC_MemMap, DATA)", OFFSET(CRC_MemMap,DATA[0]), 0},
	{"OFFSET(CRC_MemMap, GPOLY)", OFFSET(CRC_MemMap,GPOLY[0]), 4},
	{"OFFSET(CRC_MemMap, CTRL)", OFFSET(CRC_MemMap,CTRL[0]), 8},
	{"sizeof(CRC_MemMap)", sizeof(struct CRC_MemMap), 12},
	{"OFFSET(USBDCD_MemMap, CLOCK)", OFFSET(USBDCD_MemMap,CLOCK[0]), 4},
	{"OFFSET(USBDCD_MemMap, STATUS)", OFFSET(USBDCD_MemMap,STATUS[0]), 8},
	{"OFFSET(USBDCD_MemMap, TIMER0)", OFFSET(USBDCD_MemMap,TIMER0[0]), 16},
	{"OFFSET(USBDCD_MemMap, TIMER1)", OFFSET(USBDCD_MemMap,TIMER1[0]), 20},
	{"OFFSET(USBDCD_MemMap, TIMER2_BC11)", OFFSET(USBDCD_MemMap,TIMER2_BC11[0]), 24},
	{"OFFSET(USBDCD_MemMap, TIMER2_BC12)", OFFSET(USBDCD_MemMap,TIMER2_BC12[0]), 24},
	{"sizeof(USBDCD_MemMap)", sizeof(struct USBDCD_MemMap), 28},
	{"OFFSET(PDB_MemMap, SC)", OFFSET(PDB_MemMap,SC[0]), 0},
	{"OFFSET(PDB_MemMap, MOD)", OFFSET(PDB_MemMap,MOD[0]), 4},
	{"OFFSET(PDB_MemMap, CNT)", OFFSET(PDB_MemMap,CNT[0]), 8},
	{"OFFSET(PDB_MemMap, IDLY)", OFFSET(PDB_MemMap,IDLY[0]), 12},
	{"OFFSET(PDB_MemMap, POEN)", OFFSET(PDB_MemMap,POEN[0]), 400},
	...
	{"OFFSET(VREF_MemMap, TRM)", OFFSET(VREF_MemMap,TRM[0]), 0},
	{"sizeof(VREF_MemMap)", sizeof(struct VREF_MemMap), 2},
	{"OFFSET(LLWU_MemMap, PE1)", OFFSET(LLWU_MemMap,PE1[0]), 0},
	{"OFFSET(LLWU_MemMap, PE2)", OFFSET(LLWU_MemMap,PE2[0]), 1},
	{"OFFSET(LLWU_MemMap, PE3)", OFFSET(LLWU_MemMap,PE3[0]), 2},
	{"OFFSET(LLWU_MemMap, PE4)", OFFSET(LLWU_MemMap,PE4[0]), 3},
	{"OFFSET(LLWU_MemMap, ME)", OFFSET(LLWU_MemMap,ME[0]), 4},
	{"OFFSET(LLWU_MemMap, F1)", OFFSET(LLWU_MemMap,F1[0]), 5},
	{"OFFSET(LLWU_MemMap, F2)", OFFSET(LLWU_MemMap,F2[0]), 6},
	{"OFFSET(LLWU_MemMap, F3)", OFFSET(LLWU_MemMap,F3[0]), 7},
	{"OFFSET(LLWU_MemMap, FILT1)", OFFSET(LLWU_MemMap,FILT1[0]), 8},
	{"OFFSET(LLWU_MemMap, FILT2)", OFFSET(LLWU_MemMap,FILT2[0]), 9},
	{"OFFSET(LLWU_MemMap, RST)", OFFSET(LLWU_MemMap,RST[0]), 10},
	{"sizeof(LLWU_MemMap)", sizeof(struct LLWU_MemMap), 11},
	{"OFFSET(RCM_MemMap, SRS0)", OFFSET(RCM_MemMap,SRS0[0]), 0},
	{"OFFSET(RCM_MemMap, SRS1)", OFFSET(RCM_MemMap,SRS1[0]), 1},
	{"OFFSET(RCM_MemMap, RPFC)", OFFSET(RCM_MemMap,RPFC[0]), 4},
	{"OFFSET(RCM_MemMap, RPFW)", OFFSET(RCM_MemMap,RPFW[0]), 5},
	{"OFFSET(RCM_MemMap, MR)", OFFSET(RCM_MemMap,MR[0]), 7},
	{"sizeof(RCM_MemMap)", sizeof(struct RCM_MemMap), 8},
	{"OFFSET(DAC_MemMap, C0)", OFFSET(DAC_MemMap,C0[0]), 33},
	{"OFFSET(DAC_MemMap, SR)", OFFSET(DAC_MemMap,SR[0]), 32},
	{"OFFSET(DAC_MemMap, C2)", OFFSET(DAC_MemMap,C2[0]), 35},
	{"sizeof(DAC_MemMap)", sizeof(struct DAC_MemMap), 36},
	{"OFFSET(RTC_MemMap, TSR)", OFFSET(RTC_MemMap,TSR[0]), 0},
	{"OFFSET(RTC_MemMap, TPR)", OFFSET(RTC_MemMap,TPR[0]), 4},
	{"OFFSET(RTC_MemMap, TAR)", OFFSET(RTC_MemMap,TAR[0]), 8},
	{"OFFSET(RTC_MemMap, TCR)", OFFSET(RTC_MemMap,TCR[0]), 12},
	{"OFFSET(RTC_MemMap, LR)", OFFSET(RTC_MemMap,LR[0]), 24},
	{"OFFSET(RTC_MemMap, IER)", OFFSET(RTC_MemMap,IER[0]), 28},
	{"OFFSET(RTC_MemMap, WAR)", OFFSET(RTC_MemMap,WAR[0]), 2048},
	{"OFFSET(RTC_MemMap, RAR)", OFFSET(RTC_MemMap,RAR[0]), 2052},
	...
	{"OFFSET(LPTMR_MemMap, PSR)", OFFSET(LPTMR_MemMap,PSR[0]), 4},
	{"OFFSET(LPTMR_MemMap, CMR)", OFFSET(LPTMR_MemMap,CMR[0]), 8},
	{"OFFSET(LPTMR_MemMap, CNR)", OFFSET(LPTMR_MemMap,CNR[0]), 12},
	{"sizeof(LPTMR_MemMap)", sizeof(struct LPTMR_MemMap), 16},
	{"OFFSET(MCM_MemMap, PLASC)", OFFSET(MCM_MemMap,PLASC[0]), 8},
	{"OFFSET(MCM_MemMap, PLAMC)", OFFSET(MCM_MemMap,PLAMC[0]), 10},
	{"OFFSET(MCM_MemMap, PLACR)", OFFSET(MCM_MemMap,PLACR[0]), 12},
	{"OFFSET(MCM_MemMap, ISCR)", OFFSET(MCM_MemMap,ISCR[0]), 16},
	{"sizeof(MCM_MemMap)", sizeof(struct MCM_MemMap), 12},
	{"sizeof(RFSYS_MemMap)", sizeof(struct RFSYS_MemMap), 32},
	{"OFFSET(SIM_MemMap, SOPT1)", OFFSET(SIM_MemMap,SOPT1[0]), 0},
	{"OFFSET(SIM_MemMap, SOPT1CFG)", OFFSET(SIM_MemMap,SOPT1CFG[0]), 4},
	{"OFFSET(SIM_MemMap, SOPT2)", OFFSET(SIM_MemMap,SOPT2[0]), 4100},
	{"OFFSET(SIM_MemMap, SOPT4)", OFFSET(SIM_MemMap,SOPT4[0]), 4108},
	{"OFFSET(SIM_MemMap, SOPT5)", OFFSET(SIM_MemMap,SOPT5[0]), 4112},
	{"OFFSET(SIM_MemMap, SOPT7)", OFFSET(SIM_MemMap,SOPT7[0]), 4120},
	{"OFFSET(SIM_MemMap, SDID)", OFFSET(SIM_MemMap,SDID[0]), 4132},
	{"OFFSET(SIM_MemMap, SCGC1)", OFFSET(SIM_MemMap,SCGC1[0]), 4136},
	{"OFFSET(SIM_MemMap, SCGC2)", OFFSET(SIM_MemMap,SCGC2[0]), 4140},
	{"OFFSET(SIM_MemMap, SCGC3)", OFFSET(SIM_MemMap,SCGC3[0]), 4144},
	{"OFFSET(SIM_MemMap, SCGC4)", OFFSET(SIM_MemMap,SCGC4[0]), 4148},
	{"OFFSET(SIM_MemMap, SCGC5)", OFFSET(SIM_MemMap,SCGC5[0]), 4152},
	{"OFFSET(SIM_MemMap, SCGC6)", OFFSET(SIM_MemMap,SCGC6[0]), 4156},
	{"OFFSET(SIM_MemMap, SCGC7)", OFFSET(SIM_MemMap,SCGC7[0]), 4160},
	{"OFFSET(SIM_MemMap, CLKDIV1)", OFFSET(SIM_MemMap,CLKDIV1[0]), 4164},
	{"OFFSET(SIM_MemMap, CLKDIV2)", OFFSET(SIM_MemMap,CLKDIV2[0]), 4168},
	{"OFFSET(SIM_MemMap, FCFG1)", OFFSET(SIM_MemMap,FCFG1[0]), 4172},
	{"OFFSET(SIM_MemMap, FCFG2)", OFFSET(SIM_MemMap,FCFG2[0]), 4176},
	{"OFFSET(SIM_MemMap, UIDH)", OFFSET(SIM_MemMap,UIDH[0]), 4180},
	{"OFFSET(SIM_MemMap, UIDMH)", OFFSET(SIM_MemMap,UIDMH[0]), 4184},
	{"OFFSET(SIM_MemMap, UIDML)", OFFSET(SIM_MemMap,UIDML[0]), 4188},
	{"OFFSET(SIM_MemMap, UIDL)", OFFSET(SIM_MemMap,UIDL[0]), 4192},
	{"sizeof(SIM_MemMap)", sizeof(struct SIM_MemMap), 4196},
	{"OFFSET(NV_MemMap, BACKKEY3)", OFFSET(NV_MemMap,BACKKEY3[0]), 0},
	{"OFFSET(NV_MemMap, BACKKEY2)", OFFSET(NV_MemMap,BACKKEY2[0]), 1},
	{"OFFSET(NV_MemMap, BACKKEY1)", OFFSET(NV_MemMap,BACKKEY1[0]), 2},
	{"OFFSET(NV_MemMap, BACKKEY0)", OFFSET(NV_MemMap,BACKKEY0[0]), 3},
	{"OFFSET(NV_MemMap, BACKKEY7)", OFFSET(NV_MemMap,BACKKEY7[0]), 4},
	{"OFFSET(NV_MemMap, BACKKEY6)", OFFSET(NV_MemMap,BACKKEY6[0]), 5},
	{"OFFSET(NV_MemMap, BACKKEY5)", OFFSET(NV_MemMap,BACKKEY5[0]), 6},
	{"OFFSET(NV_MemMap, BACKKEY4)", OFFSET(NV_MemMap,BACKKEY4[0]), 7},
	{"OFFSET(NV_MemMap, FPROT3)", OFFSET(NV_MemMap,FPROT3[0]), 8},
	{"OFFSET(NV_MemMap, FPROT2)", OFFSET(NV_MemMap,FPROT2[0]), 9},
	{"OFFSET(NV_MemMap, FPROT1)", OFFSET(NV_MemMap,FPROT1[0]), 10},
	{"OFFSET(NV_MemMap, FPROT0)", OFFSET(NV_MemMap,FPROT0[0]), 11},
	{"OFFSET(NV_MemMap, FSEC)", OFFSET(NV_MemMap,FSEC[0]), 12},
	{"OFFSET(NV_MemMap, FOPT)", OFFSET(NV_MemMap,FOPT[0]), 13},
	{"sizeof(NV_MemMap)", sizeof(struct NV_MemMap), 14},
	{"OFFSET(FTFA_MemMap, FSTAT)", OFFSET(FTFA_MemMap,FSTAT[0]), 0},
	{"OFFSET(FTFA_MemMap, FCNFG)", OFFSET(FTFA_MemMap,FCNFG[0]), 1},
	{"OFFSET(FTFA_MemMap, FCCOB3)", OFFSET(FTFA_MemMap,FCCOB3[0]), 4},
	{"OFFSET(FTFA_MemMap, FCCOB2)", OFFSET(FTFA_MemMap,FCCOB2[0]), 5},
	{"OFFSET(FTFA_MemMap, FCCOB1)", OFFSET(FTFA_MemMap,FCCOB1[0]), 6},
	{"OFFSET(FTFA_MemMap, FCCOB0)", OFFSET(FTFA_MemMap,FCCOB0[0]), 7},
	{"OFFSET(FTFA_MemMap, FCCOB7)", OFFSET(FTFA_MemMap,FCCOB7[0]), 8},
	{"OFFSET(FTFA_MemMap, FCCOB6)", OFFSET(FTFA_MemMap,FCCOB6[0]), 9},
	{"OFFSET(FTFA_MemMap, FCCOB5)", OFFSET(FTFA_MemMap,FCCOB5[0]), 10},
	{"OFFSET(FTFA_MemMap, FCCOB4)", OFFSET(FTFA_MemMap,FCCOB4[0]), 11},
	{"OFFSET(FTFA_MemMap, FCCOBB)", OFFSET(FTFA_MemMap,FCCOBB[0]), 12},
	{"OFFSET(FTFA_MemMap, FCCOBA)", OFFSET(FTFA_MemMap,FCCOBA[0]), 13},
	{"OFFSET(FTFA_MemMap, FCCOB9)", OFFSET(FTFA_MemMap,FCCOB9[0]), 14},
	{"OFFSET(FTFA_MemMap, FCCOB8)", OFFSET(FTFA_MemMap,FCCOB8[0]), 15},
	{"sizeof(FTFA_MemMap)", sizeof(struct FTFA_MemMap), 20},
	{"OFFSET(RNG_MemMap, ER)", OFFSET(RNG_MemMap,ER[0]), 8},
	{"OFFSET(RNG_MemMap, OR)", OFFSET(RNG_MemMap,OR[0]), 12},
	{"sizeof(RNG_MemMap)", sizeof(struct RNG_MemMap), 16},
	{"OFFSET(EWM_MemMap, SERV)", OFFSET(EWM_MemMap,SERV[0]), 1},
	{"OFFSET(EWM_MemMap, CMPL)", OFFSET(EWM_MemMap,CMPL[0]), 2},
	{"OFFSET(EWM_MemMap, CMPH)", OFFSET(EWM_MemMap,CMPH[0]), 3},
	{"sizeof(EWM_MemMap)", sizeof(struct EWM_MemMap), 4},
	{"OFFSET(WDOG_MemMap, STCTRLH)", OFFSET(WDOG_MemMap,STCTRLH[0]), 0},
	{"OFFSET(WDOG_MemMap, STCTRLL)", OFFSET(WDOG_MemMap,STCTRLL[0]), 2},
	{"OFFSET(WDOG_MemMap, TOVALH)", OFFSET(WDOG_MemMap,TOVALH[0]), 4},
	{"OFFSET(WDOG_MemMap, TOVALL)", OFFSET(WDOG_MemMap,TOVALL[0]), 6},
	{"OFFSET(WDOG_MemMap, WINH)", OFFSET(WDOG_MemMap,WINH[0]), 8},
	{"OFFSET(WDOG_MemMap, WINL)", OFFSET(WDOG_MemMap,WINL[0]), 10},
	{"OFFSET(WDOG_MemMap, REFRESH)", OFFSET(WDOG_MemMap,REFRESH[0]), 12},
	{"OFFSET(WDOG_MemMap, UNLOCK)", OFFSET(WDOG_MemMap,UNLOCK[0]), 14},
	{"OFFSET(WDOG_MemMap, TMROUTH)", OFFSET(WDOG_MemMap,TMROUTH[0]), 16},
	{"OFFSET(WDOG_MemMap, TMROUTL)", OFFSET(WDOG_MemMap,TMROUTL[0]), 18},
	{"OFFSET(WDOG_MemMap, RSTCNT)", OFFSET(WDOG_MemMap,RSTCNT[0]), 20},
	{"OFFSET(WDOG_MemMap, PRESC)", OFFSET(WDOG_MemMap,PRESC[0]), 22},
	{"sizeof(WDOG_MemMap)", sizeof(struct WDOG_MemMap), 24},
	{"OFFSET(CMT_MemMap, DMA)", OFFSET(CMT_MemMap,DMA[0]), 11},
	{"OFFSET(CMT_MemMap, CGH1)", OFFSET(CMT_MemMap,CGH1[0]), 0},
	{"OFFSET(CMT_MemMap, CGL1)", OFFSET(CMT_MemMap,CGL1[0]), 1},
	{"OFFSET(CMT_MemMap, CGH2)", OFFSET(CMT_MemMap,CGH2[0]), 2},
	{"OFFSET(CMT_MemMap, CGL2)", OFFSET(CMT_MemMap,CGL2[0]), 3},
	{"OFFSET(CMT_MemMap, OC)", OFFSET(CMT_MemMap,OC[0]), 4},
	{"OFFSET(CMT_MemMap, MSC)", OFFSET(CMT_MemMap,MSC[0]), 5},
	{"OFFSET(CMT_MemMap, CMD1)", OFFSET(CMT_MemMap,CMD1[0]), 6},
	{"OFFSET(CMT_MemMap, CMD2)", OFFSET(CMT_MemMap,CMD2[0]), 7},
	{"OFFSET(CMT_MemMap, CMD3)", OFFSET(CMT_MemMap,CMD3[0]), 8},
	{"OFFSET(CMT_MemMap, CMD4)", OFFSET(CMT_MemMap,CMD4[0]), 9},
	{"OFFSET(CMT_MemMap, PPS)", OFFSET(CMT_MemMap,PPS[0]), 10},
	{"sizeof(CMT_MemMap)", sizeof(struct CMT_MemMap), 12},
	{"OFFSET(PMC_MemMap, LVDSC1)", OFFSET(PMC_MemMap,LVDSC1[0]), 0},
	{"OFFSET(PMC_MemMap, LVDSC2)", OFFSET(PMC_MemMap,LVDSC2[0]), 1},
	{"OFFSET(PMC_MemMap, REGSC)", OFFSET(PMC_MemMap,REGSC[0]), 2},
	{"sizeof(PMC_MemMap)", sizeof(struct PMC_MemMap), 3},
	{"OFFSET(MCG_MemMap, C3)", OFFSET(MCG_MemMap,C3[0]), 2},
	{"OFFSET(MCG_MemMap, C4)", OFFSET(MCG_MemMap,C4[0]), 3},
	{"OFFSET(MCG_MemMap, C5)", OFFSET(MCG_MemMap,C5[0]), 4},
	{"OFFSET(MCG_MemMap, C6)", OFFSET(MCG_MemMap,C6[0]), 5},
	{"OFFSET(MCG_MemMap, ATCVH)", OFFSET(MCG_MemMap,ATCVH[0]), 10},
	{"OFFSET(MCG_MemMap, ATCVL)", OFFSET(MCG_MemMap,ATCVL[0]), 11},
	{"OFFSET(MCG_MemMap, C7)", OFFSET(MCG_MemMap,C7[0]), 12},
	{"OFFSET(MCG_MemMap, C8)", OFFSET(MCG_MemMap,C8[0]), 13},
	{"sizeof(MCG_MemMap)", sizeof(struct MCG_MemMap), 14},
	{"OFFSET(SMC_MemMap, PMPROT)", OFFSET(SMC_MemMap,PMPROT[0]), 0},
	{"OFFSET(SMC_MemMap, PMCTRL)", OFFSET(SMC_MemMap,PMCTRL[0]), 1},
	{"OFFSET(SMC_MemMap, VLLSCTRL)", OFFSET(SMC_MemMap,VLLSCTRL[0]), 2},
	{"OFFSET(SMC_MemMap, PMSTAT)", OFFSET(SMC_MemMap,PMSTAT[0]), 3},
	...
	{"OFFSET(ADC_MemMap, CFG1)", OFFSET(ADC_MemMap,CFG1[0]), 8},
	{"OFFSET(ADC_MemMap, CFG2)", OFFSET(ADC_MemMap,CFG2[0]), 12},
	{"OFFSET(ADC_MemMap, R)", OFFSET(ADC_MemMap,R[0]), 16},
	{"OFFSET(ADC_MemMap, CV1)", OFFSET(ADC_MemMap,CV1[0]), 24},
	{"OFFSET(ADC_MemMap, CV2)", OFFSET(ADC_MemMap,CV2[0]), 28},
	{"OFFSET(ADC_MemMap, SC2)", OFFSET(ADC_MemMap,SC2[0]), 32},
	{"OFFSET(ADC_MemMap, SC3)", OFFSET(ADC_MemMap,SC3[0]), 36},
	{"OFFSET(ADC_MemMap, OFS)", OFFSET(ADC_MemMap,OFS[0]), 40},
	{"OFFSET(ADC_MemMap, PG)", OFFSET(ADC_MemMap,PG[0]), 44},
	{"OFFSET(ADC_MemMap, MG)", OFFSET(ADC_MemMap,MG[0]), 48},
	{"OFFSET(ADC_MemMap, CLPD)", OFFSET(ADC_MemMap,CLPD[0]), 52},
	{"OFFSET(ADC_MemMap, CLPS)", OFFSET(ADC_MemMap,CLPS[0]), 56},
	{"OFFSET(ADC_MemMap, CLP4)", OFFSET(ADC_MemMap,CLP4[0]), 60},
	{"OFFSET(ADC_MemMap, CLP3)", OFFSET(ADC_MemMap,CLP3[0]), 64},
	{"OFFSET(ADC_MemMap, CLP2)", OFFSET(ADC_MemMap,CLP2[0]), 68},
	{"OFFSET(ADC_MemMap, CLP1)", OFFSET(ADC_MemMap,CLP1[0]), 72},
	{"OFFSET(ADC_MemMap, CLP0)", OFFSET(ADC_MemMap,CLP0[0]), 76},
	{"OFFSET(ADC_MemMap, CLMD)", OFFSET(ADC_MemMap,CLMD[0]), 84},
	{"OFFSET(ADC_MemMap, CLMS)", OFFSET(ADC_MemMap,CLMS[0]), 88},
	{"OFFSET(ADC_MemMap, CLM4)", OFFSET(ADC_MemMap,CLM4[0]), 92},
	{"OFFSET(ADC_MemMap, CLM3)", OFFSET(ADC_MemMap,CLM3[0]), 96},
	{"OFFSET(ADC_MemMap, CLM2)", OFFSET(ADC_MemMap,CLM2[0]), 100},
	{"OFFSET(ADC_MemMap, CLM1)", OFFSET(ADC_MemMap,CLM1[0]), 104},
	{"OFFSET(ADC_MemMap, CLM0)", OFFSET(ADC_MemMap,CLM0[0]), 108},
	{"sizeof(ADC_MemMap)", sizeof(struct ADC_MemMap), 112},
	{"OFFSET(AIPS_MemMap, PACRC)", OFFSET(AIPS_MemMap,PACRC[0]), 40},
	{"OFFSET(AIPS_MemMap, PACRE)", OFFSET(AIPS_MemMap,PACRE[0]), 64},
	{"OFFSET(AIPS_MemMap, PACRF)", OFFSET(AIPS_MemMap,PACRF[0]), 68},
	{"OFFSET(AIPS_MemMap, PACRG)", OFFSET(AIPS_MemMap,PACRG[0]), 72},
	{"OFFSET(AIPS_MemMap, PACRH)", OFFSET(AIPS_MemMap,PACRH[0]), 76},
	{"OFFSET(AIPS_MemMap, PACRI)", OFFSET(AIPS_MemMap,PACRI[0]), 80},
	{"OFFSET(AIPS_MemMap, PACRJ)", OFFSET(AIPS_MemMap,PACRJ[0]), 84},
	{"OFFSET(AIPS_MemMap, PACRK)", OFFSET(AIPS_MemMap,PACRK[0]), 88},
	{"OFFSET(AIPS_MemMap, PACRL)", OFFSET(AIPS_MemMap,PACRL[0]), 92},
	{"OFFSET(AIPS_MemMap, PACRM)", OFFSET(AIPS_MemMap,PACRM[0]), 96},
	{"OFFSET(AIPS_MemMap, PACRN)", OFFSET(AIPS_MemMap,PACRN[0]), 100},
	{"OFFSET(AIPS_MemMap, PACRO)", OFFSET(AIPS_MemMap,PACRO[0]), 104},
	{"OFFSET(AIPS_MemMap, PACRP)", OFFSET(AIPS_MemMap,PACRP[0]), 108},
	{"OFFSET(AIPS_MemMap, PACRA)", OFFSET(AIPS_MemMap,PACRA[0]), 32},
	{"OFFSET(AIPS_MemMap, PACRB)", OFFSET(AIPS_MemMap,PACRB[0]), 36},
	{"OFFSET(AIPS_MemMap, PACRD)", OFFSET(AIPS_MemMap,PACRD[0]), 44},
	{"OFFSET(AIPS_MemMap, PACRU)", OFFSET(AIPS_MemMap,PACRU[0]), 128},
	{"sizeof(AIPS_MemMap)", sizeof(struct AIPS_MemMap), 132},
	{"OFFSET(CMP_MemMap, CR0)", OFFSET(CMP_MemMap,CR0[0]), 0},
	{"OFFSET(CMP_MemMap, CR1)", OFFSET(CMP_MemMap,CR1[0]), 1},
	{"OFFSET(CMP_MemMap, FPR)", OFFSET(CMP_MemMap,FPR[0]), 2},
	{"OFFSET(CMP_MemMap, SCR)", OFFSET(CMP_MemMap,SCR[0]), 3},
	{"OFFSET(CMP_MemMap, DACCR)", OFFSET(CMP_MemMap,DACCR[0]), 4},
	{"OFFSET(CMP_MemMap, MUXCR)", OFFSET(CMP_MemMap,MUXCR[0]), 5},
	{"sizeof(CMP_MemMap)", sizeof(struct CMP_MemMap), 6},
	{"OFFSET(FTM_MemMap, CNTIN)", OFFSET(FTM_MemMap,CNTIN[0]), 76},
	{"OFFSET(FTM_MemMap, MODE)", OFFSET(FTM_MemMap,MODE[0]), 84},
	{"OFFSET(FTM_MemMap, SYNC)", OFFSET(FTM_MemMap,SYNC[0]), 88},
	{"OFFSET(FTM_MemMap, OUTINIT)", OFFSET(FTM_MemMap,OUTINIT[0]), 92},
	{"OFFSET(FTM_MemMap, OUTMASK)", OFFSET(FTM_MemMap,OUTMASK[0]), 96},
	{"OFFSET(FTM_MemMap, COMBINE)", OFFSET(FTM_MemMap,COMBINE[0]), 100},
	{"OFFSET(FTM_MemMap, DEADTIME)", OFFSET(FTM_MemMap,DEADTIME[0]), 104},
	{"OFFSET(FTM_MemMap, EXTTRIG)", OFFSET(FTM_MemMap,EXTTRIG[0]), 108},
	{"OFFSET(FTM_MemMap, POL)", OFFSET(FTM_MemMap,POL[0]), 112},
	{"OFFSET(FTM_MemMap, FMS)", OFFSET(FTM_MemMap,FMS[0]), 116},
	{"OFFSET(FTM_MemMap, FILTER)", OFFSET(FTM_MemMap,FILTER[0]), 120},
	{"OFFSET(FTM_MemMap, FLTCTRL)", OFFSET(FTM_MemMap,FLTCTRL[0]), 124},
	{"OFFSET(FTM_MemMap, QDCTRL)", OFFSET(FTM_MemMap,QDCTRL[0]), 128},
	{"OFFSET(FTM_MemMap, CONF)", OFFSET(FTM_MemMap,CONF[0]), 132},
	{"OFFSET(FTM_MemMap, FLTPOL)", OFFSET(FTM_MemMap,FLTPOL[0]), 136},
	{"OFFSET(FTM_MemMap, SYNCONF)", OFFSET(FTM_MemMap,SYNCONF[0]), 140},
	{"OFFSET(FTM_MemMap, INVCTRL)", OFFSET(FTM_MemMap,INVCTRL[0]), 144},
	{"OFFSET(FTM_MemMap, SWOCTRL)", OFFSET(FTM_MemMap,SWOCTRL[0]), 148},
	{"OFFSET(FTM_MemMap, PWMLOAD)", OFFSET(FTM_MemMap,PWMLOAD[0]), 152},
	{"sizeof(FTM_MemMap)", sizeof(struct FTM_MemMap), 156},
	{"OFFSET(GPIO_MemMap, PDOR)", OFFSET(GPIO_MemMap,PDOR[0]), 0},
	{"OFFSET(GPIO_MemMap, PSOR)", OFFSET(GPIO_MemMap,PSOR[0]), 4},
	{"OFFSET(GPIO_MemMap, PCOR)", OFFSET(GPIO_MemMap,PCOR[0]), 8},
	{"OFFSET(GPIO_MemMap, PTOR)", OFFSET(GPIO_MemMap,PTOR[0]), 12},
	{"OFFSET(GPIO_MemMap, PDIR)", OFFSET(GPIO_MemMap,PDIR[0]), 16},
	{"OFFSET(GPIO_MemMap, PDDR)", OFFSET(GPIO_MemMap,PDDR[0]), 20},
	{"sizeof(GPIO_MemMap)", sizeof(struct GPIO_MemMap), 24},
	{"OFFSET(I2C_MemMap, A1)", OFFSET(I2C_MemMap,A1[0]), 0},
	{"OFFSET(I2C_MemMap, F)", OFFSET(I2C_MemMap,F[0]), 1},
	{"OFFSET(I2C_MemMap, D)", OFFSET(I2C_MemMap,D[0]), 4},
	{"OFFSET(I2C_MemMap, FLT)", OFFSET(I2C_MemMap,FLT[0]), 6},
	{"OFFSET(I2C_MemMap, RA)", OFFSET(I2C_MemMap,RA[0]), 7},
	{"OFFSET(I2C_MemMap, SMB)", OFFSET(I2C_MemMap,SMB[0]), 8},
	{"OFFSET(I2C_MemMap, A2)", OFFSET(I2C_MemMap,A2[0]), 9},
	{"OFFSET(I2C_MemMap, SLTH)", OFFSET(I2C_MemMap,SLTH[0]), 10},
	{"OFFSET(I2C_MemMap, SLTL)", OFFSET(I2C_MemMap,SLTL[0]), 11},
	{"sizeof(I2C_MemMap)", sizeof(struct I2C_MemMap), 12},
	{"OFFSET(PORT_MemMap, PCR)", OFFSET(PORT_MemMap,PCR[0]), 0},
	{"OFFSET(PORT_MemMap, GPCLR)", OFFSET(PORT_MemMap,GPCLR[0]), 128},
	{"OFFSET(PORT_MemMap, GPCHR)", OFFSET(PORT_MemMap,GPCHR[0]), 132},
	{"OFFSET(PORT_MemMap, ISFR)", OFFSET(PORT_MemMap,ISFR[0]), 160},
	{"sizeof(PORT_MemMap)", sizeof(struct PORT_MemMap), 164},
	{"OFFSET(SPI_MemMap, CTAR_SLAVE)", OFFSET(SPI_MemMap,CTAR_SLAVE[0]), 12},
	{"OFFSET(SPI_MemMap, CTAR)", OFFSET(SPI_MemMap,CTAR[0]), 12},
	{"OFFSET(SPI_MemMap, RSER)", OFFSET(SPI_MemMap,RSER[0]), 48},
	{"OFFSET(SPI_MemMap, PUSHR)", OFFSET(SPI_MemMap,PUSHR[0]), 52},
	{"OFFSET(SPI_MemMap, PUSHR_SLAVE)", OFFSET(SPI_MemMap,PUSHR_SLAVE[0]), 52},
	{"OFFSET(SPI_MemMap, POPR)", OFFSET(SPI_MemMap,POPR[0]), 56},
	{"OFFSET(SPI_MemMap, TXFR0)", OFFSET(SPI_MemMap,TXFR0[0]), 60},
	{"OFFSET(SPI_MemMap, TXFR1)", OFFSET(SPI_MemMap,TXFR1[0]), 64},
	{"OFFSET(SPI_MemMap, TXFR2)", OFFSET(SPI_MemMap,TXFR2[0]), 68},
	{"OFFSET(SPI_MemMap, TXFR3)", OFFSET(SPI_MemMap,TXFR3[0]), 72},
	{"OFFSET(SPI_MemMap, RXFR0)", OFFSET(SPI_MemMap,RXFR0[0]), 124},
	{"OFFSET(SPI_MemMap, RXFR1)", OFFSET(SPI_MemMap,RXFR1[0]), 128},
	{"OFFSET(SPI_MemMap, RXFR2)", OFFSET(SPI_MemMap,RXFR2[0]), 132},
	{"OFFSET(SPI_MemMap, RXFR3)", OFFSET(SPI_MemMap,RXFR3[0]), 136},
	{"sizeof(SPI_MemMap)", sizeof(struct SPI_MemMap), 140},
	{"OFFSET(UART_MemMap, BDH)", OFFSET(UART_MemMap,BDH[0]), 0},
	{"OFFSET(UART_MemMap, BDL)", OFFSET(UART_MemMap,BDL[0]), 1},
	{"OFFSET(UART_MemMap, S1)", OFFSET(UART_MemMap,S1[0]), 4},
	{"OFFSET(UART_MemMap, S2)", OFFSET(UART_MemMap,S2[0]), 5},
	{"OFFSET(UART_MemMap, MA1)", OFFSET(UART_MemMap,MA1[0]), 8},
	{"OFFSET(UART_MemMap, MA2)", OFFSET(UART_MemMap,MA2[0]), 9},
	{"OFFSET(UART_MemMap, ED)", OFFSET(UART_MemMap,ED[0]), 12},
	{"OFFSET(UART_MemMap, MODEM)", OFFSET(UART_MemMap,MODEM[0]), 13},
	{"OFFSET(UART_MemMap, IR)", OFFSET(UART_MemMap,IR[0]), 14},
	{"OFFSET(UART_MemMap, PFIFO)", OFFSET(UART_MemMap,PFIFO[0]), 16},
	{"OFFSET(UART_MemMap, CFIFO)", OFFSET(UART_MemMap,CFIFO[0]), 17},
	{"OFFSET(UART_MemMap, SFIFO)", OFFSET(UART_MemMap,SFIFO[0]), 18},
	{"OFFSET(UART_MemMap, TWFIFO)", OFFSET(UART_MemMap,TWFIFO[0]), 19},
	{"OFFSET(UART_MemMap, TCFIFO)", OFFSET(UART_MemMap,TCFIFO[0]), 20},
	{"OFFSET(UART_MemMap, RWFIFO)", OFFSET(UART_MemMap,RWFIFO[0]), 21},
	{"OFFSET(UART_MemMap, RCFIFO)", OFFSET(UART_MemMap,RCFIFO[0]), 22},
