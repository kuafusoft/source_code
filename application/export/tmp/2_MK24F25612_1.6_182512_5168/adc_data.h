...
struct DATA ADC_REG_DATA[] = {
	{"OFFSET(DMA_MemMap)",OFFSET(DMA_MemMap,CR[0]), 0},
	{"OFFSET(DMA_MemMap)",OFFSET(DMA_MemMap,ES[0]), 4},
	{"OFFSET(DMA_MemMap)",OFFSET(DMA_MemMap,ERQ[0]), 12},
	{"OFFSET(DMA_MemMap)",OFFSET(DMA_MemMap,EEI[0]), 20},
	{"OFFSET(DMA_MemMap)",OFFSET(DMA_MemMap,CEEI[0]), 24},
	{"OFFSET(DMA_MemMap)",OFFSET(DMA_MemMap,SEEI[0]), 25},
	{"OFFSET(DMA_MemMap)",OFFSET(DMA_MemMap,CERQ[0]), 26},
	{"OFFSET(DMA_MemMap)",OFFSET(DMA_MemMap,SERQ[0]), 27},
	{"OFFSET(DMA_MemMap)",OFFSET(DMA_MemMap,CDNE[0]), 28},
	{"OFFSET(DMA_MemMap)",OFFSET(DMA_MemMap,SSRT[0]), 29},
	{"OFFSET(DMA_MemMap)",OFFSET(DMA_MemMap,CERR[0]), 30},
	{"OFFSET(DMA_MemMap)",OFFSET(DMA_MemMap,CINT[0]), 31},
	{"OFFSET(DMA_MemMap)",OFFSET(DMA_MemMap,INT[0]), 36},
	{"OFFSET(DMA_MemMap)",OFFSET(DMA_MemMap,ERR[0]), 44},
	{"OFFSET(DMA_MemMap)",OFFSET(DMA_MemMap,HRS[0]), 52},
	...
	{"OFFSET(FMC_MemMap)",OFFSET(FMC_MemMap,PFAPR[0]), 0},
	{"OFFSET(FMC_MemMap)",OFFSET(FMC_MemMap,PFB0CR[0]), 4},
	{"OFFSET(FMC_MemMap)",OFFSET(FMC_MemMap,TAGVDW0S[0]), 256},
	{"OFFSET(FMC_MemMap)",OFFSET(FMC_MemMap,TAGVDW1S[0]), 272},
	{"OFFSET(FMC_MemMap)",OFFSET(FMC_MemMap,TAGVDW2S[0]), 288},
	{"OFFSET(FMC_MemMap)",OFFSET(FMC_MemMap,TAGVDW3S[0]), 304},
	{"sizeof(FMC_MemMap)",sizeof(struct FMC_MemMap), 768},
	{"OFFSET(DMAMUX_MemMap)",OFFSET(DMAMUX_MemMap,CHCFG[0]), 0},
	{"sizeof(DMAMUX_MemMap)",sizeof(struct DMAMUX_MemMap), 16},
	{"OFFSET(I2S_MemMap)",OFFSET(I2S_MemMap,TCSR[0]), 0},
	{"OFFSET(I2S_MemMap)",OFFSET(I2S_MemMap,RCSR[0]), 128},
	{"OFFSET(I2S_MemMap)",OFFSET(I2S_MemMap,TCR1[0]), 4},
	{"OFFSET(I2S_MemMap)",OFFSET(I2S_MemMap,TCR2[0]), 8},
	{"OFFSET(I2S_MemMap)",OFFSET(I2S_MemMap,RCR2[0]), 136},
	{"OFFSET(I2S_MemMap)",OFFSET(I2S_MemMap,TCR3[0]), 12},
	{"OFFSET(I2S_MemMap)",OFFSET(I2S_MemMap,RCR3[0]), 140},
	{"OFFSET(I2S_MemMap)",OFFSET(I2S_MemMap,TCR4[0]), 16},
	{"OFFSET(I2S_MemMap)",OFFSET(I2S_MemMap,RCR4[0]), 144},
	{"OFFSET(I2S_MemMap)",OFFSET(I2S_MemMap,TCR5[0]), 20},
	{"OFFSET(I2S_MemMap)",OFFSET(I2S_MemMap,RCR5[0]), 148},
	{"OFFSET(I2S_MemMap)",OFFSET(I2S_MemMap,TDR[0]), 32},
	{"OFFSET(I2S_MemMap)",OFFSET(I2S_MemMap,TFR[0]), 64},
	{"OFFSET(I2S_MemMap)",OFFSET(I2S_MemMap,RFR[0]), 192},
	{"OFFSET(I2S_MemMap)",OFFSET(I2S_MemMap,TMR[0]), 96},
	{"OFFSET(I2S_MemMap)",OFFSET(I2S_MemMap,RCR1[0]), 132},
	{"OFFSET(I2S_MemMap)",OFFSET(I2S_MemMap,RDR[0]), 160},
	{"OFFSET(I2S_MemMap)",OFFSET(I2S_MemMap,RMR[0]), 224},
	{"OFFSET(I2S_MemMap)",OFFSET(I2S_MemMap,MCR[0]), 256},
	{"OFFSET(I2S_MemMap)",OFFSET(I2S_MemMap,MDR[0]), 260},
	{"sizeof(I2S_MemMap)",sizeof(struct I2S_MemMap), 264},
	{"OFFSET(USB_MemMap)",OFFSET(USB_MemMap,PERID[0]), 0},
	{"OFFSET(USB_MemMap)",OFFSET(USB_MemMap,IDCOMP[0]), 4},
	{"OFFSET(USB_MemMap)",OFFSET(USB_MemMap,REV[0]), 8},
	{"OFFSET(USB_MemMap)",OFFSET(USB_MemMap,ADDINFO[0]), 12},
	{"OFFSET(USB_MemMap)",OFFSET(USB_MemMap,OTGISTAT[0]), 16},
	{"OFFSET(USB_MemMap)",OFFSET(USB_MemMap,OTGICR[0]), 20},
	{"OFFSET(USB_MemMap)",OFFSET(USB_MemMap,OTGSTAT[0]), 24},
	{"OFFSET(USB_MemMap)",OFFSET(USB_MemMap,OTGCTL[0]), 28},
	{"OFFSET(USB_MemMap)",OFFSET(USB_MemMap,ISTAT[0]), 128},
	{"OFFSET(USB_MemMap)",OFFSET(USB_MemMap,INTEN[0]), 132},
	{"OFFSET(USB_MemMap)",OFFSET(USB_MemMap,ERRSTAT[0]), 136},
	{"OFFSET(USB_MemMap)",OFFSET(USB_MemMap,ERREN[0]), 140},
	{"OFFSET(USB_MemMap)",OFFSET(USB_MemMap,STAT[0]), 144},
	{"OFFSET(USB_MemMap)",OFFSET(USB_MemMap,CTL[0]), 148},
	{"OFFSET(USB_MemMap)",OFFSET(USB_MemMap,ADDR[0]), 152},
	{"OFFSET(USB_MemMap)",OFFSET(USB_MemMap,BDTPAGE1[0]), 156},
	{"OFFSET(USB_MemMap)",OFFSET(USB_MemMap,FRMNUML[0]), 160},
	{"OFFSET(USB_MemMap)",OFFSET(USB_MemMap,FRMNUMH[0]), 164},
	{"OFFSET(USB_MemMap)",OFFSET(USB_MemMap,TOKEN[0]), 168},
	{"OFFSET(USB_MemMap)",OFFSET(USB_MemMap,SOFTHLD[0]), 172},
	{"OFFSET(USB_MemMap)",OFFSET(USB_MemMap,BDTPAGE2[0]), 176},
	{"OFFSET(USB_MemMap)",OFFSET(USB_MemMap,BDTPAGE3[0]), 180},
	{"OFFSET(USB_MemMap)",OFFSET(USB_MemMap,USBCTRL[0]), 256},
	{"OFFSET(USB_MemMap)",OFFSET(USB_MemMap,OBSERVE[0]), 260},
	{"OFFSET(USB_MemMap)",OFFSET(USB_MemMap,CONTROL[0]), 264},
	{"OFFSET(USB_MemMap)",OFFSET(USB_MemMap,USBTRC0[0]), 268},
	{"OFFSET(USB_MemMap)",OFFSET(USB_MemMap,USBFRMADJUST[0]), 276},
	{"OFFSET(USB_MemMap)",OFFSET(USB_MemMap,CLK_RECOVER_CTRL[0]), 320},
	{"OFFSET(USB_MemMap)",OFFSET(USB_MemMap,CLK_RECOVER_IRC_EN[0]), 324},
	{"OFFSET(USB_MemMap)",OFFSET(USB_MemMap,CLK_RECOVER_INT_EN[0]), 340},
	{"OFFSET(USB_MemMap)",OFFSET(USB_MemMap,CLK_RECOVER_INT_STATUS[0]), 348},
	{"sizeof(USB_MemMap)",sizeof(struct USB_MemMap), 349},
	{"OFFSET(CRC_MemMap)",OFFSET(CRC_MemMap,DATA[0]), 0},
	{"OFFSET(CRC_MemMap)",OFFSET(CRC_MemMap,GPOLY[0]), 4},
	{"OFFSET(CRC_MemMap)",OFFSET(CRC_MemMap,CTRL[0]), 8},
	{"sizeof(CRC_MemMap)",sizeof(struct CRC_MemMap), 12},
	{"OFFSET(USBDCD_MemMap)",OFFSET(USBDCD_MemMap,CLOCK[0]), 4},
	{"OFFSET(USBDCD_MemMap)",OFFSET(USBDCD_MemMap,STATUS[0]), 8},
	{"OFFSET(USBDCD_MemMap)",OFFSET(USBDCD_MemMap,TIMER0[0]), 16},
	{"OFFSET(USBDCD_MemMap)",OFFSET(USBDCD_MemMap,TIMER1[0]), 20},
	{"OFFSET(USBDCD_MemMap)",OFFSET(USBDCD_MemMap,TIMER2_BC11[0]), 24},
	{"OFFSET(USBDCD_MemMap)",OFFSET(USBDCD_MemMap,TIMER2_BC12[0]), 24},
	{"sizeof(USBDCD_MemMap)",sizeof(struct USBDCD_MemMap), 28},
	{"OFFSET(PDB_MemMap)",OFFSET(PDB_MemMap,SC[0]), 0},
	{"OFFSET(PDB_MemMap)",OFFSET(PDB_MemMap,MOD[0]), 4},
	{"OFFSET(PDB_MemMap)",OFFSET(PDB_MemMap,CNT[0]), 8},
	{"OFFSET(PDB_MemMap)",OFFSET(PDB_MemMap,IDLY[0]), 12},
	{"OFFSET(PDB_MemMap)",OFFSET(PDB_MemMap,POEN[0]), 400},
	{"OFFSET(PDB_MemMap)",OFFSET(PDB_MemMap,PODLY[0]), 404},
	{"sizeof(PDB_MemMap)",sizeof(struct PDB_MemMap), 412},
	{"sizeof(PIT_MemMap)",sizeof(struct PIT_MemMap), 320},
	{"OFFSET(VREF_MemMap)",OFFSET(VREF_MemMap,TRM[0]), 0},
	{"sizeof(VREF_MemMap)",sizeof(struct VREF_MemMap), 2},
	{"OFFSET(LLWU_MemMap)",OFFSET(LLWU_MemMap,PE1[0]), 0},
	{"OFFSET(LLWU_MemMap)",OFFSET(LLWU_MemMap,PE2[0]), 1},
	{"OFFSET(LLWU_MemMap)",OFFSET(LLWU_MemMap,PE3[0]), 2},
	{"OFFSET(LLWU_MemMap)",OFFSET(LLWU_MemMap,PE4[0]), 3},
	{"OFFSET(LLWU_MemMap)",OFFSET(LLWU_MemMap,ME[0]), 4},
	{"OFFSET(LLWU_MemMap)",OFFSET(LLWU_MemMap,F1[0]), 5},
	{"OFFSET(LLWU_MemMap)",OFFSET(LLWU_MemMap,F2[0]), 6},
	{"OFFSET(LLWU_MemMap)",OFFSET(LLWU_MemMap,F3[0]), 7},
	{"OFFSET(LLWU_MemMap)",OFFSET(LLWU_MemMap,FILT1[0]), 8},
	{"OFFSET(LLWU_MemMap)",OFFSET(LLWU_MemMap,FILT2[0]), 9},
	{"OFFSET(LLWU_MemMap)",OFFSET(LLWU_MemMap,RST[0]), 10},
	{"sizeof(LLWU_MemMap)",sizeof(struct LLWU_MemMap), 11},
	{"OFFSET(RCM_MemMap)",OFFSET(RCM_MemMap,SRS0[0]), 0},
	{"OFFSET(RCM_MemMap)",OFFSET(RCM_MemMap,SRS1[0]), 1},
	{"OFFSET(RCM_MemMap)",OFFSET(RCM_MemMap,RPFC[0]), 4},
	{"OFFSET(RCM_MemMap)",OFFSET(RCM_MemMap,RPFW[0]), 5},
	{"OFFSET(RCM_MemMap)",OFFSET(RCM_MemMap,MR[0]), 7},
	{"sizeof(RCM_MemMap)",sizeof(struct RCM_MemMap), 8},
	{"OFFSET(DAC_MemMap)",OFFSET(DAC_MemMap,C0[0]), 33},
	{"OFFSET(DAC_MemMap)",OFFSET(DAC_MemMap,SR[0]), 32},
	{"OFFSET(DAC_MemMap)",OFFSET(DAC_MemMap,C2[0]), 35},
	{"sizeof(DAC_MemMap)",sizeof(struct DAC_MemMap), 36},
	{"OFFSET(RTC_MemMap)",OFFSET(RTC_MemMap,TSR[0]), 0},
	{"OFFSET(RTC_MemMap)",OFFSET(RTC_MemMap,TPR[0]), 4},
	{"OFFSET(RTC_MemMap)",OFFSET(RTC_MemMap,TAR[0]), 8},
	{"OFFSET(RTC_MemMap)",OFFSET(RTC_MemMap,TCR[0]), 12},
	{"OFFSET(RTC_MemMap)",OFFSET(RTC_MemMap,LR[0]), 24},
	{"OFFSET(RTC_MemMap)",OFFSET(RTC_MemMap,IER[0]), 28},
	{"OFFSET(RTC_MemMap)",OFFSET(RTC_MemMap,WAR[0]), 2048},
	{"OFFSET(RTC_MemMap)",OFFSET(RTC_MemMap,RAR[0]), 2052},
	{"sizeof(RTC_MemMap)",sizeof(struct RTC_MemMap), 2056},
	{"OFFSET(RFVBAT_MemMap)",OFFSET(RFVBAT_MemMap,REG[0]), 0},
	{"sizeof(RFVBAT_MemMap)",sizeof(struct RFVBAT_MemMap), 32},
	{"OFFSET(LPTMR_MemMap)",OFFSET(LPTMR_MemMap,PSR[0]), 4},
	{"OFFSET(LPTMR_MemMap)",OFFSET(LPTMR_MemMap,CMR[0]), 8},
	{"OFFSET(LPTMR_MemMap)",OFFSET(LPTMR_MemMap,CNR[0]), 12},
	{"sizeof(LPTMR_MemMap)",sizeof(struct LPTMR_MemMap), 16},
	{"OFFSET(MCM_MemMap)",OFFSET(MCM_MemMap,PLASC[0]), 8},
	{"OFFSET(MCM_MemMap)",OFFSET(MCM_MemMap,PLAMC[0]), 10},
	{"OFFSET(MCM_MemMap)",OFFSET(MCM_MemMap,PLACR[0]), 12},
	{"OFFSET(MCM_MemMap)",OFFSET(MCM_MemMap,ISCR[0]), 16},
	{"sizeof(MCM_MemMap)",sizeof(struct MCM_MemMap), 12},
	{"sizeof(RFSYS_MemMap)",sizeof(struct RFSYS_MemMap), 32},
	{"OFFSET(SIM_MemMap)",OFFSET(SIM_MemMap,SOPT1[0]), 0},
	{"OFFSET(SIM_MemMap)",OFFSET(SIM_MemMap,SOPT1CFG[0]), 4},
	{"OFFSET(SIM_MemMap)",OFFSET(SIM_MemMap,SOPT2[0]), 4100},
	{"OFFSET(SIM_MemMap)",OFFSET(SIM_MemMap,SOPT4[0]), 4108},
	{"OFFSET(SIM_MemMap)",OFFSET(SIM_MemMap,SOPT5[0]), 4112},
	{"OFFSET(SIM_MemMap)",OFFSET(SIM_MemMap,SOPT7[0]), 4120},
	{"OFFSET(SIM_MemMap)",OFFSET(SIM_MemMap,SDID[0]), 4132},
	{"OFFSET(SIM_MemMap)",OFFSET(SIM_MemMap,SCGC1[0]), 4136},
	{"OFFSET(SIM_MemMap)",OFFSET(SIM_MemMap,SCGC2[0]), 4140},
	{"OFFSET(SIM_MemMap)",OFFSET(SIM_MemMap,SCGC3[0]), 4144},
	{"OFFSET(SIM_MemMap)",OFFSET(SIM_MemMap,SCGC4[0]), 4148},
	{"OFFSET(SIM_MemMap)",OFFSET(SIM_MemMap,SCGC5[0]), 4152},
	{"OFFSET(SIM_MemMap)",OFFSET(SIM_MemMap,SCGC6[0]), 4156},
	{"OFFSET(SIM_MemMap)",OFFSET(SIM_MemMap,SCGC7[0]), 4160},
	{"OFFSET(SIM_MemMap)",OFFSET(SIM_MemMap,CLKDIV1[0]), 4164},
	{"OFFSET(SIM_MemMap)",OFFSET(SIM_MemMap,CLKDIV2[0]), 4168},
	{"OFFSET(SIM_MemMap)",OFFSET(SIM_MemMap,FCFG1[0]), 4172},
	{"OFFSET(SIM_MemMap)",OFFSET(SIM_MemMap,FCFG2[0]), 4176},
	{"OFFSET(SIM_MemMap)",OFFSET(SIM_MemMap,UIDH[0]), 4180},
	{"OFFSET(SIM_MemMap)",OFFSET(SIM_MemMap,UIDMH[0]), 4184},
	{"OFFSET(SIM_MemMap)",OFFSET(SIM_MemMap,UIDML[0]), 4188},
	{"OFFSET(SIM_MemMap)",OFFSET(SIM_MemMap,UIDL[0]), 4192},
	{"sizeof(SIM_MemMap)",sizeof(struct SIM_MemMap), 4196},
	{"OFFSET(NV_MemMap)",OFFSET(NV_MemMap,BACKKEY3[0]), 0},
	{"OFFSET(NV_MemMap)",OFFSET(NV_MemMap,BACKKEY2[0]), 1},
	{"OFFSET(NV_MemMap)",OFFSET(NV_MemMap,BACKKEY1[0]), 2},
	{"OFFSET(NV_MemMap)",OFFSET(NV_MemMap,BACKKEY0[0]), 3},
	{"OFFSET(NV_MemMap)",OFFSET(NV_MemMap,BACKKEY7[0]), 4},
	{"OFFSET(NV_MemMap)",OFFSET(NV_MemMap,BACKKEY6[0]), 5},
	{"OFFSET(NV_MemMap)",OFFSET(NV_MemMap,BACKKEY5[0]), 6},
	{"OFFSET(NV_MemMap)",OFFSET(NV_MemMap,BACKKEY4[0]), 7},
	{"OFFSET(NV_MemMap)",OFFSET(NV_MemMap,FPROT3[0]), 8},
	{"OFFSET(NV_MemMap)",OFFSET(NV_MemMap,FPROT2[0]), 9},
	{"OFFSET(NV_MemMap)",OFFSET(NV_MemMap,FPROT1[0]), 10},
	{"OFFSET(NV_MemMap)",OFFSET(NV_MemMap,FPROT0[0]), 11},
	{"OFFSET(NV_MemMap)",OFFSET(NV_MemMap,FSEC[0]), 12},
	{"OFFSET(NV_MemMap)",OFFSET(NV_MemMap,FOPT[0]), 13},
	{"sizeof(NV_MemMap)",sizeof(struct NV_MemMap), 14},
	{"OFFSET(FTFA_MemMap)",OFFSET(FTFA_MemMap,FSTAT[0]), 0},
	{"OFFSET(FTFA_MemMap)",OFFSET(FTFA_MemMap,FCNFG[0]), 1},
	...
	{"OFFSET(RNG_MemMap)",OFFSET(RNG_MemMap,ER[0]), 8},
	{"OFFSET(RNG_MemMap)",OFFSET(RNG_MemMap,OR[0]), 12},
	{"sizeof(RNG_MemMap)",sizeof(struct RNG_MemMap), 16},
	{"OFFSET(EWM_MemMap)",OFFSET(EWM_MemMap,SERV[0]), 1},
	{"OFFSET(EWM_MemMap)",OFFSET(EWM_MemMap,CMPL[0]), 2},
	{"OFFSET(EWM_MemMap)",OFFSET(EWM_MemMap,CMPH[0]), 3},
	{"sizeof(EWM_MemMap)",sizeof(struct EWM_MemMap), 4},
	{"OFFSET(WDOG_MemMap)",OFFSET(WDOG_MemMap,STCTRLH[0]), 0},
	{"OFFSET(WDOG_MemMap)",OFFSET(WDOG_MemMap,STCTRLL[0]), 2},
	{"OFFSET(WDOG_MemMap)",OFFSET(WDOG_MemMap,TOVALH[0]), 4},
	{"OFFSET(WDOG_MemMap)",OFFSET(WDOG_MemMap,TOVALL[0]), 6},
	{"OFFSET(WDOG_MemMap)",OFFSET(WDOG_MemMap,WINH[0]), 8},
	{"OFFSET(WDOG_MemMap)",OFFSET(WDOG_MemMap,WINL[0]), 10},
	{"OFFSET(WDOG_MemMap)",OFFSET(WDOG_MemMap,REFRESH[0]), 12},
	{"OFFSET(WDOG_MemMap)",OFFSET(WDOG_MemMap,UNLOCK[0]), 14},
	{"OFFSET(WDOG_MemMap)",OFFSET(WDOG_MemMap,TMROUTH[0]), 16},
	{"OFFSET(WDOG_MemMap)",OFFSET(WDOG_MemMap,TMROUTL[0]), 18},
	{"OFFSET(WDOG_MemMap)",OFFSET(WDOG_MemMap,RSTCNT[0]), 20},
	{"OFFSET(WDOG_MemMap)",OFFSET(WDOG_MemMap,PRESC[0]), 22},
	{"sizeof(WDOG_MemMap)",sizeof(struct WDOG_MemMap), 24},
	{"OFFSET(CMT_MemMap)",OFFSET(CMT_MemMap,DMA[0]), 11},
	{"OFFSET(CMT_MemMap)",OFFSET(CMT_MemMap,CGH1[0]), 0},
	{"OFFSET(CMT_MemMap)",OFFSET(CMT_MemMap,CGL1[0]), 1},
	{"OFFSET(CMT_MemMap)",OFFSET(CMT_MemMap,CGH2[0]), 2},
	{"OFFSET(CMT_MemMap)",OFFSET(CMT_MemMap,CGL2[0]), 3},
	{"OFFSET(CMT_MemMap)",OFFSET(CMT_MemMap,OC[0]), 4},
	{"OFFSET(CMT_MemMap)",OFFSET(CMT_MemMap,MSC[0]), 5},
	{"OFFSET(CMT_MemMap)",OFFSET(CMT_MemMap,CMD1[0]), 6},
	{"OFFSET(CMT_MemMap)",OFFSET(CMT_MemMap,CMD2[0]), 7},
	{"OFFSET(CMT_MemMap)",OFFSET(CMT_MemMap,CMD3[0]), 8},
	{"OFFSET(CMT_MemMap)",OFFSET(CMT_MemMap,CMD4[0]), 9},
	{"OFFSET(CMT_MemMap)",OFFSET(CMT_MemMap,PPS[0]), 10},
	{"sizeof(CMT_MemMap)",sizeof(struct CMT_MemMap), 12},
	{"OFFSET(PMC_MemMap)",OFFSET(PMC_MemMap,LVDSC1[0]), 0},
	{"OFFSET(PMC_MemMap)",OFFSET(PMC_MemMap,LVDSC2[0]), 1},
	{"OFFSET(PMC_MemMap)",OFFSET(PMC_MemMap,REGSC[0]), 2},
	{"sizeof(PMC_MemMap)",sizeof(struct PMC_MemMap), 3},
	{"OFFSET(MCG_MemMap)",OFFSET(MCG_MemMap,C3[0]), 2},
	{"OFFSET(MCG_MemMap)",OFFSET(MCG_MemMap,C4[0]), 3},
	{"OFFSET(MCG_MemMap)",OFFSET(MCG_MemMap,C5[0]), 4},
	{"OFFSET(MCG_MemMap)",OFFSET(MCG_MemMap,C6[0]), 5},
	{"OFFSET(MCG_MemMap)",OFFSET(MCG_MemMap,ATCVH[0]), 10},
	{"OFFSET(MCG_MemMap)",OFFSET(MCG_MemMap,ATCVL[0]), 11},
	{"OFFSET(MCG_MemMap)",OFFSET(MCG_MemMap,C7[0]), 12},
	{"OFFSET(MCG_MemMap)",OFFSET(MCG_MemMap,C8[0]), 13},
	{"sizeof(MCG_MemMap)",sizeof(struct MCG_MemMap), 14},
	{"OFFSET(SMC_MemMap)",OFFSET(SMC_MemMap,PMPROT[0]), 0},
	{"OFFSET(SMC_MemMap)",OFFSET(SMC_MemMap,PMCTRL[0]), 1},
	{"OFFSET(SMC_MemMap)",OFFSET(SMC_MemMap,VLLSCTRL[0]), 2},
	{"OFFSET(SMC_MemMap)",OFFSET(SMC_MemMap,PMSTAT[0]), 3},
	...
	{"OFFSET(AIPS_MemMap)",OFFSET(AIPS_MemMap,PACRC[0]), 40},
	{"OFFSET(AIPS_MemMap)",OFFSET(AIPS_MemMap,PACRE[0]), 64},
	{"OFFSET(AIPS_MemMap)",OFFSET(AIPS_MemMap,PACRF[0]), 68},
	{"OFFSET(AIPS_MemMap)",OFFSET(AIPS_MemMap,PACRG[0]), 72},
	{"OFFSET(AIPS_MemMap)",OFFSET(AIPS_MemMap,PACRH[0]), 76},
	{"OFFSET(AIPS_MemMap)",OFFSET(AIPS_MemMap,PACRI[0]), 80},
	{"OFFSET(AIPS_MemMap)",OFFSET(AIPS_MemMap,PACRJ[0]), 84},
	{"OFFSET(AIPS_MemMap)",OFFSET(AIPS_MemMap,PACRK[0]), 88},
	{"OFFSET(AIPS_MemMap)",OFFSET(AIPS_MemMap,PACRL[0]), 92},
	{"OFFSET(AIPS_MemMap)",OFFSET(AIPS_MemMap,PACRM[0]), 96},
	{"OFFSET(AIPS_MemMap)",OFFSET(AIPS_MemMap,PACRN[0]), 100},
	{"OFFSET(AIPS_MemMap)",OFFSET(AIPS_MemMap,PACRO[0]), 104},
	{"OFFSET(AIPS_MemMap)",OFFSET(AIPS_MemMap,PACRP[0]), 108},
	{"OFFSET(AIPS_MemMap)",OFFSET(AIPS_MemMap,PACRA[0]), 32},
	{"OFFSET(AIPS_MemMap)",OFFSET(AIPS_MemMap,PACRB[0]), 36},
	{"OFFSET(AIPS_MemMap)",OFFSET(AIPS_MemMap,PACRD[0]), 44},
	{"OFFSET(AIPS_MemMap)",OFFSET(AIPS_MemMap,PACRU[0]), 128},
	{"sizeof(AIPS_MemMap)",sizeof(struct AIPS_MemMap), 132},
	{"OFFSET(CMP_MemMap)",OFFSET(CMP_MemMap,CR0[0]), 0},
	{"OFFSET(CMP_MemMap)",OFFSET(CMP_MemMap,CR1[0]), 1},
	{"OFFSET(CMP_MemMap)",OFFSET(CMP_MemMap,FPR[0]), 2},
	{"OFFSET(CMP_MemMap)",OFFSET(CMP_MemMap,SCR[0]), 3},
	{"OFFSET(CMP_MemMap)",OFFSET(CMP_MemMap,DACCR[0]), 4},
	{"OFFSET(CMP_MemMap)",OFFSET(CMP_MemMap,MUXCR[0]), 5},
	{"sizeof(CMP_MemMap)",sizeof(struct CMP_MemMap), 6},
	{"OFFSET(FTM_MemMap)",OFFSET(FTM_MemMap,CNTIN[0]), 76},
	{"OFFSET(FTM_MemMap)",OFFSET(FTM_MemMap,MODE[0]), 84},
	{"OFFSET(FTM_MemMap)",OFFSET(FTM_MemMap,SYNC[0]), 88},
	{"OFFSET(FTM_MemMap)",OFFSET(FTM_MemMap,OUTINIT[0]), 92},
	{"OFFSET(FTM_MemMap)",OFFSET(FTM_MemMap,OUTMASK[0]), 96},
	{"OFFSET(FTM_MemMap)",OFFSET(FTM_MemMap,COMBINE[0]), 100},
	{"OFFSET(FTM_MemMap)",OFFSET(FTM_MemMap,DEADTIME[0]), 104},
	{"OFFSET(FTM_MemMap)",OFFSET(FTM_MemMap,EXTTRIG[0]), 108},
	{"OFFSET(FTM_MemMap)",OFFSET(FTM_MemMap,POL[0]), 112},
	{"OFFSET(FTM_MemMap)",OFFSET(FTM_MemMap,FMS[0]), 116},
	{"OFFSET(FTM_MemMap)",OFFSET(FTM_MemMap,FILTER[0]), 120},
	{"OFFSET(FTM_MemMap)",OFFSET(FTM_MemMap,FLTCTRL[0]), 124},
	{"OFFSET(FTM_MemMap)",OFFSET(FTM_MemMap,QDCTRL[0]), 128},
	{"OFFSET(FTM_MemMap)",OFFSET(FTM_MemMap,CONF[0]), 132},
	{"OFFSET(FTM_MemMap)",OFFSET(FTM_MemMap,FLTPOL[0]), 136},
	{"OFFSET(FTM_MemMap)",OFFSET(FTM_MemMap,SYNCONF[0]), 140},
	{"OFFSET(FTM_MemMap)",OFFSET(FTM_MemMap,INVCTRL[0]), 144},
	{"OFFSET(FTM_MemMap)",OFFSET(FTM_MemMap,SWOCTRL[0]), 148},
	{"OFFSET(FTM_MemMap)",OFFSET(FTM_MemMap,PWMLOAD[0]), 152},
	{"sizeof(FTM_MemMap)",sizeof(struct FTM_MemMap), 156},
	{"OFFSET(GPIO_MemMap)",OFFSET(GPIO_MemMap,PDOR[0]), 0},
	{"OFFSET(GPIO_MemMap)",OFFSET(GPIO_MemMap,PSOR[0]), 4},
	{"OFFSET(GPIO_MemMap)",OFFSET(GPIO_MemMap,PCOR[0]), 8},
	{"OFFSET(GPIO_MemMap)",OFFSET(GPIO_MemMap,PTOR[0]), 12},
	{"OFFSET(GPIO_MemMap)",OFFSET(GPIO_MemMap,PDIR[0]), 16},
	{"OFFSET(GPIO_MemMap)",OFFSET(GPIO_MemMap,PDDR[0]), 20},
	{"sizeof(GPIO_MemMap)",sizeof(struct GPIO_MemMap), 24},
	{"OFFSET(I2C_MemMap)",OFFSET(I2C_MemMap,A1[0]), 0},
	{"OFFSET(I2C_MemMap)",OFFSET(I2C_MemMap,F[0]), 1},
	{"OFFSET(I2C_MemMap)",OFFSET(I2C_MemMap,D[0]), 4},
	{"OFFSET(I2C_MemMap)",OFFSET(I2C_MemMap,FLT[0]), 6},
	{"OFFSET(I2C_MemMap)",OFFSET(I2C_MemMap,RA[0]), 7},
	{"OFFSET(I2C_MemMap)",OFFSET(I2C_MemMap,SMB[0]), 8},
	{"OFFSET(I2C_MemMap)",OFFSET(I2C_MemMap,A2[0]), 9},
	{"OFFSET(I2C_MemMap)",OFFSET(I2C_MemMap,SLTH[0]), 10},
	{"OFFSET(I2C_MemMap)",OFFSET(I2C_MemMap,SLTL[0]), 11},
	{"sizeof(I2C_MemMap)",sizeof(struct I2C_MemMap), 12},
	{"OFFSET(PORT_MemMap)",OFFSET(PORT_MemMap,PCR[0]), 0},
	{"OFFSET(PORT_MemMap)",OFFSET(PORT_MemMap,GPCLR[0]), 128},
	{"OFFSET(PORT_MemMap)",OFFSET(PORT_MemMap,GPCHR[0]), 132},
	{"OFFSET(PORT_MemMap)",OFFSET(PORT_MemMap,ISFR[0]), 160},
	{"sizeof(PORT_MemMap)",sizeof(struct PORT_MemMap), 164},
	{"OFFSET(SPI_MemMap)",OFFSET(SPI_MemMap,CTAR_SLAVE[0]), 12},
	{"OFFSET(SPI_MemMap)",OFFSET(SPI_MemMap,CTAR[0]), 12},
	{"OFFSET(SPI_MemMap)",OFFSET(SPI_MemMap,RSER[0]), 48},
	{"OFFSET(SPI_MemMap)",OFFSET(SPI_MemMap,PUSHR[0]), 52},
	{"OFFSET(SPI_MemMap)",OFFSET(SPI_MemMap,PUSHR_SLAVE[0]), 52},
	{"OFFSET(SPI_MemMap)",OFFSET(SPI_MemMap,POPR[0]), 56},
	...
	{"OFFSET(UART_MemMap)",OFFSET(UART_MemMap,BDH[0]), 0},
	{"OFFSET(UART_MemMap)",OFFSET(UART_MemMap,BDL[0]), 1},
	{"OFFSET(UART_MemMap)",OFFSET(UART_MemMap,S1[0]), 4},
	{"OFFSET(UART_MemMap)",OFFSET(UART_MemMap,S2[0]), 5},
	{"OFFSET(UART_MemMap)",OFFSET(UART_MemMap,MA1[0]), 8},
	{"OFFSET(UART_MemMap)",OFFSET(UART_MemMap,MA2[0]), 9},
	{"OFFSET(UART_MemMap)",OFFSET(UART_MemMap,ED[0]), 12},
	{"OFFSET(UART_MemMap)",OFFSET(UART_MemMap,MODEM[0]), 13},
	{"OFFSET(UART_MemMap)",OFFSET(UART_MemMap,IR[0]), 14},
	{"OFFSET(UART_MemMap)",OFFSET(UART_MemMap,PFIFO[0]), 16},
	{"OFFSET(UART_MemMap)",OFFSET(UART_MemMap,CFIFO[0]), 17},
	{"OFFSET(UART_MemMap)",OFFSET(UART_MemMap,SFIFO[0]), 18},
	{"OFFSET(UART_MemMap)",OFFSET(UART_MemMap,TWFIFO[0]), 19},
	{"OFFSET(UART_MemMap)",OFFSET(UART_MemMap,TCFIFO[0]), 20},
	{"OFFSET(UART_MemMap)",OFFSET(UART_MemMap,RWFIFO[0]), 21},
	{"OFFSET(UART_MemMap)",OFFSET(UART_MemMap,RCFIFO[0]), 22},
