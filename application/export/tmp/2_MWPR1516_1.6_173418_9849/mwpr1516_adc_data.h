...
struct DATA ADC_REG_DATA[] = {
	...
	{"OFFSET(FTMRE_MemMap, FSEC)", OFFSET(FTMRE_MemMap,FSEC), 2},
	...
	{"OFFSET(FTMRE_MemMap, FPROT)", OFFSET(FTMRE_MemMap,FPROT), 11},
	...
	{"OFFSET(FSKDT_MemMap, CR)", OFFSET(FSKDT_MemMap,CR), 0},
	{"OFFSET(FSKDT_MemMap, SR)", OFFSET(FSKDT_MemMap,SR), 2},
	...
	{"OFFSET(SIM_MemMap, RST)", OFFSET(SIM_MemMap,RST), 28},
	...
	{"OFFSET(ICS_MemMap, C2)", OFFSET(ICS_MemMap,C2), 1},
