...
class t_v{
	...
	protected $main_params = array();
	protected $ver_params = array();
	
	public function __construct($db, $main, $ver = '', $main_params = array(), $ver_params = array()){
		$this->init($db, $main, $ver, $main_params, $ver_params);
	}
	...
	protected function init($db, $main, $ver = '', $main_params = array(), $ver_params = array()){
		if(empty($ver))
			$ver = $main.'_ver';
		$this->options['db'] = $db;
		$this->options['main'] = $main;
		$this->options['main_params'] = $main_params;
		$this->options['ver'] = $ver;
		$this->options['ver_params'] = $ver_params;
		$this->main = table_descFactory::get($db, $main, $main_params);
		$this->ver = table_descFactory::get($db, $main, $ver_params); 
